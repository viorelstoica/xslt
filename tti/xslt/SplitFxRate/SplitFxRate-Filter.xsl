...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="SplitFxRate-Filter-Core.xsl"/>
	<xsl:import href="SplitFxRate-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SplitFxRate" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SplitFxRate\SplitFxRateT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SplitFxRate\SplitFxRate.xml" processortype="jaxp"
