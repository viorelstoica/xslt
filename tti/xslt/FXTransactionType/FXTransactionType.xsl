...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/FXTransactionType" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFXTransactionType" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiFXTransactionType" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiFXTransactionType" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   ...
   <xsl:template match="c:MultiFXTransactionType">
      <xsl:apply-templates select="c:CurrentEvent/b:FXTransactionType"/>
   </xsl:template>
   <xsl:template match="batch:BatchFXTransactionType">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchFXTransactionType" name="BatchFXTransactionType">
         <xsl:apply-templates select="b:FXTransactionType"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiFXTransactionType">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiFXTransactionType" name="BatchMultiFXTransactionType">
         <xsl:apply-templates select="c:MultiFXTransactionType"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:FXTransactionType">
      <InfraPMS>
         <xsl:attribute name="mode">INSUPD</xsl:attribute>
         <xsl:attribute name="output">
            <xsl:value-of select="concat('FXTransactionType',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Type>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('FXTransactionType.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
