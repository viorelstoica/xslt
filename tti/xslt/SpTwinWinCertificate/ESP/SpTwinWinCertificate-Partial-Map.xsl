...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="SpTwinWinCertificate-Core.xsl"/>
    <xsl:import href="SpTwinWinCertificate-Custo.xsl"/>
	<xsl:import href="../SpTwinWinCertificate-Partial-Core.xsl"/>
    <xsl:import href="../SpTwinWinCertificate-Partial-Custo.xsl"/>
    <xsl:import href="SpTwinWinCertificate-Partial-Core.xsl"/>
    <xsl:import href="SpTwinWinCertificate-Partial-Custo.xsl"/>
	<xsl:import href="SpTwinWinCertificate-Partial.xsl"/>
