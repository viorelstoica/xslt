...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="SpTwinWinCertificate-Core.xsl"/>
    <xsl:import href="SpTwinWinCertificate-Custo.xsl"/>
	<xsl:import href="../SpTwinWinCertificate-PartialD-Core.xsl"/>
    <xsl:import href="../SpTwinWinCertificate-PartialD-Custo.xsl"/>
    <xsl:import href="SpTwinWinCertificate-PartialD-Core.xsl"/>
    <xsl:import href="SpTwinWinCertificate-PartialD-Custo.xsl"/>
    <xsl:import href="SpTwinWinCertificate-PartialD.xsl"/>
