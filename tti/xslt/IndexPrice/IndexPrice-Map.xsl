...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchIndexPrice"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiIndexPrice"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiIndexPrice" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="IndexPrice-Core.xsl"/>
    <xsl:import href="IndexPrice-Custo.xsl"/>
	<xsl:import href="IndexPrice.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="IndexPrice" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\IndexPrice\IndexPrice.xml" htmlbaseurl="" outputurl="..\..\TestFiles\IndexPrice\IndexPriceCusto.xml" processortype="jaxp" useresolver="no"
		          profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext=""
		          validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
			<advancedProp name="bSchemaAware" value="false"/>
