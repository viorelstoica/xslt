   ...
   <xsl:template match="b:TransactionEntitlement">
      <CorporateActionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('CoaStockDividends',b:diaryId)"/>
         </xsl:attribute>
         <DataGroup>
            <StockDividend>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionStockDividend.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
               ...
               <xsl:call-template name="stockDividendQuantity"/>
            </StockDividend>
         </DataGroup>
      </CorporateActionPMS>
   </xsl:template><!-- End of template TransactionEntitlement -->
