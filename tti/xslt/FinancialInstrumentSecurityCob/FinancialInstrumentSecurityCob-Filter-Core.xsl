...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/FinancialInstrumentSecurityCob"
                xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFinancialInstrumentSecurityCob" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiFinancialInstrumentSecurityCob" xmlns:infra="http://www.odcgroup.com/InfraPMS"
	...
	<xsl:template match="b:FinancialInstrumentSecurityCob">
		...
		<xsl:apply-templates select="self::b:FinancialInstrumentSecurityCob[($g_filterBySubAssetType = 'Y' and b:subAssetType and contains($list_SubAssetType_IrregularCoupon,b:subAssetType)) 
		                                                                      or $irregularCouponToBePaid = 'Y']" mode="filter-custo"/>
	</xsl:template>
	<!-- Custo placeholder -->
	<xsl:template match="b:FinancialInstrumentSecurityCob" mode="filter-custo">
		<xsl:apply-templates select="self::b:FinancialInstrumentSecurityCob" mode="filter-final"/>
	</xsl:template>

	<!-- Copy block -->
	<xsl:template match="b:FinancialInstrumentSecurityCob" mode="filter-final">
		<xsl:copy>
			<xsl:apply-templates select="@* | node()"/>
		</xsl:copy>
	</xsl:template>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FinancialInstrumentSecurity" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumentSecurity\FinancialInstrumentSecurity.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentSecurity\FinancialInstrumentSecurityCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
	...
	<MapperMetaTag>
		<MapperInfo srcSchemaPathIsRelative="yes" srcSchemaInterpretAsXML="no" destSchemaPath="" destSchemaRoot="" destSchemaPathIsRelative="yes" destSchemaInterpretAsXML="no">
			<SourceSchema srcSchemaPath="..\..\TestFiles\FinancialInstrumentSecurity\FinancialInstrumentSecurity.xml" srcSchemaRoot="MultiFinancialInstrumentSecurity" AssociatedInstance="" loaderFunction="document" loaderFunctionUsesURI="no"/>
		</MapperInfo>
		<MapperBlockPosition>
			<template match="b:FinancialInstrumentSecurity">
