...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/AAAccountAccrual"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchAAAccountAccrual"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiAAAccountAccrual"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiAAAccountAccrual" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="AAAccountAccrual-Core.xsl"/>
    <xsl:import href="AAAccountAccrual-Custo.xsl"/>
	<xsl:import href="AAAccountAccrual.xsl"/>
