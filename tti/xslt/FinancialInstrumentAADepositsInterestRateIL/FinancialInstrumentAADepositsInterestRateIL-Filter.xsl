...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="FinancialInstrumentAADepositsInterestRateIL-Filter-Core.xsl"/>
    <xsl:import href="FinancialInstrumentAADepositsInterestRateIL-Filter-Custo.xsl"/>
