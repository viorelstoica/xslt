...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/Price" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchPrice" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiPrice" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiPrice" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   <xsl:output encoding="UTF-8" indent="yes" method="xml"/>
   <xsl:template match="c:MultiPrice">
      <xsl:apply-templates select="c:CurrentEvent/b:Price"/>
   </xsl:template>
   <xsl:template match="batch:BatchPrice">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchPrice" name="BatchPrice">
         <xsl:apply-templates select="b:Price"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiPrice">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiPrice" name="BatchMultiPrice">
         <xsl:apply-templates select="c:MultiPrice"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:Price">
      <FiPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('price',b:securityNo)"/>
         </xsl:attribute>
         <DataGroup>
            <Price>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('Price.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
