...
<metaInformation>
	<scenarios>
		<scenario default="no" name="F2B_OrderInstruction" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\F2B_OrderInstruction\F2B_OrderInstructionGWP.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\F2B_OrderInstruction\F2B_OrderInstruction.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
		...
		<scenario default="no" name="F2B_TaxLots" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\F2B_OrderInstruction\F2B_TaxLotsGWP.xml" htmlbaseurl="" outputurl="..\..\TestFiles\F2B_OrderInstruction\F2B_TaxLots.xml"
		...
		<scenario default="yes" name="4562_msgin" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\F2B_OrderInstruction\4562_msgin.xml" htmlbaseurl="" outputurl="..\..\TestFiles\F2B_OrderInstruction\4562_msginFilter.xml"
		          processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline=""
		          postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
			<advancedProp name="bXsltOneIsOkay" value="true"/>
