...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="TransactionPaymentOrderDebitRev-Core.xsl"/>
    <xsl:import href="TransactionPaymentOrderDebitRev-Custo.xsl"/>
	<xsl:import href="TransactionPaymentOrderDebitRev.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="TransactionPaymentOrderDebitRev" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionPaymentOrderDebitRev\TransactionPaymentOrderDebitInput.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionPaymentOrderDebitRev\TransactionPaymentOrderDebitCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
