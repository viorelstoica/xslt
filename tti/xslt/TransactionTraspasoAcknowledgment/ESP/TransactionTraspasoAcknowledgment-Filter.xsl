...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="TransactionTraspasoAcknowledgment-Filter-Core.xsl"/>
    <xsl:import href="TransactionTraspasoAcknowledgment-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DXOrderAcknowledgment" userelativepaths="yes" externalpreview="no" url="..\test\ack.xml" htmlbaseurl="" outputurl="..\test\ackfil.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth=""
