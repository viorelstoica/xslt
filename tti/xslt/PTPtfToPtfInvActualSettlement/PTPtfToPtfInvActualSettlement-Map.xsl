...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferScSettlement"
	...
	<xsl:import href="PTPtfToPtfInvActualSettlement-Core.xsl"/>
	<xsl:import href="PTPtfToPtfInvActualSettlement-Custo.xsl"/>
	<xsl:import href="PTPtfToPtfInvActualSettlement.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PTPtfToPtfInvActualSettlement" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PTPtfToPtfInvActualSettlement\PTPtfToPtfInvActualSettlement.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PTPtfToPtfInvActualSettlement\PTPtfToPtfInvActualSettlementGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
