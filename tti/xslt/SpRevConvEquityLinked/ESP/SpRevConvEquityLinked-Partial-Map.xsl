...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="SpRevConvEquityLinked-Core.xsl"/>
    <xsl:import href="SpRevConvEquityLinked-Custo.xsl"/>
	<xsl:import href="../SpRevConvEquityLinked-Partial-Core.xsl"/>
    <xsl:import href="../SpRevConvEquityLinked-Partial-Custo.xsl"/>
    <xsl:import href="SpRevConvEquityLinked-Partial-Core.xsl"/>
    <xsl:import href="SpRevConvEquityLinked-Partial-Custo.xsl"/>
	<xsl:import href="SpRevConvEquityLinked-Partial.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\..\GWPACK Trunk\XML Schema\Untitled1.xml" htmlbaseurl="" outputurl="..\..\..\..\GWPACK Trunk\XML Schema\Untisssstled1.xml" processortype="saxon8"
