...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="SpRevConvEquityLinked-Core.xsl"/>
    <xsl:import href="SpRevConvEquityLinked-Custo.xsl"/>
	<xsl:import href="../SpRevConvEquityLinked-PartialD-Core.xsl"/>
    <xsl:import href="../SpRevConvEquityLinked-PartialD-Custo.xsl"/>
    <xsl:import href="SpRevConvEquityLinked-PartialD-Core.xsl"/>
    <xsl:import href="SpRevConvEquityLinked-PartialD-Custo.xsl"/>
    <xsl:import href="SpRevConvEquityLinked-PartialD.xsl"/>
