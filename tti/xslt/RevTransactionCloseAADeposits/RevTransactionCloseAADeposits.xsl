   ...
   <xsl:template match="c:AAAFlow">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('RevTransactionCloseAADeposits',c:aatxncontext/b:aaArrActivityId)"/>
         </xsl:attribute>
         <DataGroup>
   ...
   <xsl:template match="c:aaarecord">
      <DepositLoan>
         <xsl:attribute name="description">
            <xsl:value-of select="concat('RevTransactionCloseAADeposits.xsl+', name(/*), '+', ../c:eventCommon/ns0:eventId, '+', ../c:eventCommon/ns0:creationTime)"/>
         </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\RevTransactionCloseAADeposits\RevTransactionCloseAADeposits.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\RevTransactionCloseAADeposits\RevTransactionCloseAADepositsgg.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
