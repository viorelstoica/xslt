...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/GenericCOA" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionAssignExpiryOptionBuyCloseOutRev"
	...
	<xsl:import href="TransactionAssignExpiryOptionBuyCloseOutRev-Core.xsl"/>
	<xsl:import href="TransactionAssignExpiryOptionBuyCloseOutRev-Custo.xsl"/>
	<xsl:import href="TransactionAssignExpiryOptionBuyCloseOutRev.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionAssignExpiryOptionBuyCloseOutRev" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionAssignExpiryOptionBuyCloseOutRev\TransactionAssignExpiryOptionBuyCloseOutRev.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionAssignExpiryOptionBuyCloseOutRev\TransactionAssignExpiryOptionBuyCloseOutRevGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
