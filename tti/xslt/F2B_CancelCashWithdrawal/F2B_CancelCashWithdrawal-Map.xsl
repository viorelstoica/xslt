...
<xsl:stylesheet exclude-result-prefixes="b" version="1.0"
    ...
    <xsl:import href="F2B_CancelCashWithdrawal-Core.xsl"/>
    <xsl:import href="F2B_CancelCashWithdrawal-Custo.xsl"/>
	<xsl:import href="F2B_CancelCashWithdrawal.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\..\DailyTrack\TTI-2686\CancelCashTransfer\orderinstr.xml" htmlbaseurl=""
		          outputurl="..\..\..\..\DailyTrack\TTI-2686\CancelCashTransfer\orderinstrout.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
