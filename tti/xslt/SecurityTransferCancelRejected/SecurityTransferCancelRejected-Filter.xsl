...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="SecurityTransferCancelRejected-Filter-Core.xsl"/>
    <xsl:import href="SecurityTransferCancelRejected-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\ts.xml" htmlbaseurl="" outputurl="..\tsfil.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
