...
<xsl:stylesheet exclude-result-prefixes="b" version="1.0"
    ...
    <xsl:import href="TransactionCloseLDLoanDeposit-Core.xsl"/>
    <xsl:import href="TransactionCloseLDLoanDeposit-Custo.xsl"/>
	<xsl:import href="TransactionCloseLDLoanDeposit.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionCloseLDLoanDeposit" userelativepaths="yes" externalpreview="no" url="..\..\..\Untitled1.xml" htmlbaseurl="" outputurl="..\..\..\TransactionCloseLDLoanDepositCusto.xml" processortype="saxon8" useresolver="no"
