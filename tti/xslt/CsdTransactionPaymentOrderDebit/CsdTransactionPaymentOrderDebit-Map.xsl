...
<xsl:stylesheet exclude-result-prefixes="b c e batch multibatch"
    ...
    <xsl:import href="CsdTransactionPaymentOrderDebit-Core.xsl"/>
    <xsl:import href="CsdTransactionPaymentOrderDebit-Custo.xsl"/>
	<xsl:import href="CsdTransactionPaymentOrderDebit.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="TransactionPaymentOrderCredit" userelativepaths="yes" externalpreview="no" url="..\..\..\..\..\Users\abiram.anandakumar\Downloads\CsdDebit\Filter.xml" htmlbaseurl=""
		          outputurl="..\..\..\..\..\Users\abiram.anandakumar\Downloads\CsdDebit\Msgout.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
