	...
	<xsl:template match="b:PaymentOrder">
		<TransactionPMS>
			...
			<xsl:attribute name="output">
				<xsl:value-of select="concat('CsdTransactionPaymentOrderDebit',b:id)"/>
			</xsl:attribute>
			...
			<DataGroup>
				<Cash>
					<xsl:attribute name="description">
						<xsl:value-of select="concat('CsdTransactionPaymentOrderDebit.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
					</xsl:attribute>
