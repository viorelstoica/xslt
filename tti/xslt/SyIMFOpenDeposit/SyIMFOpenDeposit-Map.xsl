...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="SyIMFOpenDeposit-Core.xsl"/>
    <xsl:import href="SyIMFOpenDeposit-Custo.xsl"/>
	<xsl:import href="SyIMFOpenDeposit.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyIMFOpenDeposit\SyIMFOpenDeposit.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyIMFOpenDeposit\SyIMFOpenDepositFilter.xml"
