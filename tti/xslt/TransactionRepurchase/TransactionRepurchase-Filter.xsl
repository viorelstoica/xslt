...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/GenericCOA" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionEntitlement" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchTransactionEntitlement"
	...
	<xsl:import href="TransactionRepurchase-Filter-Core.xsl"/>
	<xsl:import href="TransactionRepurchase-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionRepurchase" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionRepurchase\TransactionRepurchaseT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionRepurchase\TransactionRepurchase.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
