...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/FiPMS" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="FXInstrPrice-Core.xsl"/>
	<xsl:import href="FXInstrPrice-Custo.xsl"/>
	<xsl:import href="FXInstrPrice.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FXInstrPrice" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\FXInstrPrice\FXInstrPricePostFilter.xml" htmlbaseurl="" outputurl="..\..\TestFiles\FXInstrPrice\FXInstrPriceGWP.xml" processortype="jaxp"
