...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="CsdChronoDataUnpaidPercentage-Core.xsl"/>
    <xsl:import href="CsdChronoDataUnpaidPercentage-Custo.xsl"/>
	<xsl:import href="CsdChronoDataUnpaidPercentage.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="ChronoDataUnpaidPercentage" userelativepaths="yes" externalpreview="no" url="..\..\..\..\..\..\Chrono.xml" htmlbaseurl="" outputurl="..\..\..\..\..\..\ChronoMap.xml" processortype="saxon8" useresolver="no"
