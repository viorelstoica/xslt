...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0" version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/ClientPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="CustomerDocument-Core.xsl"/>
	<xsl:import href="CustomerDocument-Custo.xsl"/>
	<xsl:import href="CustomerDocument.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="CustomerDocument" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\CustomerDocument\CustomerDocument.xml" htmlbaseurl="" outputurl="..\..\TestFiles\CustomerDocument\CustomerDocumentGWP.xml"
