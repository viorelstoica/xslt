...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionRevReceivedGuarantee" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchTransactionRevReceivedGuarantee" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiTransactionRevReceivedGuarantee" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiTransactionRevReceivedGuarantee" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   ...
   <xsl:template match="c:MultiTransactionRevReceivedGuarantee">
      <xsl:apply-templates select="c:CurrentEvent/b:TransactionRevReceivedGuarantee"/>
   </xsl:template>
   <xsl:template match="batch:BatchTransactionRevReceivedGuarantee">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchTransactionRevReceivedGuarantee" name="BatchTransactionRevReceivedGuarantee">
         <xsl:apply-templates select="b:TransactionRevReceivedGuarantee"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiTransactionRevReceivedGuarantee">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiTransactionRevReceivedGuarantee" name="BatchMultiTransactionRevReceivedGuarantee">
         <xsl:apply-templates select="c:MultiTransactionRevReceivedGuarantee"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:TransactionRevReceivedGuarantee">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransactionRevReceivedGuarantee',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Security>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionRevReceivedGuarantee.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
