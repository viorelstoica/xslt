...
<xsl:stylesheet exclude-result-prefixes="b c d e f g ns0 batch multibatch"
    ...
    <xsl:import href="TransactionPaymentIncomingRevTPH-Core.xsl"/>
    <xsl:import href="TransactionPaymentIncomingRevTPH-Custo.xsl"/>
	<xsl:import href="TransactionPaymentIncomingRevTPH.xsl"/>
