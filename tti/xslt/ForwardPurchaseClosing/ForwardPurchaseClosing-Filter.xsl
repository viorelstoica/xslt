...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/ForwardPurchaseClosing"
	...
	<xsl:import href="ForwardPurchaseClosing-Filter-Core.xsl"/>
	<xsl:import href="ForwardPurchaseClosing-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="ForwardPurchaseClosing" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\ForwardPurchaseClosing\ForwardPurchaseClosingT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\ForwardPurchaseClosing\ForwardPurchaseClosing.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
