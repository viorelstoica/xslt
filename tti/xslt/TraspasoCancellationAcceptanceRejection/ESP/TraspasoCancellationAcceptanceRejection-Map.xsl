...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/EsfundTraspasoRequest"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchEsfundTraspasoRequest"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiEsfundTraspasoRequest"
    ...
    <xsl:import href="TraspasoCancellationAcceptanceRejection-Core.xsl"/>
    <xsl:import href="TraspasoCancellationAcceptanceRejection-Custo.xsl"/>
	<xsl:import href="TraspasoCancellationAcceptanceRejection.xsl"/>
