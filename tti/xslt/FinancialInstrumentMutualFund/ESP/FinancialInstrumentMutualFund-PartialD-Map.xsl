...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="FinancialInstrumentMutualFund-Core.xsl"/>
    <xsl:import href="FinancialInstrumentMutualFund-Custo.xsl"/>
	<xsl:import href="../FinancialInstrumentMutualFund-PartialD-Core.xsl"/>
    <xsl:import href="../FinancialInstrumentMutualFund-PartialD-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentMutualFund-PartialD-Core.xsl"/>
    <xsl:import href="FinancialInstrumentMutualFund-PartialD-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentMutualFund-PartialD.xsl"/>
