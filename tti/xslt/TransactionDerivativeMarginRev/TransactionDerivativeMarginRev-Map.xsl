...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionDerivativeMarginRev"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchTransactionDerivativeMarginRev"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiTransactionDerivativeMarginRev"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiTransactionDerivativeMarginRev"
    ...
    <xsl:import href="TransactionDerivativeMarginRev-Core.xsl"/>
    <xsl:import href="TransactionDerivativeMarginRev-Custo.xsl"/>
	<xsl:import href="TransactionDerivativeMarginRev.xsl"/>
