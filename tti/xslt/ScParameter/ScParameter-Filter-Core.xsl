<?xml version="1.0" encoding="UTF-8"?><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/InfraPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/ScParameter" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchScParameter" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiScParameter" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiScParameter" exclude-result-prefixes="b c batch multibatch" version="1.0">
	...
	<xsl:template match="b:ScParameter">
		<xsl:apply-templates select="self::b:ScParameter[b:altUserIndexList/b:altUserIndex != '']" mode="filter-custo"/>
	</xsl:template>
	<!-- Custo placeholder -->
	<xsl:template match="b:ScParameter" mode="filter-custo">
		<xsl:apply-templates select="self::b:ScParameter" mode="filter-final"/>
	</xsl:template>

	<!-- Copy block -->
	<xsl:template match="b:ScParameter" mode="filter-final">
		<xsl:copy>
			<xsl:apply-templates select="@* | node()"/>
		</xsl:copy>
	</xsl:template>
