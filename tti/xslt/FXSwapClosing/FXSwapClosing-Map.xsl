...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/FXSwapClosing"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFXSwapClosing"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiFXSwapClosing"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiFXSwapClosing"
    ...
    <xsl:import href="FXSwapClosing-Core.xsl"/>
    <xsl:import href="FXSwapClosing-Custo.xsl"/>
	<xsl:import href="FXSwapClosing.xsl"/>
