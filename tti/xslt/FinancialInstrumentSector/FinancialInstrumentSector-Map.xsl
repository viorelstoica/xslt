...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFinancialInstrumentSector"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiFinancialInstrumentSector"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiFinancialInstrumentSector" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentSector-Core.xsl"/>
    <xsl:import href="FinancialInstrumentSector-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentSector.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FinancialInstrumentSector" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumentSector\FinancialInstrumentSector.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentSector\FinancialInstrumentSector_Custo.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
