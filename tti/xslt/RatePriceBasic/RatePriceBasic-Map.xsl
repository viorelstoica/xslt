...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/BasicInterest" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchBasicInterest"
                xmlns:c="http://www.temenos.com/T24/event/TTI/MultiBasicInterest" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiBasicInterest" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	<xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
	<xsl:import href="RatePriceBasic-Core.xsl"/>
    <xsl:import href="RatePriceBasic-Custo.xsl"/>
	<xsl:import href="RatePriceBasic.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="Price" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\RatePriceBasic\RatePriceBasic.xml" htmlbaseurl="" outputurl="..\..\TestFiles\RatePriceBasic\RatePriceBasic_Filter.xml" processortype="saxon8"
		          useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath=""
		          postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
