...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="Price" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\Price\Price.xml" htmlbaseurl="" outputurl="..\..\TestFiles\Price\PriceCusto.xml" processortype="saxon8" useresolver="no" profilemode="0"
