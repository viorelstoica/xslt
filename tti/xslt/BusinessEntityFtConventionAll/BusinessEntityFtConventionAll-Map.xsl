...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="BusinessEntityFtConventionAll-Core.xsl"/>
	<xsl:import href="BusinessEntityFtConventionAll-Custo.xsl"/>
	<xsl:import href="BusinessEntityFtConventionAll.xsl"/>
