...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="BusinessEntityFtConventionAll-Filter-Core.xsl"/>
	<xsl:import href="BusinessEntityFtConventionAll-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\Defects\TAXAll\20190313_220940_629_323_msgin_MultiCginventoryAll_4535164e-e41c-4085-af24-0e65c1010cf7.xml" htmlbaseurl=""
		          outputurl="..\..\..\Defects\TAXAll\bftall.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none"
