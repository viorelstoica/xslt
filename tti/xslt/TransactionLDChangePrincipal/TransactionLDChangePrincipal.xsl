   ...
   <xsl:template match="b:AcEntry">
      ...
      <TransactionPMS>
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransactionLDChangePrincipal',b:statemententry[e:transactionCode/@Rank=$MinRank]/e:transactionCode)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionLDChangePrincipal.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
               ...
               <xsl:if test="($CRFPRODCAT &lt;= '21074' and '21050' &lt;= $CRFPRODCAT)">
                  <loanOpening>
                     ...
                     <xsl:call-template name="l_account1CcyDepositCcyExchangeRate"/>
                     <xsl:call-template name="l_account2"/>
                     <xsl:call-template name="l_account2NetAmount"/>
                     <xsl:call-template name="l_account2CcyDepositCcyExchangeRate"/>
                     <xsl:call-template name="l_account3"/>
                     <xsl:call-template name="l_account3NetAmount"/>
                     <xsl:call-template name="l_account3CcyDepositCcyExchangeRate"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\..\testfiles\TransactionLDCommAndChrg\20170117_141229_237_46_msgin_AcEntry_70a34192-6a74-4bb8-93c4-0e4ef3797028.xml" htmlbaseurl=""
		          outputurl="..\..\..\..\testfiles\TransactionLDChangePrincipal\LoanWithCommAndChrgGWP.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
