   ...
   <xsl:template match="b:SyImfRollover">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SyIMFLoanInc',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SyIMFLoanInc.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
               ...
               <loancapitalIncrease>
                  ...
                  <xsl:call-template name="loanCapitalIncrease"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyIMFLoanInc\SyIMFLoanIncFilter.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyIMFLoanInc\SyIMFLoanIncGWP.xml" processortype="saxon8"
