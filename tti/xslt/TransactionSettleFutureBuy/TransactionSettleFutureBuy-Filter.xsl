...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionSettleFutureBuy"
	...
	<xsl:import href="TransactionSettleFutureBuy-Filter-Core.xsl"/>
	<xsl:import href="TransactionSettleFutureBuy-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionSettleFutureBuy" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionSettleFutureBuy\TransactionSettleFutureBuyT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionSettleFutureBuy\TransactionSettleFutureBuy.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
