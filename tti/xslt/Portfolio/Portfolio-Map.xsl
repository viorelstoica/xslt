...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Portfolio" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\Portfolio\Portfolio.xml" htmlbaseurl="" outputurl="..\..\TestFiles\Portfolio\PortfolioGWP.xml" processortype="jaxp" useresolver="no"
