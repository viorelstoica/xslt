...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="TransactionPaymentOrderCredit" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionPaymentOrderCredit\TransactionPaymentOrderCredit.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionPaymentOrderCredit\TransactionPaymentOrderCreditCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
