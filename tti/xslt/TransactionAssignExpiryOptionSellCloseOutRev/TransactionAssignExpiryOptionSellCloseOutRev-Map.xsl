...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/GenericCOA" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionAssignExpiryOptionSellCloseOutRev"
	...
	<xsl:import href="TransactionAssignExpiryOptionSellCloseOutRev-Core.xsl"/>
	<xsl:import href="TransactionAssignExpiryOptionSellCloseOutRev-Custo.xsl"/>
	<xsl:import href="TransactionAssignExpiryOptionSellCloseOutRev.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionAssignExpiryOptionSellCloseOutRev" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionAssignExpiryOptionSellCloseOutRev\TransactionAssignExpiryOptionSellCloseOutRev.xml"
		          htmlbaseurl="" outputurl="..\..\TestFiles\TransactionAssignExpiryOptionSellCloseOutRev\TransactionAssignExpiryOptionSellCloseOutRevGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength=""
