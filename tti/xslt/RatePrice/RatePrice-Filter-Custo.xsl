...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="RatePrice" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\RatePrice\RatePrice.xml" htmlbaseurl="" outputurl="..\..\TestFiles\RatePrice\RatePriceCusto.xml" processortype="jaxp" useresolver="no"
