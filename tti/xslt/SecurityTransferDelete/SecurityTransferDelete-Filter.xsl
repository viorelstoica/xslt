...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/F2B" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/SecurityTransfer"
    ...
    <xsl:import href="SecurityTransferDelete-Filter-Core.xsl"/>
    <xsl:import href="SecurityTransferDelete-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SecurityTransferDelete" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SecurityTransferDelete\SecurityTransferDeleteT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SecurityTransferDelete\SecurityTransferDelete.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
