...
<xsl:stylesheet xmlns="http://www.odcgroup.com/FiPMS"
	...
	<xsl:template name="usageNature">
		<xsl:if test="b:priceSetGroup/b:priceSet = 'INTERFACE' and b:underlyingGroup/b:underlying!= '' and b:underlyingGroup/b:underlying != 'BASKET' and b:underlyingGroup/b:underlying != 'OTHER' and b:underlyingGroup/b:underlying != 'CASH'">
			<usageNature>				
	...
	<xsl:template name="underlying">
	  <xsl:if test="b:underlyingGroup/b:underlying != '' and b:underlyingGroup/b:underlying != 'BASKET' and b:underlyingGroup/b:underlying != 'OTHER' and b:underlyingGroup/b:underlying != 'CASH'">
		<underlying>
		  <infra:code>
