...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0"
	...
	xmlns:c="http://www.temenos.com/T24/event/TTI/MultiFinancialInstrumentFutureContractMaster"
    ...
    <xsl:import href="../FinancialInstrumentFutureContractMaster-Filter-Core.xsl"/>
    <xsl:import href="../FinancialInstrumentFutureContractMaster-Filter-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentFutureContractMaster-Filter-Core.xsl"/>
    <xsl:import href="FinancialInstrumentFutureContractMaster-Filter-Custo.xsl"/>
