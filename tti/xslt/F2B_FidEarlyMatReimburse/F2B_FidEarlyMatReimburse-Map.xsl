...
<xsl:stylesheet exclude-result-prefixes="b" version="1.0"
    ...
    <xsl:import href="F2B_FidEarlyMatReimburse-Core.xsl"/>
    <xsl:import href="F2B_FidEarlyMatReimburse-Custo.xsl"/>
	<xsl:import href="F2B_FidEarlyMatReimburse.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\..\F2B_MM_CloseRequest.xml" htmlbaseurl="" outputurl="..\..\..\..\F2B_MM_CloseRequestOut.xml" processortype="saxon8" useresolver="no" profilemode="0"
