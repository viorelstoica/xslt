...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/FinancialInstrumentSecurity"
	...
	<xsl:import href="../FinancialInstrumentIndexSM-Core.xsl"/>
    <xsl:import href="../FinancialInstrumentIndexSM-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentIndexSM-Core.xsl"/>
    <xsl:import href="FinancialInstrumentIndexSM-Custo.xsl"/>
	<xsl:import href="../FinancialInstrumentIndexSM.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FinancialInstrumentSecurity" userelativepaths="yes" externalpreview="no" url="..\..\..\FinancialInstrumentSecurity.xml" htmlbaseurl="" outputurl="..\..\..\FinancialInstrumentSecurityfilter.xml" processortype="saxon8"
