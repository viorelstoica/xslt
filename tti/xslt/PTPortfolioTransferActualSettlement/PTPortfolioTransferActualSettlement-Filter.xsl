...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferScSettlement"
	...
	<xsl:import href="PTPortfolioTransferActualSettlement-Filter-Core.xsl"/>
	<xsl:import href="PTPortfolioTransferActualSettlement-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PTPortfolioTransferActualSettlement" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PTPortfolioTransferActualSettlement\PTPortfolioTransferActualSettlementT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PTPortfolioTransferActualSettlement\PTPortfolioTransferActualSettlement.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
