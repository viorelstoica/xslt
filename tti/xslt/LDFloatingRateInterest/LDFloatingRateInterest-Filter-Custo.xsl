...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DepositsLoansFloatingCondition" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\DepositsLoansFloatingCondition\DepositsLoansFloatingCondition.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\DepositsLoansFloatingCondition\DepositsLoansFloatingConditionCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
