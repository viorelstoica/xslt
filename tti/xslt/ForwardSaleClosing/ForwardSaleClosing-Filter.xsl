...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/ForwardSaleClosing" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchForwardSaleClosing"
	...
	<xsl:import href="ForwardSaleClosing-Filter-Core.xsl"/>
	<xsl:import href="ForwardSaleClosing-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="ForwardSaleClosing" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\ForwardSaleClosing\ForwardSaleClosingT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\ForwardSaleClosing\ForwardSaleClosing.xml"
