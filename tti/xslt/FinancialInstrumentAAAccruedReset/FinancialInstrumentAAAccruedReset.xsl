   ...
   <xsl:template match="c:AAAFlow">
      <FiPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('FinancialInstrumentAAAccruedReset',c:aatxncontext/b:aaArrangementId)"/>
         </xsl:attribute>
         <DataGroup>
		      <ChronologicalData>
		         <xsl:attribute name="description">
		            <xsl:value-of select="concat('FinancialInstrumentAAAccruedReset.xsl+', name(/*), '+', ../c:eventCommon/ns0:eventId, '+', ../c:eventCommon/ns0:creationTime)"/>
		         </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumentAAAccruedReset\FinancialInstrumentAAAccruedResetFilter.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentAAAccruedReset\FinancialInstrumentAAAccruedResetGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
