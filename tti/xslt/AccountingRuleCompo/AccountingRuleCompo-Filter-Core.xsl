...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0" xmlns="http://www.odcgroup.com/InfraPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/Cginventory"
                xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchCginventory" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiCginventory" 
	...
	<xsl:template match="b:Cginventory" mode="filter2">
		...
		<xsl:apply-templates select="self::b:Cginventory[($cgMethod = 'AVERAGE' or $cgMethod = 'FIFO' or $cgMethod = 'LIFO' or $cgMethod = 'HIGHEST.COST' or $cgMethod = 'LOWEST.COST' or $cgMethod = 'MAX.GAIN' or $cgMethod = 'MIN.GAIN')]" mode="filter-custo"/>
	</xsl:template>
	<!-- Custo placeholder -->
