	...
	<xsl:template match="b:PECustomerTxn">
		<TransactionPMS>
			...
			<xsl:attribute name="output">
				<xsl:value-of select="concat('PEFundCreateSubscription',b:id)"/>
			</xsl:attribute>
			<DataGroup>
				<Security>
					<xsl:attribute name="description">
						<xsl:value-of select="concat('PEFundCreateSubscription.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
					</xsl:attribute>
