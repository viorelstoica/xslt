   ...
   <xsl:template match="b:TransactionEntitlement">
      <CorporateActionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('CoaStockSplit',b:diaryId)"/>
         </xsl:attribute>
         <DataGroup>
            <StockSplit>
               <TwoLegs>
                  <Link>
                     <xsl:attribute name="description">
                        <xsl:value-of select="concat('TransactionStockSplit.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
                     </xsl:attribute>
