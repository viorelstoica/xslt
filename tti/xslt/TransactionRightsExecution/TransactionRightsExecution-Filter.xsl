...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0" version="1.0" xmlns="http://www.odcgroup.com/GenericCOA" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionEntitlement"
	...
	<xsl:import href="TransactionRightsExecution-Filter-Core.xsl"/>
	<xsl:import href="TransactionRightsExecution-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionRightsExecution" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionRightsExecution\TransactionEntitlementT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionRightsExecution\TransactionEntitlement.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
