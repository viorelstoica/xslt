...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/GenericCOA" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferFromToDeposit"
	...
	<xsl:import href="PositionTransferFromToDeposit-Filter-Core.xsl"/>
	<xsl:import href="PositionTransferFromToDeposit-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PositionTransferFromToDeposit" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PositionTransferFromToDeposit\PositionTransferFromToDepositT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PositionTransferFromToDeposit\PositionTransferFromToDeposit.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
