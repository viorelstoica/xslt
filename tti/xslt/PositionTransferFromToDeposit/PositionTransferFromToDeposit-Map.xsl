...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/GenericCOA" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferFromToDeposit"
	...
	<xsl:import href="PositionTransferFromToDeposit-Core.xsl"/>
	<xsl:import href="PositionTransferFromToDeposit-Custo.xsl"/>
	<xsl:import href="PositionTransferFromToDeposit.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PositionTransferFromToDeposit" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PositionTransferFromToDeposit\PositionTransferFromToDeposit.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PositionTransferFromToDeposit\PositionTransferFromToDepositGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
