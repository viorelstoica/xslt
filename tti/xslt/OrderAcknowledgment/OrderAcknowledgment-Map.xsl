...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/F2B" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/OrderAcknowledgment"
	...
	<xsl:import href="OrderAcknowledgment-Core.xsl"/>
	<xsl:import href="OrderAcknowledgment-Custo.xsl"/>
	<xsl:import href="OrderAcknowledgment.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="OrderAcknowledgment" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\OrderAcknowledgment\OrderAcknowledgment.xml" htmlbaseurl=""
