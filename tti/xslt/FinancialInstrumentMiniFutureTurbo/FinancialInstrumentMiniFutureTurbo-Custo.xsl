...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/FinancialInstrumentSecurity" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFinancialInstrumentSecurity" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiFinancialInstrumentSecurity" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiFinancialInstrumentSecurity" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:d="http://www.temenos.com/T24/event/TTI/FinancialInstrumentME" xmlns:e="http://www.temenos.com/T24/event/TTI/BatchFinancialInstrumentME" xmlns:f="http://www.temenos.com/T24/event/TTI/MultiFinancialInstrumentME" xmlns:g="http://www.temenos.com/T24/event/TTI/BatchMultiFinancialInstrumentME">
	...
	<xsl:template name="barrierNature_termEvent">
		<barrierNature>
			<xsl:choose>
				<xsl:when test="($g_filterBySubAssetType='Y' and b:csdHedgeType = 'LONG') or ($g_filterBySubAssetType='N' and b:subAssetTypeTapInstrType and b:subAssetTypeTapInstrType='MINIFUTTURBO1')">
					<xsl:value-of select=" '4' "/>
				</xsl:when>
				<xsl:when test="($g_filterBySubAssetType='Y' and b:csdHedgeType = 'SHORT') or ($g_filterBySubAssetType='N' and b:subAssetTypeTapInstrType and b:subAssetTypeTapInstrType='MINIFUTTURBO2')">
					<xsl:value-of select=" '2' "/>
				</xsl:when>
			</xsl:choose>
		</barrierNature>
