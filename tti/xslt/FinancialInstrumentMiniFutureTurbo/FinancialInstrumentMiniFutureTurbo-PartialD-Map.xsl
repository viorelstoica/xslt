...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="FinancialInstrumentMiniFutureTurbo-PartialD-Core.xsl"/>
    <xsl:import href="FinancialInstrumentMiniFutureTurbo-PartialD-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentMiniFutureTurbo-PartialD.xsl"/>
