...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferPortfolioTransfer"
	...
	<xsl:import href="PositionTransferPortfolioTransfer-Filter-Core.xsl"/>
	<xsl:import href="PositionTransferPortfolioTransfer-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PositionTransferPortfolioTransfer" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PositionTransferPortfolioTransfer\PositionTransferPortfolioTransferT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PositionTransferPortfolioTransfer\PositionTransferPortfolioTransfer.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
