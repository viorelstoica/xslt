...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferPortfolioTransfer"
	...
	<xsl:import href="PositionTransferPortfolioTransfer-Core.xsl"/>
	<xsl:import href="PositionTransferPortfolioTransfer-Custo.xsl"/>
	<xsl:import href="PositionTransferPortfolioTransfer.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PositionTransferPortfolioTransfer" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PositionTransferPortfolioTransfer\PositionTransferPortfolioTransfer.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PositionTransferPortfolioTransfer\PositionTransferPortfolioTransferGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
