...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchInstrumentSynonymCodification"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiInstrumentSynonymCodification"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiInstrumentSynonymCodification" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="InstrumentSynonymCodification-Core.xsl"/>
    <xsl:import href="InstrumentSynonymCodification-Custo.xsl"/>
	<xsl:import href="InstrumentSynonymCodification.xsl"/>
