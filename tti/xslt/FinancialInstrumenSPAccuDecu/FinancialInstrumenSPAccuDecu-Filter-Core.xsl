...
<xsl:stylesheet xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:b="http://www.temenos.com/T24/event/TTI/SyAccuDecu" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchSyAccuDecu" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiSyAccuDecu" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiSyAccuDecu" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
  ...
  <xsl:template match="b:SyAccuDecu" mode="filter1">
    ...
    <xsl:apply-templates select="self::b:SyAccuDecu[number($check_MaturityDate) &gt;= number($check_toDay)]" mode="filter2"/>
  </xsl:template>
  <!-- Condition 3 -->
  <xsl:template match="b:SyAccuDecu" mode="filter2">
    <xsl:apply-templates select="self::b:SyAccuDecu[b:portfolio != '']" mode="filter3"/>
  </xsl:template>
  <!-- Condition 4 -->
  <xsl:template match="b:SyAccuDecu" mode="filter3">
    <xsl:apply-templates select="self::b:SyAccuDecu[b:dealerBook = '' or not(b:dealerBook)]" mode="filter4"/>
  </xsl:template>
  <!-- Condition 5 -->
