...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="AccuDecuUnwindingFee-Core.xsl"/>
    <xsl:import href="AccuDecuUnwindingFee-Custo.xsl"/>
	<xsl:import href="AccuDecuUnwindingFee.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\AccuDecuUnwindingFee\AccuDecuUnwindingFee.xml" htmlbaseurl="" outputurl="..\..\TestFiles\AccuDecuUnwindingFee\AccuDecuUnwindingFeeFilter.xml"
