   ...
   <xsl:template match="b:SyFxForwards">
      <StructuredProducts>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('FiTarko',translate(translate(b:id,'/',''),':',''))"/>
         </xsl:attribute>
         <DataGroup>
            <PartForward>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('FiTarko.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
               ...
               <xsl:call-template name="compundingFrequency"/>
               <xsl:call-template name="compundingFrequencyUnit"/>
            ...
            <xsl:if test="b:bOptionType != ''">
               <Composition>
			      ...
			      <xsl:call-template name="cheapest_Composition1"/>
                  <xsl:call-template name="compositeInstrument1"/>
				  <xsl:call-template name="conversionFactor_Composition1"/>
                  <xsl:call-template name="conversionRatio_Composition1"/>
                  <xsl:call-template name="divisor_Composition1"/>
				  <xsl:call-template name="endDate_Composition1"/>
				  ...
				  <xsl:call-template name="mbFields_Composition1"/> 
               </Composition>
            </xsl:if>
            <xsl:if test="b:sOptionType != ''">
               <Composition>
			      ...
			      <xsl:call-template name="cheapest_Composition2"/>
                  <xsl:call-template name="compositeInstrument2"/>
				  <xsl:call-template name="conversionFactor_Composition2"/>
                  <xsl:call-template name="conversionRatio_Composition2"/>
                  <xsl:call-template name="divisor_Composition2"/>
				  <xsl:call-template name="endDate_Composition2"/>
                  ...
                  <xsl:call-template name="mbFields_Composition2"/> 
               </Composition>
            </xsl:if>
            <xsl:if test="b:vbOptionType != ''">
               <Composition>
			      ...
			      <xsl:call-template name="cheapest_Composition3"/>
                  <xsl:call-template name="compositeInstrument3"/>
				  <xsl:call-template name="conversionFactor_Composition3"/>
                  <xsl:call-template name="conversionRatio_Composition3"/>
                  <xsl:call-template name="divisor_Composition3"/>
				  <xsl:call-template name="endDate_Composition3"/>
                  ...
                  <xsl:call-template name="mbFields_Composition3"/>
               </Composition>
            </xsl:if>
         </DataGroup>
      </StructuredProducts>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FiTarko" userelativepaths="yes" externalpreview="no" url="..\..\..\SyFxForwards.xml" htmlbaseurl="" outputurl="..\..\..\FiTarkoOut.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth=""
