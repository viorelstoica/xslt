...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="FiTarko-Core.xsl"/>
    <xsl:import href="FiTarko-Custo.xsl"/>
	<xsl:import href="FiTarko.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FiTarko" userelativepaths="yes" externalpreview="no" url="..\..\IntegrationStudio\TTI\schemas\syfxforwards.xml" htmlbaseurl="" outputurl="..\..\TestFiles\FiTarko\FiTarko_Filter1.xml" processortype="jaxp"
		          useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath=""
		          postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
