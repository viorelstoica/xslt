...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchCountry"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiCountry"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiCountry" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="Country-Filter-Core.xsl"/>
    <xsl:import href="Country-Filter-Custo.xsl"/>
