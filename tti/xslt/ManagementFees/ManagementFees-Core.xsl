...
<xsl:stylesheet xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/ManagementFees" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchManagementFees" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiManagementFees" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiManagementFees" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
	...
	<xsl:template name="feesTaxesCounter">
		<feesTaxesCounter>
			<infra:code>PTF_MGM_FEES</infra:code>
		</feesTaxesCounter>
	</xsl:template>
	...
	<xsl:template name="transactionCode">
		<transactionCode>
			<xsl:value-of select="concat('PTFCHG_',b:id)"/>
		</transactionCode>
	</xsl:template>
