...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/ManagementFees"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchManagementFees"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiManagementFees"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiManagementFees" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="ManagementFees-Core.xsl"/>
    <xsl:import href="ManagementFees-Custo.xsl"/>
	<xsl:import href="ManagementFees.xsl"/>
