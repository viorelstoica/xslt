...
<xsl:stylesheet exclude-result-prefixes="b" version="1.0"
    ...
    <xsl:import href="../F2B_FXForwardSale-Filter-Core.xsl"/>
    <xsl:import href="../F2B_FXForwardSale-Filter-Custo.xsl"/>
	<xsl:import href="F2B_FXForwardSale-Filter-Core.xsl"/>
    <xsl:import href="F2B_FXForwardSale-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\F2B_FXForwardSale\F2B_FXForwardSale.xml" htmlbaseurl="" outputurl="..\..\TestFiles\F2B_FXForwardSale\F2B_FXForwardSaleFilter.xml"
