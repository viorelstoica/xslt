         ...
         <DataGroup>
            <EventStatus>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('DXOrderUpdateAccepted.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DXOrderUpdateAccepted" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\DXOrderUpdateAccepted\DXOrderUpdateAcceptedOUT.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\DXOrderAcknowledgment\DXOrderUpdateAcceptedGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
