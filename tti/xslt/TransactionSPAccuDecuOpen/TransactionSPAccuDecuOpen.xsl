...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/SyAccuDecu" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchSyAccuDecu"
	...
	<xsl:template match="c:MultiTransactionSPAccuDecuOpen">
	...
	<xsl:template match="b:SyAccuDecu">
		<TransactionPMS mode="INSUPD">
			<xsl:attribute name="output">
				<xsl:value-of select="concat('TransactionSPAccuDecuOpen',b:id)"/>
			</xsl:attribute>
			<DataGroup>
				<Security>
					<xsl:attribute name="description">
						<xsl:value-of select="concat('TransactionSPAccuDecuOpen.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
					</xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionSPAccuDecuOpen" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionSPAccuDecuOpen\TransactionSPAccuDecuOpen.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionSPAccuDecuOpen\TransactionSPAccuDecuOpenGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
