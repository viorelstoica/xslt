...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/SyFxForwardsCob" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchSyFxForwardsCob" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiSyFxForwardsCob" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiSyFxForwardsCob" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   ...
   <xsl:template match="c:MultiSyFxForwardsCob">
      <xsl:apply-templates select="c:CurrentEvent/b:SyFxForwardsCob"/>
   </xsl:template>
   <xsl:template match="batch:BatchSyFxForwardsCob">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchSyFxForwardsCob" name="BatchSyFxForwardsCob">
         <xsl:apply-templates select="b:SyFxForwardsCob"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiSyFxForwardsCob">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiSyFxForwardsCob" name="BatchMultiSyFxForwardsCob">
         <xsl:apply-templates select="c:MultiSyFxForwardsCob"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:SyFxForwardsCob">
      <TransactionPMS mode="INSUPD">
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransactionSYTarkoOpenDerivativeSell',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Derivative>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionSYTarkoOpenDerivativeSell.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionOpenDerivativeSell" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyFxForwardsCob\SyFxForwardsCob.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyFxForwardsCob\SyFxForwardsCobGWP.xml"
