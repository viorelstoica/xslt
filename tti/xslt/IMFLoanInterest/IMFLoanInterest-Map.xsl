...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="IMFLoanInterest-Core.xsl"/>
    <xsl:import href="IMFLoanInterest-Custo.xsl"/>
	<xsl:import href="IMFLoanInterest.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\IMFLoanInterest\IMFLoanInterest.xml" htmlbaseurl="" outputurl="..\..\TestFiles\IMFLoanInterest\IMFLoanInterestFilter.xml" processortype="jaxp"
