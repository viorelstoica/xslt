   ...
   <xsl:template match="b:SyAccuDecu">
      <TransactionPMS mode="INSUPD">
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransactionSPAccuDecuClose',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Security>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionSPAccuDecuClose.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionSPAccuDecuOpen" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionSPAccuDecuClose\TransactionSPAccuDecuClose.xml" htmlbaseurl=""
