...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/AAAccountInterest"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchAAAccountInterest"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiAAAccountInterest"
    ...
    <xsl:import href="AAAccountInterest-Core.xsl"/>
    <xsl:import href="AAAccountInterest-Custo.xsl"/>
	<xsl:import href="AAAccountInterest.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DepositsLoansFloatingCondition" userelativepaths="yes" externalpreview="no" url="..\msgin.xml" htmlbaseurl="" outputurl="..\msgout.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth=""
