...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.temenos.com/T24/OFSML/150" xmlns:b="http://www.odcgroup.com/F2B_MM_FX" xmlns:infra="http://www.odcgroup.com/InfraPMS"
                xmlns:paymentorder="http://www.temenos.com/T24/paymentorder" exclude-result-prefixes="b" version="1.0">
	<xsl:output encoding="UTF-8" indent="yes" method="xml"/>
	<xsl:template match="/">
		<T24Batch>
			<xsl:for-each select="b:F2B_MM_FX/b:DataGroup/b:Cash/b:OrderLifeCycle/b:SellRequest">
	...
	<xsl:template name="PAYMENT.ORDER">
		...
		<xsl:call-template name="TAP.DR.SLV.ACC"/>
		<xsl:call-template name="TAP.CR.SLV.ACC"/>
		<xsl:call-template name="TAP.SLEEVE.PTF"/>
	</xsl:template>
