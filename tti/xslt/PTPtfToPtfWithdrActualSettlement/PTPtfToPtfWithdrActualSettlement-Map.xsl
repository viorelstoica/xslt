...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferScSettlement"
	...
	<xsl:import href="PTPtfToPtfWithdrActualSettlement-Core.xsl"/>
	<xsl:import href="PTPtfToPtfWithdrActualSettlement-Custo.xsl"/>
	<xsl:import href="PTPtfToPtfWithdrActualSettlement.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PTPtfToPtfWithdrActualSettlement" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PTPtfToPtfWithdrActualSettlement\PTPtfToPtfWithdrActualSettlement.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PTPtfToPtfWithdrActualSettlement\PTPtfToPtfWithdrActualSettlementGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
