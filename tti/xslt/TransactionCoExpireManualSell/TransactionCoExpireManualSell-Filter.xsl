...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionCoExpireManualSell"
	...
	<xsl:import href="TransactionCoExpireManualSell-Filter-Core.xsl"/>
	<xsl:import href="TransactionCoExpireManualSell-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionCoExpireManualSell" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionCoExpireManualSell\TransactionCoExpireManualSellT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionCoExpireManualSell\TransactionCoExpireManualSell.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
