...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchCurrencyMarket"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiCurrencyMarket"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiCurrencyMarket" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="CurrencyMarket-Core.xsl"/>
    <xsl:import href="CurrencyMarket-Custo.xsl"/>
	<xsl:import href="CurrencyMarket.xsl"/>
