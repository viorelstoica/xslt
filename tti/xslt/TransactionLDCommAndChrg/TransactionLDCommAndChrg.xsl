   ...
   <xsl:template match="b:AcEntry">
      ...
      <TransactionPMS>
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransactionLDCommAndChrg',b:statemententry[e:transactionCode/@Rank=$MinRank]/e:transactionCode)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionLDCommAndChrg.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\..\testfiles\TransactionLDCommAndChrg\LoanWithCommAndChrg@rank.xml" htmlbaseurl=""
		          outputurl="..\..\..\..\testfiles\TransactionLDCommAndChrg\LoanWithCommAndChrgGWP.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
