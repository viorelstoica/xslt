...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/CorporateActionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionEntitlement"
	...
	<xsl:import href="TransactionSinkingRedemption-Filter-Core.xsl"/>
	<xsl:import href="TransactionSinkingRedemption-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionSinkingRedemption" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionSinkingRedemption\TransactionSinkingRedemptionPartialT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionSinkingRedemption\TransactionSinkingRedemptionPartial.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
