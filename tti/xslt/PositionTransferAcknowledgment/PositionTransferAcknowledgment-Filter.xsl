...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/F2B" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferAcknowledgment"
	...
	<xsl:import href="PositionTransferAcknowledgment-Filter-Core.xsl"/>
	<xsl:import href="PositionTransferAcknowledgment-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PositionTransferAcknowledgement" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PositionTransferAcknowledgment\PositionTransferAcknowledgmentT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PositionTransferAcknowledgment\PositionTransferAcknowledgment.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
