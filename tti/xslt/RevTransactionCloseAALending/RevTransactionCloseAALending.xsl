   ...
   <xsl:template match="c:AAAFlow">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('RevTransactionCloseAALending',c:aatxncontext/b:aaArrActivityId)"/>
         </xsl:attribute>
         <DataGroup>
            <xsl:call-template name="mappingRevTransactionCloseAALending"/>
         </DataGroup>
      </TransactionPMS>
   </xsl:template>
   <xsl:template name="mappingRevTransactionCloseAALending">
      <xsl:for-each select="c:aaarecord">
         <DepositLoan>
            <xsl:attribute name="description">
               <xsl:value-of select="concat('RevTransactionCloseAALending.xsl+', name(/*), '+', ../c:eventCommon/ns0:eventId, '+', ../c:eventCommon/ns0:creationTime)"/>
            </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\RevTransactionCloseAALending\RevTransactionCloseAALending.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\RevTransactionCloseAALending\RevTransactionCloseAALendingGW.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
