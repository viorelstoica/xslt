...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="SpRevConvCreditLinked-Core.xsl"/>
	<xsl:import href="SpRevConvCreditLinked-Custo.xsl"/>
	<xsl:import href="SpRevConvCreditLinked.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SpRevConvCreditLinked" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SpRevConvCreditLinked\SpRevConvCreditLinked.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SpRevConvCreditLinked\SpRevConvCreditLinkedGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
