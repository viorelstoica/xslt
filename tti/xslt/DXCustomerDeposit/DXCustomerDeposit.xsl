   ...
   <xsl:template match="b:DXCustomer">
      <InfraPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('DXCustomerDeposit',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Deposit>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('DXCustomerDeposit.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="Deposit" userelativepaths="yes" externalpreview="no" url="..\..\..\testfiles\DXCustomer\DXCustomer.xml" htmlbaseurl="" outputurl="..\..\..\testfiles\DXCustomer\DXCustomerGWP.xml" processortype="jaxp" useresolver="no"
		          profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext=""
		          validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
