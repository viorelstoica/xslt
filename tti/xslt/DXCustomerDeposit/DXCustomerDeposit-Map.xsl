...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0" xmlns="http://www.odcgroup.com/InfraPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/DXCustomer" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchDXCustomer"
	...
	<xsl:import href="DXCustomerDeposit-Core.xsl"/>
    <xsl:import href="DXCustomerDeposit-Custo.xsl"/>
	<xsl:import href="DXCustomerDeposit.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="Deposit" userelativepaths="yes" externalpreview="no" url="..\..\..\testfiles\DXCustomer\DXCustomer.xml" htmlbaseurl="" outputurl="..\..\..\testfiles\DXCustomer\DXCustomerFilter.xml" processortype="jaxp"
		          useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath=""
		          postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
