...
<xsl:stylesheet exclude-result-prefixes="b c d e f g ns0 batch multibatch" version="1.0" 
	...
	<xsl:import href="TransactionPaymentOutgoingRevTPH-Core.xsl"/>
	<xsl:import href="TransactionPaymentOutgoingRevTPH-Custo.xsl"/>
	<xsl:import href="TransactionPaymentOutgoingRevTPH.xsl"/>
