...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/Request" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/T24StatusChangeCancelUpdate"
	...
	<xsl:import href="T24StatusChangeCancelUpdate-Core.xsl"/>
	<xsl:import href="T24StatusChangeCancelUpdate-Custo.xsl"/>
	<xsl:import href="T24StatusChangeCancelUpdate.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="T24StatusChangeCancelUpdate" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\T24StatusChangeCancelUpdate\T24StatusChangeCancelUpdate.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\T24StatusChangeCancelUpdate\T24StatusChangeCancelUpdateGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
