...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="TransactionSecurityBuy-Filter-Core.xsl"/>
    <xsl:import href="TransactionSecurityBuy-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="yes" url="..\..\ant\primaryTests\test_ValidB2fFlow\Online_TransactionSecurityBuy.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionSecurityBuy\TransactionSecurityBuyCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
