   ...
   <xsl:template match="b:SyImf">
      <StructuredProducts>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('FinancialInstrumentSyIMFDP',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DualCurrencyInvestment>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('FinancialInstrumentSyIMFDP.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FinancialInstrumentSyIMFDP" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumentSyIMFDP\FinancialInstrumentSyIMFDPFilter.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentSyIMFDP\FinancialInstrumentSyIMFDPGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
