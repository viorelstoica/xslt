...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="OrderGroupingCutOffDateChange-Core.xsl"/>
    <xsl:import href="OrderGroupingCutOffDateChange-Custo.xsl"/>
	<xsl:import href="OrderGroupingCutOffDateChange.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="OrderGroupingCutOffDateChange" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumentMiniFutureTurbo\FinancialInstrumentMiniFutureTurbo2Filter.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentMiniFutureTurbo\FinancialInstrumentMiniFutureTurbo2FilterKiran.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
