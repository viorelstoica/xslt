...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="SpRevConvBondLinked-Core.xsl"/>
	<xsl:import href="SpRevConvBondLinked-Custo.xsl"/>
	<xsl:import href="SpRevConvBondLinked.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SpRevConvBondLinked" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SpRevConvBondLinked\SpRevConvBondLinked.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SpRevConvBondLinked\SpRevConvBondLinkedGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
