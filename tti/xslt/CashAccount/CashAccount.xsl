...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/CashAccount" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchCashAccount" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiCashAccount" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiCashAccount" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   ...
   <xsl:template match="c:MultiCashAccount">
      <xsl:apply-templates select="c:CurrentEvent/b:CashAccount"/>
   </xsl:template>
   <xsl:template match="batch:BatchCashAccount">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchCashAccount" name="BatchCashAccount">
         <xsl:apply-templates select="b:CashAccount"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiCashAccount">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiCashAccount" name="BatchMultiCashAccount">
         <xsl:apply-templates select="c:MultiCashAccount"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:CashAccount">
      <FiPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('cashAccount',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <CashAccount>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('CashAccount.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
