...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="FinancialInstrumentCommodity-Core.xsl"/>
    <xsl:import href="FinancialInstrumentCommodity-Custo.xsl"/>
	<xsl:import href="../FinancialInstrumentCommodity-Partial-Core.xsl"/>
    <xsl:import href="../FinancialInstrumentCommodity-Partial-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentCommodity-Partial-Core.xsl"/>
    <xsl:import href="FinancialInstrumentCommodity-Partial-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentCommodity-Partial.xsl"/>
