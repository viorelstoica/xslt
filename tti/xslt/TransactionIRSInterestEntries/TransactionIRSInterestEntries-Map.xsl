...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/AcEntry/AcEntry" xmlns:batch="http://www.temenos.com/T24/event/AcEntry/BatchAcEntry"
	...
	<xsl:import href="TransactionIRSInterestEntries-Core.xsl"/>
	<xsl:import href="TransactionIRSInterestEntries-Custo.xsl"/>
	<xsl:import href="TransactionIRSInterestEntries.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionIRSInterestEntries" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionIRSInterestEntries\TransactionIRSentries.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionIRSInterestEntries\TransactionIRSentriesGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
