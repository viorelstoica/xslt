				...
				<xsl:otherwise>
					<xsl:choose>
						<xsl:when test="../b:tapOperCode and ../b:tapOperCode != ''">
							<xsl:value-of select="concat(../b:tapOperCode,'_',../b:id,$COMPANY_POSTFIX_SEPARATOR,../b:companyMnemonic,$COMPANY_POSTFIX_SEPARATOR,b:securityNo,$COMPANY_POSTFIX_SEPARATOR,'R')"/>
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="concat(../b:id,$COMPANY_POSTFIX_SEPARATOR,../b:companyMnemonic,$COMPANY_POSTFIX_SEPARATOR,b:securityNo,$COMPANY_POSTFIX_SEPARATOR,'R')"/>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:otherwise>
			</xsl:choose>
		...
		<reversedTransactionCode>
			<xsl:choose>
				...
				<xsl:otherwise>
					<xsl:choose>
						<xsl:when test="../b:tapOperCode and ../b:tapOperCode != ''">
							<xsl:value-of select="concat(../b:tapOperCode,'_',../b:id,$COMPANY_POSTFIX_SEPARATOR,../b:companyMnemonic,$COMPANY_POSTFIX_SEPARATOR,b:securityNo)"/>
						</xsl:when>
						<xsl:otherwise>
							<xsl:value-of select="concat(../b:id,$COMPANY_POSTFIX_SEPARATOR,../b:companyMnemonic,$COMPANY_POSTFIX_SEPARATOR,b:securityNo)"/>
						</xsl:otherwise>
					</xsl:choose>
				</xsl:otherwise>
			</xsl:choose>
