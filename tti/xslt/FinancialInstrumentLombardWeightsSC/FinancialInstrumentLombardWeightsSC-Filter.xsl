...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/FinancialInstrumentSecurity"
	...
	<xsl:import href="FinancialInstrumentLombardWeightsSC-Filter-Core.xsl"/>
	<xsl:import href="FinancialInstrumentLombardWeightsSC-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FinancialInstrumentLombardWeightsSC" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\FinancialInstrumentLombrdWeightSC\FinancialInstrumentLombardWeightSC.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentLombrdWeightSC\FinancialInstrumentLombardWeightSC.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
