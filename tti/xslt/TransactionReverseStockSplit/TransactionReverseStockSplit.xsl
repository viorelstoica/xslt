   ...
   <xsl:template match="b:TransactionEntitlement">
      <CorporateActionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('CoaReverseStockSplit',b:diaryId)"/>
                  ...
                  <TwoLegs>
                     <Link>
                        <xsl:attribute name="description">
                           <xsl:value-of select="concat('TransactionReverseStockSplit.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
                        </xsl:attribute>
                        ...
                        <xsl:call-template name="unitaryCostPrice"/>   
                     </Link>
                  </TwoLegs>
               </Security>
            </ReverseStockSplit>
