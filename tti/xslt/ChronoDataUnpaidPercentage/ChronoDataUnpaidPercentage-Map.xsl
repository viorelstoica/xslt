...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchChronoDataUnpaidPercentage"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiChronoDataUnpaidPercentage"
    ...
    <xsl:import href="ChronoDataUnpaidPercentage-Core.xsl"/>
    <xsl:import href="ChronoDataUnpaidPercentage-Custo.xsl"/>
	<xsl:import href="ChronoDataUnpaidPercentage.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="ChronoDataUnpaidPercentage" userelativepaths="yes" externalpreview="no" url="..\..\AUTO_TEST\Online\ChronoDataUnpaidPercentage\ChronoDataUnpaidPercentage_msg-1.xml" htmlbaseurl=""
		          outputurl="..\..\AUTO_TEST\Online\ChronoDataUnpaidPercentage\ChronoDataUnpaidPercentage_msg-1Filter.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
