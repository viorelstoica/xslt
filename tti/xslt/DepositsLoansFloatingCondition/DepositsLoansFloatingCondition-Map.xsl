...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchDepositsLoansFloatingCondition"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiDepositsLoansFloatingCondition"
    ...
    <xsl:import href="DepositsLoansFloatingCondition-Core.xsl"/>
    <xsl:import href="DepositsLoansFloatingCondition-Custo.xsl"/>
	<xsl:import href="DepositsLoansFloatingCondition.xsl"/>
