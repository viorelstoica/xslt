...
<xsl:stylesheet exclude-result-prefixes="b" version="1.0"
    ...
    <xsl:import href="TransactionCashInvestWithdrawal-Core.xsl"/>
    <xsl:import href="TransactionCashInvestWithdrawal-Custo.xsl"/>
	<xsl:import href="TransactionCashInvestWithdrawal.xsl"/>
