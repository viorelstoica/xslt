...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/CurrencyExchangeRate"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchCurrencyExchangeRate"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiCurrencyExchangeRate"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiCurrencyExchangeRate" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="CurrencyExchangeRate-Core.xsl"/>
    <xsl:import href="CurrencyExchangeRate-Custo.xsl"/>
	<xsl:import href="CurrencyExchangeRate.xsl"/>
