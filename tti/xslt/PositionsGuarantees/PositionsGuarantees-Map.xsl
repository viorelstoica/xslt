...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/PositionsGuarantees"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchPositionsGuarantees"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiPositionsGuarantees"
    ...
    <xsl:import href="PositionsGuarantees-Core.xsl"/>
    <xsl:import href="PositionsGuarantees-Custo.xsl"/>
	<xsl:import href="PositionsGuarantees.xsl"/>
