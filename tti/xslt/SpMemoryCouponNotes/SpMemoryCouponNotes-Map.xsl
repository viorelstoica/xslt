...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="SpMemoryCouponNotes-Core.xsl"/>
	<xsl:import href="SpMemoryCouponNotes-Custo.xsl"/>
	<xsl:import href="SpMemoryCouponNotes.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SpMemoryCouponNotes" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SpMemoryCouponNotes\SpMemoryCouponNotes.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SpMemoryCouponNotes\SpMemoryCouponNotesGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
