...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferPtfToPtfWithdr"
	...
	<xsl:import href="PositionTransferPtfToPtfWithdr-Core.xsl"/>
	<xsl:import href="PositionTransferPtfToPtfWithdr-Custo.xsl"/>
	<xsl:import href="PositionTransferPtfToPtfWithdr.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PositionTransferPtfToPtfWithdr" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PositionTransferPtfTpPtfWithdr\PositionTransferPtfToPtfWithdr.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PositionTransferPtfTpPtfWithdr\PositionTransferPtfToPtfWithdrGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
