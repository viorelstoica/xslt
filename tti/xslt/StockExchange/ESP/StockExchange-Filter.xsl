...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0" xmlns="http://www.odcgroup.com/InfraPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/StockExchange" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchStockExchange"
                xmlns:c="http://www.temenos.com/T24/event/TTI/MultiStockExchange" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiStockExchange" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:import href="../StockExchange-Filter-Core.xsl"/>
	<xsl:import href="../StockExchange-Filter-Custo.xsl"/>
	<xsl:import href="StockExchange-Filter-Core.xsl"/>
	<xsl:import href="StockExchange-Filter-Custo.xsl"/>
