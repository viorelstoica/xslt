   ...
   <xsl:template match="b:SyDci">
      <TransactionPMS mode="INSUPD">
         <xsl:attribute name="output">
            <xsl:value-of select="concat('DCIUnwindingFee',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Cash>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('DCIUnwindingFee.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="AccuDecuUnwindingFee" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\AccuDecuUnwindingFee\AccuDecuUnwindingFee.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\AccuDecuUnwindingFee\AccuDecuUnwindingFeeGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
