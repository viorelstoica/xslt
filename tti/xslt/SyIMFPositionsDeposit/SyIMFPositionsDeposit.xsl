   ...
   <xsl:template match="b:SyImf">
      <PositionPMS mode="INSUPD">
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SyIMFPositionsDeposit',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoansPosition>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SyIMFPositionsDeposit.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PositionFiduciary" userelativepaths="yes" externalpreview="no" url="..\..\..\SyImf.xml" htmlbaseurl="" outputurl="..\..\..\SyImfGWP.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth=""
