...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="BusinessEntityAccProfileHisto-Core.xsl"/>
	<xsl:import href="BusinessEntityAccProfileHisto-Custo.xsl"/>
	<xsl:import href="BusinessEntityAccProfileHisto.xsl"/>
