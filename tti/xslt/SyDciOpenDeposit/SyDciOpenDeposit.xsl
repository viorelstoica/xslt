   ...
   <xsl:template match="b:SyDci">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SyDciOpenDeposit',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SyDciOpenDeposit.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SyDciOpenDeposit" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyDciOpenDeposit\SyDciOpenDeposit.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyDciOpenDeposit\SyDciOpenDeposit_GWP.xml"
