...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="FinancialInstrumentStock.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FinancialInstrumentStock" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\FinancialInstrumentStock\FinancialInstrumentStock.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentStock\FinancialInstrumentStockGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
