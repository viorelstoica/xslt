   ...
   <xsl:template match="b:SyImfRollover">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SyIMFLoanDec',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SyIMFLoanDec.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
               ...
               <loancapitalDecrease>
                  ...
                  <xsl:call-template name="loanCapitalDecrease"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyIMFLoanDec\SyIMFLoanDecFilter.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyIMFLoanDec\SyIMFLoanDecGWP.xml" processortype="saxon8"
