   ...
   <xsl:template match="b:FdFidOrder">
      <TransactionPMS mode="INSUPD">
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransactionFiduciaryTransfer',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionFiduciaryTransfer.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
               ...
               <depositTransfer>
				  ...
				  <xsl:call-template name="adjustedPortfolio"/>
				  <xsl:call-template name="operationCurrency"/>
				  <xsl:call-template name="operationDate"/>
				  <xsl:call-template name="operationNature"/>
				  <xsl:call-template name="portfolioCurrency"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionFiduciaryTransfer" userelativepaths="yes" externalpreview="no" url="..\..\..\testfiles\FdFidOrder\FdFidOrder.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionFiduciaryTransfer\TransactionFiduciaryTransferGWP.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
