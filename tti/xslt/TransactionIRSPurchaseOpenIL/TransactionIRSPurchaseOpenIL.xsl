   ...
   <xsl:template match="b:IRSswap">
      <TransactionPMS mode="INSUPD">
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransactionIRSPurchaseOpenIL',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <IrSwap>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionIRSPurchaseOpenIL.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionIRSPurchaseOpen\TransactionIRSPurchasOpenFilter.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionIRSPurchaseOpen\TransactionIRSPurchasGWP2xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
