...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="OrderGroupingForSubscriptionRedemption-Core.xsl"/>
    <xsl:import href="OrderGroupingForSubscriptionRedemption-Custo.xsl"/>
	<xsl:import href="OrderGroupingForSubscriptionRedemption.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="OrderGroupingForSubscriptionRedemption" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumentMiniFutureTurbo\FinancialInstrumentMiniFutureTurbo2.xml" htmlbaseurl=""
