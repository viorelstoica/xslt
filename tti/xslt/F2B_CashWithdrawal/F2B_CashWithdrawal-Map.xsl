...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.temenos.com/T24/OFSML/150" xmlns:b="http://www.odcgroup.com/F2B_MM_FX" xmlns:infra="http://www.odcgroup.com/InfraPMS" exclude-result-prefixes="b" version="1.0">
	...
	<xsl:import href="F2B_CashWithdrawal-Core.xsl"/>
	<xsl:import href="F2B_CashWithdrawal-Custo.xsl"/>
	<xsl:import href="F2B_CashWithdrawal.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="F2B_CashWithdrawal" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\F2B_CashWithdrawal\F2B_MM_Cash_WithdrawalRequest.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\F2B_CashWithdrawal\F2B_MM_Cash_WithdrawalRequestT24.xml" processortype="msxmldotnet" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
