...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="TransactionPaymentOrderCreditRev-Core.xsl"/>
    <xsl:import href="TransactionPaymentOrderCreditRev-Custo.xsl"/>
	<xsl:import href="TransactionPaymentOrderCreditRev.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="TransactionPaymentOrderCreditRev" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionPaymentOrderCreditRev\TransactionPaymentOrderDebitInput.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionPaymentOrderCreditRev\TransactionPaymentOrderDebitCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
