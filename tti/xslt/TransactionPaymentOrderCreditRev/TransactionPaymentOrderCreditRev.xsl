	...
	<xsl:template match="b:PaymentOrder">
		<TransactionPMS>
			...
			<xsl:attribute name="output">
				<xsl:value-of select="concat('TransactionPaymentOrderCreditRev',b:id)"/>
			</xsl:attribute>
			<DataGroup>
				<Cash>
					<xsl:attribute name="description">
						<xsl:value-of select="concat('TransactionPaymentOrderCreditRev.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
					</xsl:attribute>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="TransactionPaymentOrderCreditRev" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionPaymentOrderCreditRev\TransactionPaymentOrderDebitCusto.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionPaymentOrderCreditRev\TransactionPaymentOrderDebitGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
