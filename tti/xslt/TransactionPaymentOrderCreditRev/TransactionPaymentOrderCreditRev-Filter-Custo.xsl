...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:apply-templates select="self::b:PaymentOrder[not(b:paymentOrderProduct = 'TRAILERFEE')]" mode="filter-final"/>
	</xsl:template> 
	</xsl:stylesheet>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="TransactionPaymentOrderCreditRev" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionPaymentOrderCreditRev\TransactionPaymentOrderCreditRev.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionPaymentOrderCreditRev\TransactionPaymentOrderCreditRevCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
