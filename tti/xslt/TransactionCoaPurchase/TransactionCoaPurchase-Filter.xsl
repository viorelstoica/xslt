...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/GenericCOA" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionEntitlement" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchTransactionEntitlement"
	...
	<xsl:import href="TransactionCoaPurchase-Filter-Core.xsl"/>
	<xsl:import href="TransactionCoaPurchase-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionCoaPurchase" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionCoaPurchase\TransactionCoaPurchaseT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionCoaPurchase\TransactionCoaPurchase.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
