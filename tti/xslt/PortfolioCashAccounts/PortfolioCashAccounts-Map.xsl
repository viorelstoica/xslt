...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/PortfolioCashAccounts"
	...
	<xsl:import href="PortfolioCashAccounts-Core.xsl"/>
	<xsl:import href="PortfolioCashAccounts-Custo.xsl"/>
	<xsl:import href="PortfolioCashAccounts.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PortfolioCashAccounts" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PortfolioCashAccounts\PortfolioCashAccounts.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PortfolioCashAccounts\PortfolioCashAccountsGWP.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
