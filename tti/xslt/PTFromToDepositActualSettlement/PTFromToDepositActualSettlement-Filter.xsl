...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/GenericCOA" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferScSettlement"
	...
	<xsl:import href="PTFromToDepositActualSettlement-Filter-Core.xsl"/>
	<xsl:import href="PTFromToDepositActualSettlement-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PTFromToDepositActualSettlement" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PTFromToDepositActualSettlement\PTFromToDepositActualSettlementT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PTFromToDepositActualSettlement\PTFromToDepositActualSettlement.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
