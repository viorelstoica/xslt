         ...
         <DataGroup>
            <EventStatus>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('DXOrderCancelAccepted.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DXOrderCancelAccepted" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\DXOrderCancelAccepted\Filter.xml" htmlbaseurl="" outputurl="..\..\TestFiles\DXOrderCancelAccepted\GWP.xml" processortype="jaxp"
		          useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath=""
		          postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
