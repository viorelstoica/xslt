...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="DXOrderCancelAccepted-Core.xsl"/>
    <xsl:import href="DXOrderCancelAccepted-Custo.xsl"/>
	<xsl:import href="DXOrderCancelAccepted.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DXOrderCancelAccepted" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\DXOrderUpdateAccepted\20170302_102032_887_45_msgin_MultiDXT24StatusChange_1149b757-4a3e-4906-8290-0a5611df8b11.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\DXOrderCancelAccepted\Filter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
