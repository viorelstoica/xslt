...
<xsl:stylesheet exclude-result-prefixes="b c d e f g ns0 batch multibatch"
    ...
    <xsl:import href="TransactionPaymentIncomingTPH-Core.xsl"/>
    <xsl:import href="TransactionPaymentIncomingTPH-Custo.xsl"/>
	<xsl:import href="TransactionPaymentIncomingTPH.xsl"/>
