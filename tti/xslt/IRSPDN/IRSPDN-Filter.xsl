...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchIRSNotionalPrinChange"
	...
	<xsl:import href="IRSPDN-Filter-Core.xsl"/>
	<xsl:import href="IRSPDN-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="IRSPDN" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\IRSPDN\IRSPDNT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\IRSPDN\IRSPDN.xml" processortype="jaxp" useresolver="no" profilemode="0"
