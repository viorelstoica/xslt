...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/CustomerType"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchCustomerType"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiCustomerType"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiCustomerType" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="CustomerType-Core.xsl"/>
    <xsl:import href="CustomerType-Custo.xsl"/>
	<xsl:import href="CustomerType.xsl"/>
