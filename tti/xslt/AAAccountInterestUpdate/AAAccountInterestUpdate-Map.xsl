...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/AAAccountInterestUpdate"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchAAAccountInterestUpdate"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiAAAccountInterestUpdate"
    ...
    <xsl:import href="AAAccountInterestUpdate-Core.xsl"/>
    <xsl:import href="AAAccountInterestUpdate-Custo.xsl"/>
	<xsl:import href="AAAccountInterestUpdate.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DepositsLoansFloatingCondition" userelativepaths="yes" externalpreview="no" url="..\accounts.xml" htmlbaseurl="" outputurl="..\accountsout.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth=""
