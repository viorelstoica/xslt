...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/NdDeal"
	...
	<xsl:import href="NdForwardPurchaseClosing-Filter-Core.xsl"/>
	<xsl:import href="NdForwardPurchaseClosing-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="NdForwardPurchaseClosing" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\NdForwardPurchaseClosing\NdForwardPurchaseClosingT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\NdForwardPurchaseClosing\NdForwardPurchaseClosingPostFilter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
