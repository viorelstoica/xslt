...
<xsl:stylesheet xmlns="http://www.odcgroup.com/StructuredProducts"
   ...
   <xsl:template name="shortName">
      <infra:shortName>
         <xsl:value-of select="concat('IMF',$COMPANY_POSTFIX_SEPARATOR,b:depositCcy,$COMPANY_POSTFIX_SEPARATOR,b:loanCcy,$COMPANY_POSTFIX_SEPARATOR,b:maturityDate)"/>
      </infra:shortName>
   </xsl:template>
