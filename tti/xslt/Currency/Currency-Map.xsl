...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0"
    xmlns="http://www.odcgroup.com/InfraPMS"
    xmlns:b="http://www.temenos.com/T24/event/TTI/Currency"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchCurrency"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiCurrency"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiCurrency" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="Currency-Core.xsl"/>
    <xsl:import href="Currency-Custo.xsl"/>
