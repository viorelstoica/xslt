...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="FinancialInstrumentConvertibleBond-Core.xsl"/>
    <xsl:import href="FinancialInstrumentConvertibleBond-Custo.xsl"/>
	<xsl:import href="../FinancialInstrumentConvertibleBond-Partial-Core.xsl"/>
    <xsl:import href="../FinancialInstrumentConvertibleBond-Partial-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentConvertibleBond-Partial-Core.xsl"/>
    <xsl:import href="FinancialInstrumentConvertibleBond-Partial-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentConvertibleBond-Partial.xsl"/>
