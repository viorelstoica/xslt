...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="FinancialInstrumentConvertibleBond-Core.xsl"/>
    <xsl:import href="FinancialInstrumentConvertibleBond-Custo.xsl"/>
	<xsl:import href="../FinancialInstrumentConvertibleBond-PartialD-Core.xsl"/>
    <xsl:import href="../FinancialInstrumentConvertibleBond-PartialD-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentConvertibleBond-PartialD-Core.xsl"/>
    <xsl:import href="FinancialInstrumentConvertibleBond-PartialD-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentConvertibleBond-PartialD.xsl"/>
