	...
	<xsl:template match="b:PaymentOrderNotification">
		<TransactionPMS>
			...
			<xsl:attribute name="output">
				<xsl:value-of select="concat('CsdTransactionPaymentOrderNotificationDebit',b:id)"/>
			</xsl:attribute>
			<DataGroup>
				<Cash>
					<xsl:attribute name="description">
						<xsl:value-of select="concat('CsdTransactionPaymentOrderNotificationDebit.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
					</xsl:attribute>
