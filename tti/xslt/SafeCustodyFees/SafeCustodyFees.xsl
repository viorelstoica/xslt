...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/SafeCustodyFees" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchSafeCustodyFees" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiSafeCustodyFees" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiSafeCustodyFees" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   <xsl:output encoding="UTF-8" indent="yes" method="xml"/>
   <xsl:template match="c:MultiSafeCustodyFees">
      <xsl:apply-templates select="c:CurrentEvent/b:SafeCustodyFees"/>
   </xsl:template>
   <xsl:template match="batch:BatchSafeCustodyFees">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchSafeCustodyFees" name="BatchSafeCustodyFees">
         <xsl:apply-templates select="b:SafeCustodyFees"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiSafeCustodyFees">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiSafeCustodyFees" name="BatchMultiSafeCustodyFees">
         <xsl:apply-templates select="c:MultiSafeCustodyFees"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:SafeCustodyFees">
      <TransactionPMS>
         <xsl:attribute name="mode">INSUPD</xsl:attribute>
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SafeCustodyFees',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Cash>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SafeCustodyFees.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
