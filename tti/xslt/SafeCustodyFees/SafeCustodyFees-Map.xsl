...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/SafeCustodyFees"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchSafeCustodyFees"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiSafeCustodyFees"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiSafeCustodyFees" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="SafeCustodyFees-Core.xsl"/>
    <xsl:import href="SafeCustodyFees-Custo.xsl"/>
	<xsl:import href="SafeCustodyFees.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="ManagementFees" userelativepaths="yes" externalpreview="no" url="..\safe1.xml" htmlbaseurl="" outputurl="..\safe2.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength=""
