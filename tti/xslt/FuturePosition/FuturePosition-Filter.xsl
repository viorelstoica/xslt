...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/PositionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/FuturePosition" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFuturePosition"
	...
	<xsl:import href="FuturePosition-Filter-Core.xsl"/>
	<xsl:import href="FuturePosition-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FuturePosition" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\FuturePosition\FuturePositionT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\FuturePosition\FuturePositionPostFilter.xml"
