...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="SyIMFOpenLoan-Core.xsl"/>
    <xsl:import href="SyIMFOpenLoan-Custo.xsl"/>
	<xsl:import href="SyIMFOpenLoan.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyIMFOpenLoan\SyIMFOpenLoan.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyIMFOpenLoan\SyIMFOpenLoanFilter.xml" processortype="jaxp"
