   ...
   <xsl:template match="b:FdFidOrder">
      <FiPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('FinancialInstrumentFiduciaryInit',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <MoneyMarket>
               <SpecificMoneyMarket>
                  <xsl:attribute name="description">
                     <xsl:value-of select="concat('FinancialInstrumentFiduciaryInit.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
                  </xsl:attribute>
