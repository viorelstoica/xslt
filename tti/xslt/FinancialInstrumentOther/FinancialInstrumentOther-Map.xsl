...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="FinancialInstrumentOther-Core.xsl"/>
	<xsl:import href="FinancialInstrumentOther-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentOther.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FinancialInstrumentOther" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\FinancialInstrumentOther\FinancialInstrumentOther.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentOther\FinancialInstrumentOtherGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
