...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:template match="b:FinancialInstrumentSecurity">
		<FiPMS>
			...
			<xsl:attribute name="output">
				<xsl:value-of select="concat('FinancialInstrumentOther',b:id)"/>
			</xsl:attribute>
			<DataGroup>
				<Other>
					<xsl:attribute name="description">
						<xsl:value-of select="concat('FinancialInstrumentOther.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
					</xsl:attribute>
					...
					<xsl:call-template name="eomConversion"/>
	...
	<xsl:template match="d:FinancialInstrumentME">
		<FiPMS>
			<xsl:attribute name="mode">INSUPD</xsl:attribute>
			<xsl:attribute name="output">
				<xsl:value-of select="concat('FinancialInstrumentOther',d:id)"/>
			</xsl:attribute>
			<DataGroup>
				<Other>
					<xsl:attribute name="description">
						<xsl:value-of select="concat('FinancialInstrumentOther.xsl+', name(/*), '+', d:eventCommon/ns0:eventId, '+', d:eventCommon/ns0:creationTime)"/>
					</xsl:attribute>
					<xsl:attribute name="sequenceNumber">
						<xsl:call-template name="calcSeqNum">
							<xsl:with-param name="creationTime">
					...
					<xsl:call-template name="notepad-custo_MultiEntity"/>
					...
					<xsl:call-template name="contractSize_MultiEntity"/>
					...
					<xsl:call-template name="eomConversion_MultiEntity"/>
					...
					<xsl:call-template name="lastTradeDate_MultiEntity"/>
					...
					<xsl:call-template name="nature_MultiEntity"/>
