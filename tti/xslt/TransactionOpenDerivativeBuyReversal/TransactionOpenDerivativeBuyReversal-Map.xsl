...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionOpenDerivativeBuyReversal"
	...
	<xsl:import href="TransactionOpenDerivativeBuyReversal-Core.xsl"/>
	<xsl:import href="TransactionOpenDerivativeBuyReversal-Custo.xsl"/>
	<xsl:import href="TransactionOpenDerivativeBuyReversal.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionOpenDerivativeBuylReversal" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionOpenDerivativeBuyReversal\TransactionOpenDerivativeBuyReversal.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionOpenDerivativeBuyReversal\TransactionOpenDerivativeBuyReversalGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
