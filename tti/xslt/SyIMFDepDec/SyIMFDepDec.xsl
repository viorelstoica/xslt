   ...
   <xsl:template match="b:SyImfRollover">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SyIMFDepDec',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SyIMFDepDec.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
               ...
               <depositcapitalDecrease>
                  ...
                  <xsl:call-template name="depositCapitalDecrease"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyIMFDepDec\SyIMFDepDecFilter.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyIMFDepDec\SyIMFDepDecGWP.xml" processortype="saxon8"
