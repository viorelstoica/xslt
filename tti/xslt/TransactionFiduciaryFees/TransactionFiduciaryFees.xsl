   ...
   <xsl:template match="b:AcEntry">
      <TransactionPMS mode="INSUPD">
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransactionFiduciaryFees',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionFiduciaryFees.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionFiduciaryInitiate" userelativepaths="yes" externalpreview="no" url="..\..\..\..\testfiles\TransactionLDCommAndChrg\20170117_141229_237_46_msgin_AcEntry_70a34192-6a74-4bb8-93c4-0e4ef3797028.xml"
		          htmlbaseurl="" outputurl="..\..\TestFiles\TransactionFiduciaryFees\TransactionFiduciaryFeesGWP.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
