...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="FinancialInstrumentYieldCurve-Core.xsl"/>
    <xsl:import href="FinancialInstrumentYieldCurve-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentYieldCurve.xsl"/>
