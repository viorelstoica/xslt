...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFinancialInstrumentYieldCurve"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiFinancialInstrumentYieldCurve"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiFinancialInstrumentYieldCurve" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="b:FinancialInstrumentYieldCurve">
		<xsl:apply-templates select="self::b:FinancialInstrumentYieldCurve[not(b:rfrRate)]" mode="filter-custo"/>
	</xsl:template>
	<!-- Custo placeholder -->
	<xsl:template match="b:FinancialInstrumentYieldCurve" mode="filter-custo">
		<xsl:apply-templates select="self::b:FinancialInstrumentYieldCurve" mode="filter-final"/>
	</xsl:template>
	<!-- Copy block -->
	<xsl:template match="b:FinancialInstrumentYieldCurve" mode="filter-final">
		<xsl:copy>
			<xsl:apply-templates select="@* | node()"/>
		</xsl:copy>
	</xsl:template>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FinancialInstrumentYieldCurve" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumentYieldCurve\FinancialInstrumentYieldCurve.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentYieldCurve\FinancialInstrumentYieldCurveCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
		          additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
