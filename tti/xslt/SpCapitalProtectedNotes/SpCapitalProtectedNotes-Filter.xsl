...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="SpCapitalProtectedNotes-Filter-Core.xsl"/>
	<xsl:import href="SpCapitalProtectedNotes-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SpCapitalProtectedNotes" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SpCapitalProtectedNotes\SpCapitalProtectedNotesT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SpCapitalProtectedNotes\SpCapitalProtectedNotes.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
