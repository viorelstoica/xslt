...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchIRSNotionalPrinChange"
	...
	<xsl:import href="IRSPIN-Filter-Core.xsl"/>
	<xsl:import href="IRSPIN-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="IRSPIN" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\IRSPIN\IRSPINT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\IRSPIN\IRSPIN.xml" processortype="jaxp" useresolver="no" profilemode="0"
