...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="TransactionPaymentOrderDebit-Core.xsl"/>
    <xsl:import href="TransactionPaymentOrderDebit-Custo.xsl"/>
	<xsl:import href="TransactionPaymentOrderDebit.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="TransactionPaymentOrderDebit" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionPaymentOrderDebit\TransactionPaymentOrderDebitInput.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionPaymentOrderDebit\TransactionPaymentOrderDebitCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
