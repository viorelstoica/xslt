...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="ChronoDataFund-Filter-Core.xsl"/>
    <xsl:import href="ChronoDataFund-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="ChronologicalDataFixedIncome" userelativepaths="yes" externalpreview="no" url="..\msgin.xml" htmlbaseurl="" outputurl="..\msgfil.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth=""
