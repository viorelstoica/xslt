...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionBuyGuaranteeReceived" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchTransactionBuyGuaranteeReceived" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiTransactionBuyGuaranteeReceived" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiTransactionBuyGuaranteeReceived" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   ...
   <xsl:template match="c:MultiTransactionBuyGuaranteeReceived">
      <xsl:apply-templates select="c:CurrentEvent/b:TransactionBuyGuaranteeReceived"/>
   </xsl:template>
   <xsl:template match="batch:BatchTransactionBuyGuaranteeReceived">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchTransactionBuyGuaranteeReceived" name="BatchTransactionBuyGuaranteeReceived">
         <xsl:apply-templates select="b:TransactionBuyGuaranteeReceived"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiTransactionBuyGuaranteeReceived">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiTransactionBuyGuaranteeReceived" name="BatchMultiTransactionBuyGuaranteeReceived">
         <xsl:apply-templates select="c:MultiTransactionBuyGuaranteeReceived"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:TransactionBuyGuaranteeReceived">
      <TransactionPMS mode="INSUPD">
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransactionBuyGuaranteeReceived',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Security>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionBuyGuaranteeReceived.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
