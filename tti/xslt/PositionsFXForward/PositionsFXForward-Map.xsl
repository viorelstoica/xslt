...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/PositionPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionsForex"
	...
	<xsl:import href="PositionsFXForward-Core.xsl"/>
	<xsl:import href="PositionsFXForward-Custo.xsl"/>
	<xsl:import href="PositionsFXForward.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PositionsFXForward" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PositionsFXForward\PositionsFXForward.xml" htmlbaseurl="" outputurl="..\..\TestFiles\PositionsFXForward\PositionsFXForwardGWP.xml"
