...
<xsl:stylesheet exclude-result-prefixes="b" version="1.0"
	...
	xmlns:forex="http://www.temenos.com/T24/forex" 
	xmlns:nddeal="http://www.temenos.com/T24/nddeal"
    ...
    <xsl:import href="../F2B_FXForwardPurchase-Core.xsl"/>
    <xsl:import href="../F2B_FXForwardPurchase-Custo.xsl"/>
	<xsl:import href="F2B_FXForwardPurchase-Core.xsl"/>
    <xsl:import href="F2B_FXForwardPurchase-Custo.xsl"/>
	<xsl:import href="../F2B_FXForwardPurchase.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\F2B_FXFormard\F2B_FXForward.xml" htmlbaseurl="" outputurl="..\..\TestFiles\F2B_FXFormard\F2B_FXForwardFilter.xml" processortype="jaxp"
