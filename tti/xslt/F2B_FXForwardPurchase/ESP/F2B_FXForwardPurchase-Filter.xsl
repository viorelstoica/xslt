...
<xsl:stylesheet exclude-result-prefixes="b" version="1.0"
    ...
    <xsl:import href="../F2B_FXForwardPurchase-Filter-Core.xsl"/>
    <xsl:import href="../F2B_FXForwardPurchase-Filter-Custo.xsl"/>
	<xsl:import href="F2B_FXForwardPurchase-Filter-Core.xsl"/>
    <xsl:import href="F2B_FXForwardPurchase-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\F2B_FXFormard\F2B_FXForward.xml" htmlbaseurl="" outputurl="..\..\TestFiles\F2B_FXFormard\F2B_FXForwardFilter.xml" processortype="jaxp"
