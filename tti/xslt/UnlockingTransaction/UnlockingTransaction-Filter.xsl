...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="UnlockingTransaction-Filter-Core.xsl"/>
	<xsl:import href="UnlockingTransaction-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="UnlockingTransaction" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\UnlockingTransaction\UnlockingTransactionT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\UnlockingTransaction\UnlockingTransaction.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
