...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="UnlockingTransaction-Core.xsl"/>
	<xsl:import href="UnlockingTransaction-Custo.xsl"/>
	<xsl:import href="UnlockingTransaction.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="UnlockingTransaction" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\UnlockingTransaction\UnlockingTransaction.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\UnlockingTransaction\UnlockingTransactionGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
