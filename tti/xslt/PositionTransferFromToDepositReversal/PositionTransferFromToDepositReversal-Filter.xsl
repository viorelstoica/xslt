...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/GenericCOA" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferFromToDepositReversal"
	...
	<xsl:import href="PositionTransferFromToDepositReversal-Filter-Core.xsl"/>
	<xsl:import href="PositionTransferFromToDepositReversal-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PositionTransferFromToDepositReversal" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PositionTransferFromToDepositReversal\PositionTransferFromToDepositReversalT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PositionTransferFromToDepositReversal\PositionTransferFromToDepositReversal.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
