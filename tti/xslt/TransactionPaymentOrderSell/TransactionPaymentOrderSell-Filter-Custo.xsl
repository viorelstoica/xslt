...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="TransactionPaymentOrderSell" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionPaymentOrderSell\TransactionPaymentOrderSell.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionPaymentOrderSell\TransactionPaymentOrderSellCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
