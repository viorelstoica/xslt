...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/CgTxnBase"
	...
	<xsl:import href="TaxLotIL-Filter-Core.xsl"/>
	<xsl:import href="TaxLotIL-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TaxLotIL_BatchFile" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TaxLotIL\TaxLotILT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\TaxLotIL\TaxLotIL.xml" processortype="jaxp" useresolver="no"
