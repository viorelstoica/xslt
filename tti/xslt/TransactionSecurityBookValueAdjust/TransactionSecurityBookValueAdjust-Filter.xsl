...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionSecurityBookValueAdjust"
	...
	<xsl:import href="TransactionSecurityBookValueAdjust-Filter-Core.xsl"/>
	<xsl:import href="TransactionSecurityBookValueAdjust-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionSecurityBookValueAdjust" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionSecurityBookValueAdjust\TransactionSecurityBookValueAdjustT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionSecurityBookValueAdjust\TransactionSecurityBookValueAdjust.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
