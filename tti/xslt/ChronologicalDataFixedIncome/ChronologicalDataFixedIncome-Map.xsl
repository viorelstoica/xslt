...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="ChronologicalDataFixedIncome-Core.xsl"/>
    <xsl:import href="ChronologicalDataFixedIncome-Custo.xsl"/>
	<xsl:import href="ChronologicalDataFixedIncome.xsl"/>
