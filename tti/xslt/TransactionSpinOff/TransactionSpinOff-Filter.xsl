...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/CorporateActionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionEntitlement"
	...
	<xsl:import href="TransactionSpinOff-Filter-Core.xsl"/>
	<xsl:import href="TransactionSpinOff-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionSpinOff" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionSpinOff\TransactionSpinOffT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\TransactionSpinOff\TransactionSpinOff.xml"
