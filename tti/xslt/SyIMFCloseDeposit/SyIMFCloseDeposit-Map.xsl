...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="SyIMFCloseDeposit-Core.xsl"/>
    <xsl:import href="SyIMFCloseDeposit-Custo.xsl"/>
	<xsl:import href="SyIMFCloseDeposit.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyIMFCloseDeposit\SyIMFCloseDeposit.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyIMFCloseDeposit\SyIMFCloseDepositFilter.xml"
