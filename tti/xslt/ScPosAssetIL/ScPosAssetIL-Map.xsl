...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/generic" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/ScPosAsset"
	...
	<xsl:import href="ScPosAssetIL-Core.xsl"/>
	<xsl:import href="ScPosAssetIL-Custo.xsl"/>
	<xsl:import href="ScPosAssetIL.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="ScPosAsset" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\ScPosAssetIL\ScPosAssetILPostFilter.xml" htmlbaseurl="" outputurl="..\..\TestFiles\ScPosAssetIL\ScPosAssetILPostProcess.xml"
