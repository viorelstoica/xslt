...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="FinancialInstrumentSyMasterPartFwd-Filter-Core.xsl"/>
    <xsl:import href="FinancialInstrumentSyMasterPartFwd-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FinancialInstrumentSyMasterPartFwd" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumentSyMasterPartFwd\FinancialInstrumentSyMasterPartFwd.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentSyMasterPartFwd\FinancialInstrumentSyMasterPartFwdFilter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
