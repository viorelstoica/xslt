...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="SpAirBagCertificates-PartialD-Core.xsl"/>
    <xsl:import href="SpAirBagCertificates-PartialD-Custo.xsl"/>
    <xsl:import href="SpAirBagCertificates-PartialD.xsl"/>
