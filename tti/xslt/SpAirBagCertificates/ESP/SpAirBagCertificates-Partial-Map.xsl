...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="SpAirBagCertificates-Core.xsl"/>
    <xsl:import href="SpAirBagCertificates-Custo.xsl"/>
    <xsl:import href="../SpAirBagCertificates-Partial-Core.xsl"/>
    <xsl:import href="../SpAirBagCertificates-Partial-Custo.xsl"/>
    <xsl:import href="SpAirBagCertificates-Partial-Core.xsl"/>
    <xsl:import href="SpAirBagCertificates-Partial-Custo.xsl"/>
    <xsl:import href="SpAirBagCertificates-Partial.xsl"/>
