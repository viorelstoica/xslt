...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/ProductFeeType"
	...
	<xsl:import href="ProductFeeType-Filter-Core.xsl"/>
	<xsl:import href="ProductFeeType-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\productfeetype.xml" htmlbaseurl="" outputurl="..\productfeetypefil.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth=""
