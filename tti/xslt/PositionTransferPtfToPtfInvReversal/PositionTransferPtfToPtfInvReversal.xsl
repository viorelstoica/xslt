...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferPtfToPtfInvReversal" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchPositionTransferPtfToPtfInvReversal" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiPositionTransferPtfToPtfInvReversal" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiPositionTransferPtfToPtfInvReversal" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   ...
   <xsl:template match="c:MultiPositionTransferPtfToPtfInvReversal">
      <xsl:apply-templates select="c:CurrentEvent/b:PositionTransferPtfToPtfInvReversal"/>
   </xsl:template>
   <xsl:template match="batch:BatchPositionTransferPtfToPtfInvReversal">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchPositionTransferPtfToPtfInvReversal" name="BatchPositionTransferPtfToPtfInvReversal">
         <xsl:apply-templates select="b:PositionTransferPtfToPtfInvReversal"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiPositionTransferPtfToPtfInvReversal">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiPositionTransferPtfToPtfInvReversal" name="BatchMultiPositionTransferPtfToPtfInvReversal">
         <xsl:apply-templates select="c:MultiPositionTransferPtfToPtfInvReversal"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:PositionTransferPtfToPtfInvReversal">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('positionTransferPtfToPtfInvReversal',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <xsl:for-each select="b:securityNoGroup">
               <Security>
                  <xsl:attribute name="description">
                     <xsl:value-of select="concat('PositionTransferPtfToPtfInvReversal.xsl+', name(/*), '+', ../b:eventCommon/ns0:eventId, '+', ../b:eventCommon/ns0:creationTime)"/>
                  </xsl:attribute>
