...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="SYBlockUnblockSecPos-Core.xsl"/>
    <xsl:import href="SYBlockUnblockSecPos-Custo.xsl"/>
	<xsl:import href="SYBlockUnblockSecPos.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SYBlockUnblockSecPos\SYBlockUnblockSecPos.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SYBlockUnblockSecPos\SYBlockUnblockSecPosFilter.xml"
