...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="F2B_OrderCancelledExpired" userelativepaths="yes" externalpreview="no" url="..\..\test\f2bcanceltrasfil.xml" htmlbaseurl="" outputurl="..\..\test\f2bcanceltrasfilmap.xml" processortype="jaxp" useresolver="no"
