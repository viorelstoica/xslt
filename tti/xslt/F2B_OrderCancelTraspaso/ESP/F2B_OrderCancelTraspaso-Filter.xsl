...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="F2B_OrderCancelledExpired" userelativepaths="yes" externalpreview="no" url="..\..\test\f2bcancel.xml" htmlbaseurl="" outputurl="..\..\test\f2bcanceltrasfil.xml" processortype="jaxp" useresolver="no" profilemode="0"
