...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/Diary"
	...
	<xsl:import href="Diary-Core.xsl"/>
	<xsl:import href="Diary-Custo.xsl"/>
	<xsl:import href="Diary.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Diary" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\Diary\Diary.xml" htmlbaseurl="" outputurl="..\..\TestFiles\Diary\DiaryGWP.xml" processortype="jaxp" useresolver="no" profilemode="0"
