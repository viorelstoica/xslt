...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="SpBonusNotes-Filter-Core.xsl"/>
	<xsl:import href="SpBonusNotes-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SpBonusNotes" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SpBonusNotes\SpBonusNotesT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SpBonusNotes\SpBonusNotes.xml" processortype="jaxp"
