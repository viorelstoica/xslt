...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/DXOrderAcknowledgment"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchDXOrderAcknowledgment"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiDXOrderAcknowledgment"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiDXOrderAcknowledgment" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="DXOrderAcknowledgment-Core.xsl"/>
    <xsl:import href="DXOrderAcknowledgment-Custo.xsl"/>
	<xsl:import href="DXOrderAcknowledgment.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DXOrderAcknowledgment" userelativepaths="yes" externalpreview="no" url="..\..\..\TTI_1.5\TestFiles\DXOrderAcknowledgment\DXOrderAcknowledgment.xml" htmlbaseurl=""
		          outputurl="..\..\..\TTI_1.5\TestFiles\DXOrderAcknowledgment\DXOrderAcknowledgmentFilter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
