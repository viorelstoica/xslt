...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/F2B" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/DXOrderAcknowledgment" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchDXOrderAcknowledgment" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiDXOrderAcknowledgment" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiDXOrderAcknowledgment" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   <xsl:output encoding="UTF-8" indent="yes" method="xml"/>
   <xsl:template match="c:MultiDXOrderAcknowledgment">
      <xsl:apply-templates select="c:CurrentEvent/b:DXOrderAcknowledgment"/>
   </xsl:template>
   <xsl:template match="batch:BatchDXOrderAcknowledgment">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchDXOrderAcknowledgment" name="BatchDXOrderAcknowledgment">
         <xsl:apply-templates select="b:DXOrderAcknowledgment"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiDXOrderAcknowledgment">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiDXOrderAcknowledgment" name="BatchMultiDXOrderAcknowledgment">
         <xsl:apply-templates select="c:MultiDXOrderAcknowledgment"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:DXOrderAcknowledgment">
      <F2B mode="INSUPD">
         <xsl:attribute name="output">
            <xsl:value-of select="concat('DXOrderAcknowledgment',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Security>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('DXOrderAcknowledgment.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
