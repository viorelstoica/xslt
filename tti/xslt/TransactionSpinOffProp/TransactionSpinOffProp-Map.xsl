...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0" version="1.0" xmlns="http://www.odcgroup.com/CorporateActionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionEntitlement"
	...
	<xsl:import href="TransactionSpinOffProp-Core.xsl"/>
	<xsl:import href="TransactionSpinOffProp-Custo.xsl"/>
	<xsl:import href="TransactionSpinOffProp.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionSpinOffProp" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionSpinOffProp\TransactionEntitlement.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionSpinOffProp\TransactionEntitlementGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
