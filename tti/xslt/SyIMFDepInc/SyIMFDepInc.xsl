   ...
   <xsl:template match="b:SyImfRollover">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SyIMFDepInc',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SyIMFDepInc.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
               ...
               <depositcapitalIncrease>
                  ...
                  <xsl:call-template name="depositCapitalIncrease"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyIMFDepInc\SyIMFDepInc.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyIMFDepInc\SyIMFDepIncGWP.xml" processortype="saxon8" useresolver="no"
