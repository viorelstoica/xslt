...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="IRSSaleClosing-Filter-Core.xsl"/>
    <xsl:import href="IRSSaleClosing-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionIRSSaleClosing\IRS1378.xml" htmlbaseurl="" outputurl="..\..\TestFiles\TransactionIRSSaleClosing\IRSSaleClosingFilter.xml"
