...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="TransactionFiduciaryInitiate-Core.xsl"/>
    <xsl:import href="TransactionFiduciaryInitiate-Custo.xsl"/>
	<xsl:import href="TransactionFiduciaryInitiate.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionFiduciaryInitiate" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionFiduciaryInitiate\TransactionFiduciaryInitiate.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionFiduciaryInitiate\TransactionFiduciaryInitiateFilter.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
