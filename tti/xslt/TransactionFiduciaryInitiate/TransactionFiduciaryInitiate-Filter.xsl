...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="TransactionFiduciaryInitiate-Filter-Core.xsl"/>
    <xsl:import href="TransactionFiduciaryInitiate-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionFiduciaryInitiate" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionFiduciaryInitiate\TransactionFiduciaryInitiate.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionFiduciaryInitiate\TransactionFiduciaryInitiateFilter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
