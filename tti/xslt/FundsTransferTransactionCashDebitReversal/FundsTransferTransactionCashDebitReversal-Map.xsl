...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/FundsTransferTransactionCashDebitReversal"
	...
	<xsl:import href="FundsTransferTransactionCashDebitReversal-Core.xsl"/>
	<xsl:import href="FundsTransferTransactionCashDebitReversal-Custo.xsl"/>
	<xsl:import href="FundsTransferTransactionCashDebitReversal.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FundsTransferTransactionCashDebitReversal" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\FundsTransferTransactionCashDebitReversal\FundsTransferTransactionCashDebitReversal.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FundsTransferTransactionCashDebitReversal\FundsTransferTransactionCashDebitReversalGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
