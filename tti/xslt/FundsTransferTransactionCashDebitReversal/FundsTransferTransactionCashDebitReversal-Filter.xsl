...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/FundsTransferTransactionCashDebitReversal"
	...
	<xsl:import href="FundsTransferTransactionCashDebitReversal-Filter-Core.xsl"/>
	<xsl:import href="FundsTransferTransactionCashDebitReversal-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FundsTransferTransactionCashDebitReversal" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\FundsTransferTransactionCashDebitReversal\FundsTransferTransactionCashDebitReversalT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FundsTransferTransactionCashDebitReversal\FundsTransferTransactionCashDebitReversal.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
