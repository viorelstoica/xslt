...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/CorporateActionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionEntitlement"
	...
	<xsl:import href="TransactionOptionDividend-Filter-Core.xsl"/>
	<xsl:import href="TransactionOptionDividend-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionOptionDividend" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionOptionDividend\TransactionOptionDividendT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionOptionDividend\TransactionOptionDividend.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
