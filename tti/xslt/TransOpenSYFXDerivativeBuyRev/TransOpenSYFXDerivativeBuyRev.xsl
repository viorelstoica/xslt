   ...
   <xsl:template match="b:SyFxForwards">
      <TransactionPMS mode="INSUPD">
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SyFxForwards',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Derivative>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SyFxForwards.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionOpenDerivativeBuylReversal" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyFxForwards\SyFxForwards.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyFxForwards\SyFxForwardsGWP.xml"
