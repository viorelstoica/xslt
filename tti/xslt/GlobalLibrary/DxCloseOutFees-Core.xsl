<xsl:stylesheet xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="infra" version="1.0">
	<xsl:template name="printDxCloseOutFeesAndTaxes">
	...
	<xsl:template name="BP2">
		<transactionFeesTaxesCounter>
			...
			<xsl:if test="*[local-name() = 'priSecAccGroup']/*[local-name() = 'priCommTypSubGroup'][*[local-name() = 'priCommTyp'] = 'REGULATORY']/*[local-name() = 'priCommCcy']">
				<currency>
					<infra:code>
	...
	<xsl:template name="BP3">
		<transactionFeesTaxesCounter>
			...
			<xsl:if test="*[local-name() = 'priSecAccGroup']/*[local-name() = 'priCommTypSubGroup'][*[local-name() = 'priCommTyp'] = 'EXECUTION']/*[local-name() = 'priCommCcy']">
				<currency>
					<infra:code>
	...
	<xsl:template name="BP4">
		<transactionFeesTaxesCounter>
			...
			<xsl:if test="*[local-name() = 'priSecAccGroup']/*[local-name() = 'priCommTypSubGroup'][*[local-name() = 'priCommTyp'] = 'COMMISSION']/*[local-name() = 'priCommCcy']">
				<currency>
					<infra:code>
	...
	<xsl:template name="BP5">
		<transactionFeesTaxesCounter>
			...
			<xsl:if test="*[local-name() = 'priSecAccGroup']/*[local-name() = 'priCommTypSubGroup'][*[local-name() = 'priCommTyp'] = 'CLEARING']/*[local-name() = 'priCommCcy']">
				<currency>
					<infra:code>
	...
	<xsl:template name="BP7">
		<transactionFeesTaxesCounter>
			...
			<xsl:if test="*[local-name() = 'priSecAccGroup']/*[local-name() = 'priCommTypSubGroup'][*[local-name() = 'priCommTyp'] = 'MISC']/*[local-name() = 'priCommCcy']">
				<currency>
					<infra:code>
	...
	<xsl:template name="BP9">
		<transactionFeesTaxesCounter>
			<amount>
				<xsl:choose>
					<xsl:when test="*[local-name() = 'priSecAccGroup']/*[local-name() = 'taxAmtTcySubGroup']/*[local-name() = 'taxAmtTcy'] != ''">
						<xsl:value-of select="format-number(sum(*[local-name() = 'priSecAccGroup']/*[local-name() = 'taxAmtTcySubGroup']/*[local-name() = 'taxAmtTcy'][. &gt; 0]) - sum(*[local-name() = 'priSecAccGroup']/*[local-name() = 'taxAmtTcySubGroup']/*[local-name() = 'taxAmtTcy'][. &lt; 0]),$decimalformat,'nan2zero')"/>
					</xsl:when>
					<xsl:otherwise>
						<xsl:value-of select="'0'"/>
					</xsl:otherwise>
