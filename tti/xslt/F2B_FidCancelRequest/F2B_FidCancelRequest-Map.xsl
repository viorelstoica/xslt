...
<xsl:stylesheet exclude-result-prefixes="b" version="1.0"
    ...
    <xsl:import href="F2B_FidCancelRequest-Core.xsl"/>
    <xsl:import href="F2B_FidCancelRequest-Custo.xsl"/>
	<xsl:import href="F2B_FidCancelRequest.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\F2B_MM_CloseRequest.xml" htmlbaseurl="" outputurl="..\..\..\F2B_MM_CloseRequestss.xml" processortype="jaxp" useresolver="no" profilemode="0"
