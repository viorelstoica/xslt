...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="SpDiscountCertificate-Core.xsl"/>
	<xsl:import href="SpDiscountCertificate-Custo.xsl"/>
	<xsl:import href="SpDiscountCertificate.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SpDiscountCertificate" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SpDiscountCertificate\SpDiscountCertificate.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SpDiscountCertificate\SpDiscountCertificateGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
