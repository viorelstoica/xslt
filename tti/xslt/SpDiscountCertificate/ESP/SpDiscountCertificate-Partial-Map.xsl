...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="SpDiscountCertificate-Core.xsl"/>
    <xsl:import href="SpDiscountCertificate-Custo.xsl"/>
	<xsl:import href="../SpDiscountCertificate-Partial-Core.xsl"/>
    <xsl:import href="../SpDiscountCertificate-Partial-Custo.xsl"/>
    <xsl:import href="SpDiscountCertificate-Partial-Core.xsl"/>
    <xsl:import href="SpDiscountCertificate-Partial-Custo.xsl"/>
	<xsl:import href="SpDiscountCertificate-Partial.xsl"/>
