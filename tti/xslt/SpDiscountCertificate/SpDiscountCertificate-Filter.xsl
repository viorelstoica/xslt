...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="SpDiscountCertificate-Filter-Core.xsl"/>
	<xsl:import href="SpDiscountCertificate-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SpDiscountCertificate" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SpDiscountCertificate\SpDiscountCertificateT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SpDiscountCertificate\SpDiscountCertificate.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
