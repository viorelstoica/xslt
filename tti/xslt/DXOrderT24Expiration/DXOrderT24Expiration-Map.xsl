...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiDXOrderT24Expiration" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="DXOrderT24Expiration-Core.xsl"/>
    <xsl:import href="DXOrderT24Expiration-Custo.xsl"/>
	<xsl:import href="DXOrderT24Expiration.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="DXOrderT24Expiration" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\DXOrderT24Expiration\DXOrderT24Expiration.xml" htmlbaseurl="" outputurl="..\..\TestFiles\DXOrderT24Expiration\DXOrderT24ExpirationFilter2.xml"
