...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="SyIMFCloseLoan-Core.xsl"/>
    <xsl:import href="SyIMFCloseLoan-Custo.xsl"/>
	<xsl:import href="SyIMFCloseLoan.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyIMFCloseLoan\SyIMFCloseLoan.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyIMFCloseLoan\SyIMFCloseLoanFilter.xml" processortype="jaxp"
