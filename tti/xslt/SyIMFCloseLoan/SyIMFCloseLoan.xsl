   ...
   <xsl:template match="b:SyImf">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SyIMFCloseLoan',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SyIMFCloseLoan.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyIMFCloseLoan\SyIMFCloseLoanFilter.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyIMFCloseLoan\SyIMFCloseLoanGWP.xml" processortype="jaxp"
