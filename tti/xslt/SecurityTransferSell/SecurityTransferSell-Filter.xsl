...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/SecurityTransfer" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchSecurityTransfer"
	...
	<xsl:import href="SecurityTransferSell-Filter-Core.xsl"/>
	<xsl:import href="SecurityTransferSell-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SecurityTransferSell" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SecurityTransferSell\SecurityTransferSellT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SecurityTransferSell\SecurityTransferSell.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
