...
<xsl:stylesheet xmlns="http://www.temenos.com/T24/OFSML/150" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:b="http://www.odcgroup.com/F2B" xmlns:dxorder="http://www.temenos.com/T24/dxorder" xmlns:infra="http://www.odcgroup.com/InfraPMS"
	...
	<xsl:import href="F2B_OrderCancelledExpired-Filter-Core.xsl"/>
	<xsl:import href="F2B_OrderCancelledExpired-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="F2B_OrderCancelledExpired" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\F2B_OrderCancelledExpired\F2B_OrderCancelledExpiredTAP.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\F2B_OrderCancelledExpired\F2B_OrderCancelledExpired.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
