...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="F2B_OrderCancelledExpired" userelativepaths="yes" externalpreview="no" url="..\f2bcancelfil.xml" htmlbaseurl="" outputurl="..\f2bcancel1.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth=""
