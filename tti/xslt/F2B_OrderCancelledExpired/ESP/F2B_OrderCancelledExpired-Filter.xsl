...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="F2B_OrderCancelledExpired" userelativepaths="yes" externalpreview="no" url="..\f2bcancel.xml" htmlbaseurl="" outputurl="..\f2bcancelfil.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth=""
