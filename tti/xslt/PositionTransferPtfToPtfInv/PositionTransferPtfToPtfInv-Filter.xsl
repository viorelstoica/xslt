...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferPtfToPtfInv"
	...
	<xsl:import href="PositionTransferPtfToPtfInv-Filter-Core.xsl"/>
	<xsl:import href="PositionTransferPtfToPtfInv-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PositionTransferPtfToPtfInv" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PositionTransferPtfToPtfInv\PositionTransferPtfToPtfInvT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PositionTransferPtfToPtfInv\PositionTransferPtfToPtfInv.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
