...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/GenericCOA" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionEntitlement" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchTransactionEntitlement"
	...
	<xsl:import href="TransactionOffMarketBuyback-Filter-Core.xsl"/>
	<xsl:import href="TransactionOffMarketBuyback-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionOffMarketBuyback" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionOffMarketBuyback\TransactionOffMarketBuybackT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionOffMarketBuyback\TransactionOffMarketBuyback.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
