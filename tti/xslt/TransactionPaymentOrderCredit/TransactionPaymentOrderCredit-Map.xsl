...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="TransactionPaymentOrderCredit-Core.xsl"/>
    <xsl:import href="TransactionPaymentOrderCredit-Custo.xsl"/>
	<xsl:import href="TransactionPaymentOrderCredit.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="TransactionPaymentOrderCredit" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionPaymentOrderCredit\TransactionPaymentOrderCreditInput.xml" htmlbaseurl=""
