   ...
   <xsl:template match="b:SyDci">
      <StructuredProducts>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('FinancialInstrumentSPDCIFX2',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <ExoticOption>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('FinancialInstrumentSPDCIFX2.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
			...
			<Event>
               <termEvent>
                    ...
                    <xsl:call-template name="callPutIndicator1"/>
                    <xsl:call-template name="cashSettlement1"/>
                    ...
                    <xsl:call-template name="exerciseType1"/>
                    ...
                    <xsl:call-template name="underlyingQuantity1"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FinancialInstrumentSPDCIFX" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumentSPDCIFX\FinancialInstrumentSPDCIFX.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentSPDCIFX\FinancialInstrumentSPDCIFX_GWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
