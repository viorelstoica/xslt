...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionCoExpireManualBuy"
	...
	<xsl:import href="TransactionCoExpireManualBuy-Filter-Core.xsl"/>
	<xsl:import href="TransactionCoExpireManualBuy-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionCoExpireManualBuy" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionCoExpireManualBuy\TransactionCoExpireManualBuyT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionCoExpireManualBuy\TransactionCoExpireManualBuy.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
