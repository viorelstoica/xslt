...
<xsl:stylesheet xmlns="http://www.odcgroup.com/Request" xmlns:a="http://www.odcgroup.com/Request" xmlns:b="http://www.temenos.com/T24/OFSML/150" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="b" version="1.0">
  <xsl:param name="tapRefId" select="b:serviceResponse/b:ofsTransactionFailed/b:ofsTransactionInput/b:field[@name='TAP.REF.ID'] | b:serviceResponse/b:ofsFault/b:ofsFaultDetails/b:ofsTransactionInput/b:field[@name='TAP.REF.ID'] "/>
  <xsl:template name="genOutput">
    <xsl:param name="tapRefId"/>
    <UpdateStatus>
      <code>
