...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="AccountingProfileAll-Filter-Core.xsl"/>
	<xsl:import href="AccountingProfileAll-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\Defects\TAXAll\20190313_234906_896_322_msgin_MultiCginventoryAll_f812f789-7050-4b56-b310-d835a26e0b2e.xml" htmlbaseurl=""
		          outputurl="..\..\..\Defects\TAXAll\ACpaa.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none"
