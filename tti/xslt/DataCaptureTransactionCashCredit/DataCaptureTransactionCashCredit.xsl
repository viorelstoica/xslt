...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/DataCaptureTransactionCashCredit" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchDataCaptureTransactionCashCredit" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiDataCaptureTransactionCashCredit" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiDataCaptureTransactionCashCredit" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   <xsl:output encoding="UTF-8" indent="yes" method="xml"/>
   <xsl:template match="c:MultiDataCaptureTransactionCashCredit">
      <xsl:apply-templates select="c:CurrentEvent/b:DataCaptureTransactionCashCredit"/>
   </xsl:template>
   <xsl:template match="batch:BatchDataCaptureTransactionCashCredit">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchDataCaptureTransactionCashCredit" name="BatchDataCaptureTransactionCashCredit">
         <xsl:apply-templates select="b:DataCaptureTransactionCashCredit"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiDataCaptureTransactionCashCredit">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiDataCaptureTransactionCashCredit" name="BatchMultiDataCaptureTransactionCashCredit">
         <xsl:apply-templates select="c:MultiDataCaptureTransactionCashCredit"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:DataCaptureTransactionCashCredit">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('DataCaptureTransactionCashCredit',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Cash>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('DataCaptureTransactionCashCredit.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DataCaptureTransactionCashCredit" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\DataCaptureTransactionCashCredit\DataCaptureTransactionCashCredit.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\DataCaptureTransactionCashCredit\DataCaptureTransactionCashCreditCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
