...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/DataCaptureTransactionCashCredit" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" exclude-result-prefixes="b ns0" version="1.0">
   ...
   <xsl:template name="transactionCode">
      <transactionCode>
         <xsl:value-of select="concat('DC_',b:id,'_C',$COMPANY_POSTFIX_SEPARATOR,b:companyMnemonic)"/>
      </transactionCode>
   </xsl:template>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\DataCaptureTransactionCashCredit\DataCaptureTransactionCashCredit.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\DataCaptureTransactionCashCredit\DataCaptureTransactionCashCreditGWP.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
