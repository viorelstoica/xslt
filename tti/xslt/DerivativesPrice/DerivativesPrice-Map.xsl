...
<xsl:stylesheet exclude-result-prefixes="b batch multibatch"
    version="1.0" xmlns="http://www.odcgroup.com/FiPMS"
    xmlns:b="http://www.temenos.com/T24/event/TTI/DerivativesPrice"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchDerivativesPrice"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiDerivativesPrice" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="DerivativesPrice-Core.xsl"/>
    <xsl:import href="DerivativesPrice-Custo.xsl"/>
	<xsl:import href="DerivativesPrice.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DerivativesPrice" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\DerivativesPrice\DerivativesPrice.xml" htmlbaseurl="" outputurl="..\..\TestFiles\DerivativesPrice\DerivativesPriceFilter.xml"
