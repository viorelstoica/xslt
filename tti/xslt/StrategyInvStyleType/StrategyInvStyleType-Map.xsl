...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/PtfManagementType"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchPtfManagementType"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiPtfManagementType"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiPtfManagementType" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="StrategyInvStyleType-Core.xsl"/>
    <xsl:import href="StrategyInvStyleType-Custo.xsl"/>
	<xsl:import href="StrategyInvStyleType.xsl"/>
