...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="OrderAdjustStatus-Filter-Core.xsl"/>
    <xsl:import href="OrderAdjustStatus-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="OrderAdjustStatus" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\OrderAdjustStatus\OrderAdjustStatus.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\OrderAdjustStatus\OrderAdjustStatusCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
