...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="OrderAdjustStatus-Core.xsl"/>
    <xsl:import href="OrderAdjustStatus-Custo.xsl"/>
	<xsl:import href="OrderAdjustStatus.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="OrderAdjustStatus" userelativepaths="yes" externalpreview="yes" url="..\..\..\..\..\TTI\KD-8410\nnn\OrderAdjustStatus.xml" htmlbaseurl="" outputurl="..\..\..\..\..\TTI\KD-8410\nnn\OPOrderAdjustStatus.xml"
		          ...
		          postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="yes" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
			...
			<advancedProp name="bUseDTD" value="false"/>
			<advancedProp name="iErrorHandling" value="fatal"/>
			<validatorSchema value="..\..\..\..\gwpack\gwpack\XML Schema\InfraPMS.xsd"/>
			<validatorSchema value="..\..\..\..\gwpack\gwpack\XML Schema\F2B.xsd"/>
		</scenario>
