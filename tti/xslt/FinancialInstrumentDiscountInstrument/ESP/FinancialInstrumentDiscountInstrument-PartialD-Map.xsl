...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="FinancialInstrumentDiscountInstrument-Core.xsl"/>
    <xsl:import href="FinancialInstrumentDiscountInstrument-Custo.xsl"/>
	<xsl:import href="../FinancialInstrumentDiscountInstrument-PartialD-Core.xsl"/>
    <xsl:import href="../FinancialInstrumentDiscountInstrument-PartialD-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentDiscountInstrument-PartialD-Core.xsl"/>
    <xsl:import href="FinancialInstrumentDiscountInstrument-PartialD-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentDiscountInstrument-PartialD.xsl"/>
