   ...
   <xsl:template match="b:TransactionEntitlement">
      <CorporateActionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('CoaDecreaseInValue',substring-before(b:entitlementId,'.'))"/>
         ...
         <DecreaseInValue>
            <Link>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionDecreaseInValue.xsl+', name(/*), '+', ../b:eventCommon/ns0:eventId, '+', ../b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
               ...
               <xsl:call-template name="decreaseAmount"/>
