...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.temenos.com/T24/OFSML/150" xmlns:b="http://www.odcgroup.com/F2B_MM_FX" xmlns:infra="http://www.odcgroup.com/InfraPMS" exclude-result-prefixes="b" version="1.0">
   ...
   <xsl:template match="/">
      <T24Batch>
         <xsl:for-each select="b:F2B_MM_FX/b:DataGroup/b:ForexForward/b:ForexSwap/b:OrderLifeCycle/b:saleRequest">
            <T24>
               <serviceRequest>
                  <securityContext>
                     <xsl:choose>
                  ...
                  <ofsTransactionInput application="FOREX" operation="PROCESS" version="{$ForexFXSwapSaleVersion}">
