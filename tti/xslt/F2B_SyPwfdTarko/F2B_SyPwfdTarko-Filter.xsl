...
<xsl:stylesheet exclude-result-prefixes="b" version="1.0"
    ...
    <xsl:import href="F2B_SyPwfdTarko-Filter-Core.xsl"/>
    <xsl:import href="F2B_SyPwfdTarko-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="F2B_SyPwfdTarko" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\F2B_SyPwfdTarko\F2B-Format.xml" htmlbaseurl="" outputurl="..\..\TestFiles\F2B_SyPwfdTarko\F2B-FormatFilterOut.xml" processortype="jaxp"
