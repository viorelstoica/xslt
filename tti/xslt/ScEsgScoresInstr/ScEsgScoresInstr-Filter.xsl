...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="ScEsgScoresInstr-Filter-Core.xsl"/>
    <xsl:import href="ScEsgScoresInstr-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\ScEsgScoresSecurity.xml" htmlbaseurl="" outputurl="..\ScEsgScoresSecurityFILTEROUT.xml" processortype="jaxp" useresolver="no" profilemode="0"
