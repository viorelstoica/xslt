...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/LockingTransactionCOA"
	...
	<xsl:import href="LockingTransactionOPTION-Filter-Core.xsl"/>
	<xsl:import href="LockingTransactionOPTION-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="LockingTransactionOPTION" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\LockingTransactionOPTION\LockingTransactionOPTIONT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\LockingTransactionOPTION\LockingTransactionOPTION.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
