...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/AccountClosure"
	...
	<xsl:import href="AccountClosure-Core.xsl"/>
	<xsl:import href="AccountClosure-Custo.xsl"/>
	<xsl:import href="AccountClosure.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="AccountClosure" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\AccountClosure\AccountClosure.xml" htmlbaseurl="" outputurl="..\..\TestFiles\AccountClosure\AccountClosureGWP.xml" processortype="jaxp"
