...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="DXOrderCancelRejected-Core.xsl"/>
    <xsl:import href="DXOrderCancelRejected-Custo.xsl"/>
	<xsl:import href="DXOrderCancelRejected.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DXOrderCancelRejected" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\DXOrderUpdateAccepted\20161021_141601_299_47_msgin_MultiDXOrderUpdateAcceptedc.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\DXOrderCancelRejected\DXOrderCancelRejectedFiter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
