...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:template name="bonusLevel">
		<xsl:if test="b:underlyingGroup/b:priceBarrierTypeSubGroup[b:priceBarrierType='BONUS.LEVEL']/b:notePriceBarrier and b:underlyingGroup/b:priceBarrierTypeSubGroup[b:priceBarrierType='BONUS.LEVEL']/b:notePriceBarrier != ''">
			<bonusLevel>
				<xsl:value-of select="b:underlyingGroup/b:priceBarrierTypeSubGroup[b:priceBarrierType='BONUS.LEVEL']/b:notePriceBarrier"/>
			</bonusLevel>
		</xsl:if>
	</xsl:template>
	...
	<xsl:template name="bonusLevel_MultiEntity"/>
