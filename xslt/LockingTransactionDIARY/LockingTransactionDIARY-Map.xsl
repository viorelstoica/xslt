...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/LockingTransactionCOA"
	...
	<xsl:import href="LockingTransactionDIARY-Core.xsl"/>
	<xsl:import href="LockingTransactionDIARY-Custo.xsl"/>
	<xsl:import href="LockingTransactionDIARY.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="LockingTransactionDIARY" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\LockingTransactionDIARY\LockingTransactionDIARY.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\LockingTransactionDIARY\LockingTransactionDIARYGWP.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
