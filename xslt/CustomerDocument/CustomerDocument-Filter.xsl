...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0" version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/ClientPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="CustomerDocument-Filter-Core.xsl"/>
	<xsl:import href="CustomerDocument-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="CustomerDocument" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\CustomerDocument\CustomerDocumentT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\CustomerDocument\CustomerDocument.xml"
