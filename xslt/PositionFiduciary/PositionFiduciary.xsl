   ...
   <xsl:template match="b:FdFidOrder">
      <PositionPMS mode="INSUPD">
         <xsl:attribute name="output">
            <xsl:value-of select="concat('PositionFiduciary',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoansPosition>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('PositionFiduciary.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PositionFiduciary" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\PositionFiduciary\PositionFiduciary.xml" htmlbaseurl="" outputurl="..\..\TestFiles\PositionFiduciary\PositionFiduciaryGWP.xml"
