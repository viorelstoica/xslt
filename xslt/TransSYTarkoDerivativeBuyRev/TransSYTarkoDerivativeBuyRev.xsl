   ...
   <xsl:template match="b:SyFxForwards">
      <TransactionPMS mode="INSUPD">
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransSYTarkoDerivativeBuyRev',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Derivative>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransSYTarkoDerivativeBuyRev.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
