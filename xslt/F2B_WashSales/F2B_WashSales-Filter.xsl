...
<xsl:stylesheet exclude-result-prefixes="b" version="1.0"
    ...
    <xsl:import href="F2B_WashSales-Filter-Core.xsl"/>
    <xsl:import href="F2B_WashSales-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="F2B_WashSales" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\F2B_WashSales\F2B-FormatTAP.xml" htmlbaseurl="" outputurl="..\..\TestFiles\F2B_WashSales\F2B-Format.xml" processortype="jaxp"
