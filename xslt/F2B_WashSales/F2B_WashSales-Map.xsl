...
<xsl:stylesheet exclude-result-prefixes="b" version="1.0" xmlns="http://www.temenos.com/T24/OFSML/150" xmlns:b="http://www.odcgroup.com/F2B_FORMAT" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:import href="F2B_WashSales-Core.xsl"/>
	<xsl:import href="F2B_WashSales-Custo.xsl"/>
	<xsl:import href="F2B_WashSales.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="F2B_WashSales" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\F2B_WashSales\F2B-Format.xml" htmlbaseurl="" outputurl="..\..\TestFiles\F2B_WashSales\F2B-FormatT24.xml" processortype="jaxp"
