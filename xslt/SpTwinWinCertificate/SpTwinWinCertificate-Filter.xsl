...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="SpTwinWinCertificate-Filter-Core.xsl"/>
	<xsl:import href="SpTwinWinCertificate-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SpTwinWinCertificate" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SpTwinWinCertificate\SpTwinWinCertificateT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SpTwinWinCertificate\SpTwinWinCertificate.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
