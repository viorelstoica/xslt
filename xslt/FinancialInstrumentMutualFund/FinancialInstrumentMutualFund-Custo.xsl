...
<xsl:template name="infra:userDefinedField">
	...
	<infra:userDefinedField>
        <infra:name>
            <xsl:value-of select="'ud_funds_retrocession_e'"/>
        </infra:name>
        <infra:value>
            <xsl:choose>
                <xsl:when test="b:csdFndsRetcn ='Notdefined'">
                    <xsl:value-of select="0"/>
                </xsl:when>
                <xsl:when test="b:csdFndsRetcn ='Clean'">
                    <xsl:value-of select="1"/>
                </xsl:when>
                <xsl:when test="b:csdFndsRetcn ='NotClean'">
                    <xsl:value-of select="2"/>
                </xsl:when>
            </xsl:choose>
        </infra:value>
	...
	<infra:userDefinedField>
        <infra:name>
            <xsl:value-of select="'traspasos_f'"/>
        </infra:name>
        <infra:value>
            <xsl:choose>
