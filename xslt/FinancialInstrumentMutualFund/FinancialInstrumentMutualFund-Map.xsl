...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="FinancialInstrumentMutualFund-Core.xsl"/>
	<xsl:import href="FinancialInstrumentMutualFund-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentMutualFund.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FinancialInstrumentMutualFund" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\FinancialInstrumentMutualFund\FinancialInstruemntMutualFund.xml" htmlbaseurl=""
