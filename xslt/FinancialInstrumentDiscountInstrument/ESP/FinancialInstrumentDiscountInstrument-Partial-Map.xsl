...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="FinancialInstrumentDiscountInstrument-Core.xsl"/>
    <xsl:import href="FinancialInstrumentDiscountInstrument-Custo.xsl"/>
	<xsl:import href="../FinancialInstrumentDiscountInstrument-Partial-Core.xsl"/>
    <xsl:import href="../FinancialInstrumentDiscountInstrument-Partial-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentDiscountInstrument-Partial-Core.xsl"/>
    <xsl:import href="FinancialInstrumentDiscountInstrument-Partial-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentDiscountInstrument-Partial.xsl"/>
