...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="F2B_SyDciTci" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\F2B_SyDciTci\F2B-FormatFilterOut.xml" htmlbaseurl="" outputurl="..\..\TestFiles\F2B_SyDciTci\F2B-FormatPostMap.xml" processortype="jaxp"
