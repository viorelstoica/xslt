   ...
   <xsl:template match="b:SyDci">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SyDciReversal',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SyDciReversal.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SyDciReversal" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyDciReversal\SyDciReversal.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyDciReversal\SyDciReversalGWP.xml" processortype="jaxp"
