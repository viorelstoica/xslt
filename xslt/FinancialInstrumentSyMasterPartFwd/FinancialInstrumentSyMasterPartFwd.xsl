   ...
   <xsl:template match="b:FinancialInstrumentSyContractMaster">
      <StructuredProducts>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('FinancialInstrumentSyMasterPartFwd',translate(translate(b:id,'/',''),':',''))"/>
         </xsl:attribute>
         <DataGroup>
            <PartForward>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('FinancialInstrumentSyMasterPartFwd.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FinancialInstrumentSyMasterPartFwd" userelativepaths="yes" externalpreview="no" url="..\..\..\FinancialInstrumentSyContractMaster.xml" htmlbaseurl="" outputurl="..\..\..\FinancialInstrumentSyMasterPartFwdOut.xml"
