...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFinancialInstrumentSyContractMaster"
    ...
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiFinancialInstrumentSyContractMaster" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentSyMasterPartFwd-Core.xsl"/>
    <xsl:import href="FinancialInstrumentSyMasterPartFwd-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentSyMasterPartFwd.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FinancialInstrumentSyMasterPartFwd" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumentSyMasterPartFwd\FinancialInstrumentSyMasterPartFwdFilter.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentSyMasterPartFwd\FinancialInstrumentSyMasterPartFwdCore.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
