...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="FinancialInstrumentStock-Partial-Core.xsl"/>
    <xsl:import href="FinancialInstrumentStock-Partial-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentStock-Partial.xsl"/>
