...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="TransOpenSYFXDerivativeBuyRev-Core.xsl"/>
    <xsl:import href="TransOpenSYFXDerivativeBuyRev-Custo.xsl"/>
	<xsl:import href="TransOpenSYFXDerivativeBuyRev.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionOpenDerivativeBuylReversal" userelativepaths="yes" externalpreview="no" url="..\..\IntegrationStudio\TTI\schemas\syfxforwards.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SyFxForwards\SyFxForwardsFilter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
