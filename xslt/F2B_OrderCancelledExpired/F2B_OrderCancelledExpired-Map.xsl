...
<xsl:stylesheet xmlns="http://www.temenos.com/T24/OFSML/150" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:b="http://www.odcgroup.com/F2B" xmlns:dxorder="http://www.temenos.com/T24/dxorder" xmlns:infra="http://www.odcgroup.com/InfraPMS"
	...
	<xsl:import href="F2B_OrderCancelledExpired-Core.xsl"/>
	<xsl:import href="F2B_OrderCancelledExpired-Custo.xsl"/>
	<xsl:import href="F2B_OrderCancelledExpired.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="F2B_OrderCancelledExpired" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\F2B_OrderCancelledExpired\F2B_OrderCancelledExpired.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\F2B_OrderCancelledExpired\F2B_OrderCancelledExpiredT24.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
