...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/GenericCOA" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferScSettlement"
	...
	<xsl:import href="PTFromToDepositActualSettlement-Core.xsl"/>
	<xsl:import href="PTFromToDepositActualSettlement-Custo.xsl"/>
	<xsl:import href="PTFromToDepositActualSettlement.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PTFromToDepositActualSettlement" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PTFromToDepositActualSettlement\PTFromToDepositActualSettlement.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PTFromToDepositActualSettlement\PTFromToDepositActualSettlementGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
