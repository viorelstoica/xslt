...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/AccountClosure"
	...
	<xsl:import href="AccountClosure-Filter-Core.xsl"/>
	<xsl:import href="AccountClosure-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="AccountClosure" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\AccountClosure\AccountClosureT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\AccountClosure\AccountClosure.xml" processortype="jaxp"
