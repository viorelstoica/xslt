...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionRevIssuedGuarantee"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchTransactionRevIssuedGuarantee"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiTransactionRevIssuedGuarantee"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiTransactionRevIssuedGuarantee"
    ...
    <xsl:import href="TransactionRevIssuedGuarantee-Core.xsl"/>
    <xsl:import href="TransactionRevIssuedGuarantee-Custo.xsl"/>
	<xsl:import href="TransactionRevIssuedGuarantee.xsl"/>
