...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="FinancialInstrumentConvertibleBond-Core.xsl"/>
	<xsl:import href="FinancialInstrumentConvertibleBond-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentConvertibleBond.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FinancialInstrumentConvertibleBond" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\FinancialInstrumentConvertibleBond\FinancialInstrumentConvertibleBond.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentConvertibleBond\FinancialInstrumentConvertibleBondGWP.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
