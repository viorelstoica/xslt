...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0" version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="DocumentType-Filter-Core.xsl"/>
	<xsl:import href="DocumentType-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="DocumentType" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\DocumentType\DocumentTypeT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\DocumentType\DocumentType.xml"
