...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0" version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="DocumentType-Core.xsl"/>
	<xsl:import href="DocumentType-Custo.xsl"/>
	<xsl:import href="DocumentType.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="DocumentType" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\DocumentType\DocumentType.xml" htmlbaseurl="" outputurl="..\..\TestFiles\DocumentType\DocumentTypeGWP.xml"
