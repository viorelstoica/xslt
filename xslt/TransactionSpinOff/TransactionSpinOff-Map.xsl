...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/CorporateActionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionEntitlement"
	...
	<xsl:import href="TransactionSpinOff-Core.xsl"/>
	<xsl:import href="TransactionSpinOff-Custo.xsl"/>
	<xsl:import href="TransactionSpinOff.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionSpinOff" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionSpinOff\TransactionSpinOff.xml" htmlbaseurl="" outputurl="..\..\TestFiles\TransactionSpinOff\TransactionSpinOffGWP.xml"
