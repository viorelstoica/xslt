...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchThirdPartySector"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiThirdPartySector"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiThirdPartySector" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="ThirdPartySector-Core.xsl"/>
    <xsl:import href="ThirdPartySector-Custo.xsl"/>
	<xsl:import href="ThirdPartySector.xsl"/>
