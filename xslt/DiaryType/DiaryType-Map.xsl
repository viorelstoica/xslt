...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/DiaryType"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchDiaryType"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiDiaryType"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiDiaryType" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="DiaryType-Core.xsl"/>
    <xsl:import href="DiaryType-Custo.xsl"/>
	<xsl:import href="DiaryType.xsl"/>
