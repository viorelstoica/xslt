...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionSettleFutureSell"
	...
	<xsl:import href="TransactionSettleFutureSell-Filter-Core.xsl"/>
	<xsl:import href="TransactionSettleFutureSell-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionSettleFutureSell" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionSettleFutureSell\TransactionSettleFutureSellT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionSettleFutureSell\TransactionSettleFutureSell.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
