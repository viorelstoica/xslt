...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchCustomerSecurity"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiCustomerSecurity"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiCustomerSecurity" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="CustomerSecurity-Core.xsl"/>
    <xsl:import href="CustomerSecurity-Custo.xsl"/>
	<xsl:import href="CustomerSecurity.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="CustomerSecurity" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\CustomerSecurity\CustomerSecurity.xml" htmlbaseurl="" outputurl="..\..\TestFiles\CustomerSecurity\CustomerSecurity_Custo.xml"
