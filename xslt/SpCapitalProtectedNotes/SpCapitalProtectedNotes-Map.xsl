...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="SpCapitalProtectedNotes.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="StructuredProducts" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SpCapitalProtectedNotes\SpCapitalProtectedNotes.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SpCapitalProtectedNotes\SpCapitalProtectedNotesGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
