...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="SpCapitalProtectedNotes-Partial-Core.xsl"/>
    <xsl:import href="SpCapitalProtectedNotes-Partial-Custo.xsl"/>
    <xsl:import href="SpCapitalProtectedNotes-Partial.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\..\Users\sridharb\Desktop\Untitled1.xml" htmlbaseurl="" outputurl="" processortype="saxon8" useresolver="no" profilemode="0" profiledepth=""
