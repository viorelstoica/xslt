...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchDxStockExchange"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiDxStockExchange"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiDxStockExchange" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="DxStockExchange-Core.xsl"/>
    <xsl:import href="DxStockExchange-Custo.xsl"/>
	<xsl:import href="DxStockExchange.xsl"/>
