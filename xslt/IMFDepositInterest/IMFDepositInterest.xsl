   ...
   <xsl:template match="b:SyImf">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('IMFDepositInterest',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('IMFDepositInterest.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SyImf" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\IMFDepositInterest\IMFDepositInterest.xml" htmlbaseurl="" outputurl="..\..\TestFiles\IMFDepositInterest\IMFDepositInterestGWP.xml"
