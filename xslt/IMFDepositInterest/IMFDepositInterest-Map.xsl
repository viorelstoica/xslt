...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="IMFDepositInterest-Core.xsl"/>
    <xsl:import href="IMFDepositInterest-Custo.xsl"/>
	<xsl:import href="IMFDepositInterest.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\IMFDepositInterest\IMFDepositInterest.xml" htmlbaseurl="" outputurl="..\..\TestFiles\IMFDepositInterest\IMFDepositInterestFilter.xml"
