   ...
   <xsl:template match="c:AAAFlow">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('RevTransactionAADepositsInterestPayment',c:aatxncontext/b:aaArrangementId)"/>
         </xsl:attribute>
         <DataGroup>
   ...
   <xsl:template match="c:aaarecord">
      <DepositLoan>
         <xsl:attribute name="description">
            <xsl:value-of select="concat('RevTransactionAADepositsInterestPayment.xsl+', name(/*), '+', ../c:eventCommon/ns0:eventId, '+', ../c:eventCommon/ns0:creationTime)"/>
         </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="AAAFlow" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\RevTransactionAADepositsInterestPayment\RevTransactionAADepositsInterestPayment.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\RevTransactionAADepositsInterestPayment\RevTransactionAADepositsInterestPaymentGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
