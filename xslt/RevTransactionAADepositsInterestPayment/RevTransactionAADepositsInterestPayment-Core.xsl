         ...
         <xsl:choose>
			<xsl:when test="$POSTFIX_AACOMNE = 'Y'">
		         <xsl:choose>
		            ...
		            <xsl:otherwise>
		               <xsl:value-of select="concat(../c:aatxncontext/b:aaArrActivityId,$COMPANY_POSTFIX_SEPARATOR,../c:aatxncontext/b:aaCompanyMnemonic,'-I','_R')"/>
		            </xsl:otherwise>
		         </xsl:choose>
			</xsl:when>
			<xsl:otherwise>
				<xsl:choose>
		            ...
		            <xsl:otherwise>
		               <xsl:value-of select="concat(../c:aatxncontext/b:aaArrActivityId,'-I','_R')"/>
		            </xsl:otherwise>
		         </xsl:choose>
			</xsl:otherwise>
	  </xsl:choose>
