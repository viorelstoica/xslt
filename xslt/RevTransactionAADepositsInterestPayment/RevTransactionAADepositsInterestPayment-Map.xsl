...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/FiPMS" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:a="http://www.temenos.com/T24/AaActivityExtractorService/AaArrInterestRec"
	...
	<xsl:import href="RevTransactionAADepositsInterestPayment-Core.xsl"/>
    <xsl:import href="RevTransactionAADepositsInterestPayment-Custo.xsl"/>
	<xsl:import href="RevTransactionAADepositsInterestPayment.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="file:///c:/Users/donmani.ASIA/Downloads/TC52-Retest - TTI_3478-04Dec19-msgin.xml" htmlbaseurl=""
