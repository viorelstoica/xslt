...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/SecurityTransfer"
	...
	<xsl:import href="../SecurityTransferSecurityTransferOut-Filter-Core.xsl"/>
    <xsl:import href="../SecurityTransferSecurityTransferOut-Filter-Custo.xsl"/>
    <xsl:import href="SecurityTransferSecurityTransferOut-Filter-Core.xsl"/>
    <xsl:import href="SecurityTransferSecurityTransferOut-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SecurityTransferSecurityTransferOut" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SecurityTransferSecurityTransferOut\SecurityTransferSecurityTransferOutT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SecurityTransferSecurityTransferOut\SecurityTransferSecurityTransferOut.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
