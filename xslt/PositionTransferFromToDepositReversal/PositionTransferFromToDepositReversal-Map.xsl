...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/GenericCOA" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionTransferFromToDepositReversal"
	...
	<xsl:import href="PositionTransferFromToDepositReversal-Core.xsl"/>
	<xsl:import href="PositionTransferFromToDepositReversal-Custo.xsl"/>
	<xsl:import href="PositionTransferFromToDepositReversal.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PositionTransferFromToDepositReversal" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PositionTransferFromToDepositReversal\PositionTransferFromToDepositReversal.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\PositionTransferFromToDepositReversal\PositionTransferFromToDepositReversalGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
