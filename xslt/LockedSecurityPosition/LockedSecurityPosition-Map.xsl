...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/LockedSecurityPosition"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchLockedSecurityPosition"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiLockedSecurityPosition"
    ...
    <xsl:import href="LockedSecurityPosition-Core.xsl"/>
    <xsl:import href="LockedSecurityPosition-Custo.xsl"/>
	<xsl:import href="LockedSecurityPosition.xsl"/>
