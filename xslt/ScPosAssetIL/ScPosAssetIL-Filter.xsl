...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/generic" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/ScPosAsset"
	...
	<xsl:import href="ScPosAssetIL-Filter-Core.xsl"/>
	<xsl:import href="ScPosAssetIL-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="ScPosAssetIL" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\ScPosAssetIL\ScPosAssetILT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\ScPosAssetIL\ScPosAssetILPostFilter.xml" processortype="jaxp"
