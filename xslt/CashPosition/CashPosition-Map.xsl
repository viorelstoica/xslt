...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    version="1.0" xmlns="http://www.odcgroup.com/PositionPMS"
    xmlns:b="http://www.temenos.com/T24/event/TTI/CashPosition"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchCashPosition"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiCashPosition"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiCashPosition" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="CashPosition-Core.xsl"/>
    <xsl:import href="CashPosition-Custo.xsl"/>
	<xsl:import href="CashPosition.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="CashPosition" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\CashPosition\CashPosition.xml" htmlbaseurl="" outputurl="..\..\TestFiles\CashPosition\CashPosition_Custo.xml" processortype="jaxp"
