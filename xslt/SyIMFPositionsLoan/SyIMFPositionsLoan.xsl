   ...
   <xsl:template match="b:SyImf">
      <PositionPMS mode="INSUPD">
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SyIMFPositionsLoan',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoansPosition>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SyIMFPositionsLoan.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
