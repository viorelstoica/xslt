   ...
   <xsl:template match="c:AAAFlow">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('transactionAACapitaliseInterestDeposit',c:aatxncontext/b:aaArrangementId)"/>
         </xsl:attribute>
         <DataGroup>
   ...
   <xsl:template match="c:aaarecord">
      <DepositLoan>
         <xsl:attribute name="description">
            <xsl:value-of select="concat('TransactionAACapitaliseInterestDeposit.xsl+', name(/*), '+', ../c:eventCommon/ns0:eventId, '+', ../c:eventCommon/ns0:creationTime)"/>
         </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionAACapitaliseInterestDeposit\TransactionAACapitaliseInterestDeposit.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionAACapitaliseInterestDeposit\TransactionAACapitaliseInterestDepositGW.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
