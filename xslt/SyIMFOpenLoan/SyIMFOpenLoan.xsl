   ...
   <xsl:template match="b:SyImf">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SyIMFOpenLoan',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SyIMFOpenLoan.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyIMFOpenLoan\SyIMFOpenLoanFilter.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyIMFOpenLoan\SyIMFOpenLoanGWP.xml" processortype="jaxp"
