...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionOpenDerivativeBuyReversal"
	...
	<xsl:import href="TransactionOpenDerivativeBuyReversal-Filter-Core.xsl"/>
	<xsl:import href="TransactionOpenDerivativeBuyReversal-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionOpenDerivativeBuylReversal" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionOpenDerivativeBuyReversal\TransactionOpenDerivativeBuyReversalT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionOpenDerivativeBuyReversal\TransactionOpenDerivativeBuyReversal.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
