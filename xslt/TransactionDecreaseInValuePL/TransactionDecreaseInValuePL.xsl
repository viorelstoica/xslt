   ...
   <xsl:template match="b:TransactionEntitlement">
      <CorporateActionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('CoaDecreaseInValuePL',substring-before(b:entitlementId,'.'))"/>
         </xsl:attribute>
         ...
         <DecreaseInValue>
            <Link>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionDecreaseInValuePL.xsl+', name(../*), '+', ../b:eventCommon/ns0:eventId, '+', ../b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
