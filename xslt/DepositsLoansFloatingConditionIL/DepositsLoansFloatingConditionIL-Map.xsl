...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchDepositsLoansFloatingConditionIL"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiDepositsLoansFloatingConditionIL"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiDepositsLoansFloatingConditionIL" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="DepositsLoansFloatingConditionIL-Core.xsl"/>
    <xsl:import href="DepositsLoansFloatingConditionIL-Custo.xsl"/>
	<xsl:import href="DepositsLoansFloatingConditionIL.xsl"/>
