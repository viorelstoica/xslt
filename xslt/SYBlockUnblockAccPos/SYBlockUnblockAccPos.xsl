   ...
   <xsl:template match="b:SyAccuDecu">
      <TransactionPMS mode="INSUPD">
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SYBlockUnblockAccPos',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Cash>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SYBlockUnblockAccPos.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SYBlockUnblockAccPos" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SYBlockUnblockAccPos\SYBlockUnblockAccPosFilter.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SYBlockUnblockAccPos\SYBlockUnblockAccPosGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
