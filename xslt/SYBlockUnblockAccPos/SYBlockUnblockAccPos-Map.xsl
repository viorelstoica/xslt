...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="SYBlockUnblockAccPos-Core.xsl"/>
    <xsl:import href="SYBlockUnblockAccPos-Custo.xsl"/>
	<xsl:import href="SYBlockUnblockAccPos.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SYBlockUnblockAccPos\SYBlockUnblockAccPos.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SYBlockUnblockAccPos\SYBlockUnblockAccPosFilter.xml"
