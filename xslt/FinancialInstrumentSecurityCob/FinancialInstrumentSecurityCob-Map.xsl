...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="FinancialInstrumentSecurityCob-Core.xsl"/>
    <xsl:import href="FinancialInstrumentSecurityCob-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentSecurityCob.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FinancialInstrumentSecurity" userelativepaths="yes" externalpreview="yes"
		          url="..\..\..\..\..\Users\umathanun.TEMENOSGROUP\Desktop\New folder\20191115_142507_305_90_msgin_MultiFinancialInstrumentSecurityCob_104d68db-162d-4de6-b035-75d36b989847.xml" htmlbaseurl=""
		          outputurl="..\..\..\..\..\Users\umathanun.TEMENOSGROUP\Desktop\New folder\Op1113.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
		          additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="yes" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
			...
			<advancedProp name="bUseDTD" value="false"/>
			<advancedProp name="iErrorHandling" value="fatal"/>
			<validatorSchema value="..\..\..\..\gwpack\gwpack\XML Schema\FiPMS.xsd"/>
		</scenario>
	...
	<MapperMetaTag>
		<MapperInfo srcSchemaPathIsRelative="yes" srcSchemaInterpretAsXML="no" destSchemaPath="" destSchemaRoot="" destSchemaPathIsRelative="yes" destSchemaInterpretAsXML="no">
			<SourceSchema srcSchemaPath="..\..\..\..\..\TTI\KD-IrregularCoupon\Cob\msgin_MultiFinancialInstrumentSecurity_921151d9-77fb-4502-a956-d397367cee8c.xml" srcSchemaRoot="MultiFinancialInstrumentSecurity" AssociatedInstance=""
