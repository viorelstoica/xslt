...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="CsdTransactionPaymentOrderDebit-Filter-Core.xsl"/>
    <xsl:import href="CsdTransactionPaymentOrderDebit-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\CsdDebit\Msgin.xml" htmlbaseurl="" outputurl="..\..\CsdDebit\Filter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth=""
