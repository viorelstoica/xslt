...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchRatingAgency"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiRatingAgency"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiRatingAgency" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="RatingAgency-Core.xsl"/>
    <xsl:import href="RatingAgency-Custo.xsl"/>
	<xsl:import href="RatingAgency.xsl"/>
