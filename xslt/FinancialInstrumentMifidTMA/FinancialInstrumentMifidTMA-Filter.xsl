...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0" version="1.0" xmlns="http://www.odcgroup.com/BusIndicator" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/MIFID"
	...
	<xsl:import href="FinancialInstrumentMifidTMA-Filter-Core.xsl"/>
	<xsl:import href="FinancialInstrumentMifidTMA-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\..\..\Users\abiram.anandakumar\Downloads\mifidTMAmsgin.xml" htmlbaseurl=""
		          outputurl="..\..\..\..\..\Users\abiram.anandakumar\Downloads\mifidTMAfilter.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
