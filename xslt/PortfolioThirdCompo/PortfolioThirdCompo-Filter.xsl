...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="PortfolioThirdCompo-Filter-Core.xsl"/>
    <xsl:import href="PortfolioThirdCompo-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\PortfolioThirdCompo\PortfolioThirdCompo6.xml" htmlbaseurl="" outputurl="..\..\TestFiles\PortfolioThirdCompo\PortfolioThirdCompo6OUTafDon.xml"
