...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionAssignExpiryOptionSellCloseOutRev"
	...
	<xsl:import href="CashPayoutAssignReversal-Filter-Core.xsl"/>
	<xsl:import href="CashPayoutAssignReversal-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\TransactionAssignExpiryOptionSellCloseOutRevMSG_IN.xml" htmlbaseurl="" outputurl="..\TransactionAssignExpiryOptionSellCloseOutRevFILTER_OUT.xml"
