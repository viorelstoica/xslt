...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionAssignExpiryOptionSellCloseOutRev"
	...
	<xsl:import href="CashPayoutAssignReversal-Core.xsl"/>
	<xsl:import href="CashPayoutAssignReversal-Custo.xsl"/>
	<xsl:import href="CashPayoutAssignReversal.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\TransactionAssignExpiryOptionSellCloseOutRevMSG_IN.xml" htmlbaseurl="" outputurl="..\TransactionAssignExpiryOptionSellCloseOutRevMSG_OUT.xml"
