...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/FundsTransferTransactionCashDebit" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFundsTransferTransactionCashDebit" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiFundsTransferTransactionCashDebit" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiFundsTransferTransactionCashDebit" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   <xsl:output encoding="UTF-8" indent="yes" method="xml"/>
   <xsl:template match="c:MultiFundsTransferTransactionCashDebit">
      <xsl:apply-templates select="c:CurrentEvent/b:FundsTransferTransactionCashDebit"/>
   </xsl:template>
   <xsl:template match="batch:BatchFundsTransferTransactionCashDebit">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchFundsTransferTransactionCashDebit" name="BatchFundsTransferTransactionCashDebit">
         <xsl:apply-templates select="b:FundsTransferTransactionCashDebit"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiFundsTransferTransactionCashDebit">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiFundsTransferTransactionCashDebit" name="BatchMultiFundsTransferTransactionCashDebit">
         <xsl:apply-templates select="c:MultiFundsTransferTransactionCashDebit"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:FundsTransferTransactionCashDebit">
      <TransactionPMS>
         <xsl:attribute name="mode">INSUPD</xsl:attribute>
         <xsl:attribute name="output">
            <xsl:value-of select="concat('FundsTransferTransactionCashDebit',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Cash>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('FundsTransferTransactionCashDebit.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FundsTransferTransactionCashDebit" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FundsTransferTransactionCashDebit\FundsTransferTransactionCashDebit.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FundsTransferTransactionCashDebit\FundsTransferTransactionCashDebitCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
