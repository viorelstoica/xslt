...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/OperationType"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchOperationType"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiOperationType"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiOperationType" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="OperationType-Core.xsl"/>
    <xsl:import href="OperationType-Custo.xsl"/>
	<xsl:import href="OperationType.xsl"/>
