...
<xsl:import href="FinancialInstrumentAADepositFloatingCondition-Filter-Core.xsl"/>
    <xsl:import href="FinancialInstrumentAADepositFloatingCondition-Filter-Custo.xsl"/>
