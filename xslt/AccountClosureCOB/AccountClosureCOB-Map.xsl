...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/AccountClosureCOB"
	...
	<xsl:import href="AccountClosureCOB-Core.xsl"/>
	<xsl:import href="AccountClosureCOB-Custo.xsl"/>
	<xsl:import href="AccountClosureCOB.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="AccountClosureCOB" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\AccountClosureCOB\AccountClosureCOB.xml" htmlbaseurl="" outputurl="..\..\TestFiles\AccountClosureCOB\AccountClosureCOBGWP.xml"
