...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/CorporateActionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionEntitlement"
	...
	<xsl:import href="TransactionSinkingRedemption-Core.xsl"/>
	<xsl:import href="TransactionSinkingRedemption-Custo.xsl"/>
	<xsl:import href="TransactionSinkingRedemption.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionSinkingRedemption" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionSinkingRedemption\TransactionSinkingRedemptionPartial.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionSinkingRedemption\TransactionSinkingRedemptionPartialGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
