	...
	<xsl:template match="b:PaymentOrder">
		<TransactionPMS>
			...
			<xsl:attribute name="output">
				<xsl:value-of select="concat('CsdTransactionPaymentOrderCredit',b:id)"/>
			</xsl:attribute>
			...
			<DataGroup>
				<Cash>
					<xsl:attribute name="description">
						<xsl:value-of select="concat('CsdTransactionPaymentOrderCredit.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
					</xsl:attribute>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="TransactionPaymentOrderCredit" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionPaymentOrderCredit\TransactionPaymentOrderCreditCusto.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionPaymentOrderCredit\TransactionPaymentOrderCreditGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
