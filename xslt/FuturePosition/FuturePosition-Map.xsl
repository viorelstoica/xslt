...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/PositionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/FuturePosition" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFuturePosition"
	...
	<xsl:import href="FuturePosition-Core.xsl"/>
	<xsl:import href="FuturePosition-Custo.xsl"/>
	<xsl:import href="FuturePosition.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FuturePosition" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\FuturePosition\FuturePositionPostFilter.xml" htmlbaseurl="" outputurl="..\..\TestFiles\FuturePosition\FuturePositionPostProcess.xml"
