...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/OptionPosition"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchOptionPosition"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiOptionPosition"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiOptionPosition"
    ...
    <xsl:import href="OptionPosition-Core.xsl"/>
    <xsl:import href="OptionPosition-Custo.xsl"/>
	<xsl:import href="OptionPosition.xsl"/>
