...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="SpMemoryCouponNotes-Partial-Core.xsl"/>
    <xsl:import href="SpMemoryCouponNotes-Partial-Custo.xsl"/>
    <xsl:import href="SpMemoryCouponNotes-Partial.xsl"/>
