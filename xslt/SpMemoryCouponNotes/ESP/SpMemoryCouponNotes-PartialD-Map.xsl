...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="SpMemoryCouponNotes-Core.xsl"/>
    <xsl:import href="SpMemoryCouponNotes-Custo.xsl"/>
	<xsl:import href="../SpMemoryCouponNotes-PartialD-Core.xsl"/>
    <xsl:import href="../SpMemoryCouponNotes-PartialD-Custo.xsl"/>
    <xsl:import href="SpMemoryCouponNotes-PartialD-Core.xsl"/>
    <xsl:import href="SpMemoryCouponNotes-PartialD-Custo.xsl"/>
    <xsl:import href="SpMemoryCouponNotes-PartialD.xsl"/>
