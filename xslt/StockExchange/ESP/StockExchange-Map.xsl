...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="StockExchange" userelativepaths="yes" externalpreview="no" url="..\..\stock.xml" htmlbaseurl="" outputurl="..\..\stockout.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength=""
