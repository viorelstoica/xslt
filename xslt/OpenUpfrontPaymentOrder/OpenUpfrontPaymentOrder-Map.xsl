...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/ClientPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/OpenUpfrontPaymentOrder"
	...
	<xsl:import href="OpenUpfrontPaymentOrder-Core.xsl"/>
	<xsl:import href="OpenUpfrontPaymentOrder-Custo.xsl"/>
	<xsl:import href="OpenUpfrontPaymentOrder.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="MaintainPortfolioValue" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\MaintainPortfolioValue\MaintainPortfolioValue.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\MaintainPortfolioValue\MaintainPortfolioValue_GWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
