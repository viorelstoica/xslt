...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/LdLoansAndDepositsOldNew"
	...
	<xsl:import href="LDFloatingRateInterest-Core.xsl"/>
    <xsl:import href="LDFloatingRateInterest-Custo.xsl"/>
	<xsl:import href="LDFloatingRateInterest.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DepositsLoansFloatingCondition" userelativepaths="yes" externalpreview="no" url="file:///c:/Users/donmani.ASIA/Documents/ChangeFixedIntRate.xml" htmlbaseurl=""
		          outputurl="..\..\..\..\TTI-1229\LDFloatingRateInterestFilter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
