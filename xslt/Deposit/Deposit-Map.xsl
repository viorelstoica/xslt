...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/Deposit"
	...
	<xsl:import href="Deposit-Core.xsl"/>
	<xsl:import href="Deposit-Custo.xsl"/>
	<xsl:import href="Deposit.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Deposit" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\Deposit\DepositPostfilter.xml" htmlbaseurl="" outputurl="..\..\TestFiles\Deposit\Deposit_GWP.xml" processortype="jaxp" useresolver="no"
