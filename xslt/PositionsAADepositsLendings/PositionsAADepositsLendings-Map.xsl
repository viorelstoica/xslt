...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/PositionsAADepositsLendings"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchPositionsAADepositsLendings"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiPositionsAADepositsLendings"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiPositionsAADepositsLendings"
    ...
    <xsl:import href="PositionsAADepositsLendings-Core.xsl"/>
    <xsl:import href="PositionsAADepositsLendings-Custo.xsl"/>
	<xsl:import href="PositionsAADepositsLendings.xsl"/>
