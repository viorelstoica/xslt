...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0" xmlns="http://www.odcgroup.com/InfraPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/DXCustomer" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchDXCustomer"
                xmlns:c="http://www.temenos.com/T24/event/TTI/MultiDXCustomer" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiDXCustomer" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="b:DXCustomer">
		<xsl:apply-templates select="self::b:DXCustomer[b:dxCustomerType = 'BROKER' or b:dxCustomerType = 'DEALER']" mode="filter1"/>
	</xsl:template>
	<!-- Condition 2 -->
	<xsl:template match="b:DXCustomer" mode="filter1">
		<xsl:apply-templates select="self::b:DXCustomer[b:exchMemberGroup/b:exchMemberList/b:exchMember and b:exchMemberGroup/b:exchMemberList/b:exchMember = 'CLEARING']" mode="filter-custo"/>
	</xsl:template>

	<!-- Custo placeholder -->
	<xsl:template match="b:DXCustomer" mode="filter-custo">
		<xsl:apply-templates select="self::b:DXCustomer" mode="filter-final"/>
	</xsl:template>

	<!-- Copy block -->
	<xsl:template match="b:DXCustomer" mode="filter-final">
		<xsl:copy>
			<xsl:apply-templates select="@* | node()"/>
		</xsl:copy>
	</xsl:template>
