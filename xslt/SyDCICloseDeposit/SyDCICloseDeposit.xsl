   ...
   <xsl:template match="b:SyDci">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('SyDCICloseDeposit',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('SyDCICloseDeposit.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SyDciCloseDeposit" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\SyDCICloseDeposit\SyDCICloseDeposit.xml" htmlbaseurl="" outputurl="..\..\TestFiles\SyDCICloseDeposit\SyDCICloseDeposit_GWP.xml"
