...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiSyAccuDecu" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="FinancialInstrumenSPAccuDecu-Core.xsl"/>
    <xsl:import href="FinancialInstrumenSPAccuDecu-Custo.xsl"/>
	<xsl:import href="FinancialInstrumenSPAccuDecu.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FinancialInstrumentFuture" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumenSPAccuDecu\FinancialInstrumenSPAccuDecu.xml" htmlbaseurl="" outputurl="" processortype="jaxp"
		          useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath=""
		          postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
			<advancedProp name="bXsltOneIsOkay" value="true"/>
