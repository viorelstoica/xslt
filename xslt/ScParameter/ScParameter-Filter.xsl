...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchScParameter" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="ScParameter-Filter-Core.xsl"/>
    <xsl:import href="ScParameter-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="StockExchange" userelativepaths="yes" externalpreview="no" url="..\20210823_185237_000_564_msgin_ScParameter_0afa303b-9980-4b8a-867a-38a4bf368c8c.xml" htmlbaseurl=""
		          outputurl="..\20210823_185237_000_564_msgin_ScParameter_0afa303b-9980-4b8a-867a-38a4bf368c8cFilter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
		          additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
			<advancedProp name="bXsltOneIsOkay" value="true"/>
			<advancedProp name="bSchemaAware" value="false"/>
