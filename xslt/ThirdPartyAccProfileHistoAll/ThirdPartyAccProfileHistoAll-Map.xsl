...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="ThirdPartyAccProfileHistoAll-Core.xsl"/>
	<xsl:import href="ThirdPartyAccProfileHistoAll-Custo.xsl"/>
	<xsl:import href="ThirdPartyAccProfileHistoAll.xsl"/>
