...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0" xmlns="http://www.odcgroup.com/ClientPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/CginventoryAll"
                xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchCginventoryAll" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiCginventoryAll" xmlns:infra="http://www.odcgroup.com/InfraPMS"
	...
	<xsl:template match="b:CginventoryAll" mode="filter2">
		...
		<xsl:apply-templates select="self::b:CginventoryAll[$custId != 'ALL' and $portId = 'ALL']" mode="filter-custo"/>
	</xsl:template>
	<!-- Custo placeholder -->
