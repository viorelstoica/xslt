...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="SpDiscountCertificate-PartialD-Core.xsl"/>
    <xsl:import href="SpDiscountCertificate-PartialD-Custo.xsl"/>
    <xsl:import href="SpDiscountCertificate-PartialD.xsl"/>
