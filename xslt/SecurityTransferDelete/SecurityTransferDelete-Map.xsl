...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/F2B" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/SecurityTransfer"
    ...
    <xsl:import href="SecurityTransferDelete-Core.xsl"/>
    <xsl:import href="SecurityTransferDelete-Custo.xsl"/>
	<xsl:import href="SecurityTransferDelete.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SecurityTransferDelete" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SecurityTransferDelete\SecurityTransferDelete.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SecurityTransferDelete\SecurityTransferDeleteGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
