...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionRevReceivedGuarantee"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchTransactionRevReceivedGuarantee"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiTransactionRevReceivedGuarantee"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiTransactionRevReceivedGuarantee"
    ...
    <xsl:import href="TransactionRevReceivedGuarantee-Core.xsl"/>
    <xsl:import href="TransactionRevReceivedGuarantee-Custo.xsl"/>
	<xsl:import href="TransactionRevReceivedGuarantee.xsl"/>
