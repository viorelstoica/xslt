...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="TransactionSecuritySellReversal-Filter-Core.xsl"/>
    <xsl:import href="TransactionSecuritySellReversal-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionSecuritySellReversal\TransactionSecuritySellReversal.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionSecuritySellReversal\TransactionSecuritySellReversalCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
