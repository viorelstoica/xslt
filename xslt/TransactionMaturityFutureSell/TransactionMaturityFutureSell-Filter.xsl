...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionMaturityFutureSell"
	...
	<xsl:import href="TransactionMaturityFutureSell-Filter-Core.xsl"/>
	<xsl:import href="TransactionMaturityFutureSell-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionMaturityFutureSell" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionMaturityFutureSell\TransactionMaturityFutureSellT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionMaturityFutureSell\TransactionMaturityFutureSell.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
