   ...
   <xsl:template match="b:PtfManagementType">
      <InfraPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('StrategyInvStyleType',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Type>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('StrategyInvStyleType.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
