...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionCoAssignManual"
	...
	<xsl:import href="TransactionCoAssignManual-Filter-Core.xsl"/>
	<xsl:import href="TransactionCoAssignManual-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionCoAssignManual" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionCoAssignManual\TransactionCoAssignManualT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionCoAssignManual\TransactionCoAssignManual.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
