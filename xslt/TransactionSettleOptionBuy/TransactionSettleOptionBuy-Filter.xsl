...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionSettleOptionBuy"
	...
	<xsl:import href="TransactionSettleOptionBuy-Filter-Core.xsl"/>
	<xsl:import href="TransactionSettleOptionBuy-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionSettleOptionBuy" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionSettleOptionBuy\TransactionSettleOptionBuyT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionSettleOptionBuy\TransactionSettleOptionBuy.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
