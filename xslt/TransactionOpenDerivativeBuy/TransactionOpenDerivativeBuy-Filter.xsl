...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionOpenDerivativeBuy"
	...
	<xsl:import href="TransactionOpenDerivativeBuy-Filter-Core.xsl"/>
	<xsl:import href="TransactionOpenDerivativeBuy-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionOpenDerivativeBuy" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionOpenDerivativeBuy\TransactionOpenDerivativeBuyT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionOpenDerivativeBuy\TransactionOpenDerivativeBuy.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
