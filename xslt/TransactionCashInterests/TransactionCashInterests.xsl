   ...
   <xsl:template match="b:AcEntry">
      ...
      <TransactionPMS>
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransactionCashInterests',b:statemententry[e:transactionCode/@Rank=$MinRank]/e:transactionCode)"/>
         </xsl:attribute>
         <DataGroup>
            <Cash>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionCashInterests.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\TTI_1.5\TestFiles\TransactionCashInterests\TransactionCashInterestsFilter.xml" htmlbaseurl=""
		          outputurl="..\..\..\TTI_1.5\TestFiles\TransactionCashInterests\TransactionCashInterestsFilterCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
