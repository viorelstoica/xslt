...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/ClientPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/CloseUpfrontPaymentOrder"
	...
	<xsl:import href="CloseUpfrontPaymentOrder-Core.xsl"/>
	<xsl:import href="CloseUpfrontPaymentOrder-Custo.xsl"/>
	<xsl:import href="CloseUpfrontPaymentOrder.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="MaintainPortfolioValue" userelativepaths="yes" externalpreview="yes" url="..\..\..\XML Messages\CloseUpfrontPayment.xml" htmlbaseurl="" outputurl="..\..\..\XML Messages\CloseUpfrontPaymentOut.xml" processortype="jaxp"
