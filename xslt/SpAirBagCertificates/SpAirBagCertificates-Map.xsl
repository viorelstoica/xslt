...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0 d e f g" version="1.0" xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="SpAirBagCertificates-Core.xsl"/>
	<xsl:import href="SpAirBagCertificates-Custo.xsl"/>
	<xsl:import href="SpAirBagCertificates.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SpAirBagCertificates" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SpAirBagCertificates\SpAirBagCertificates.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SpAirBagCertificates\SpAirBagCertificatesGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
