...
<metaInformation>
	...
	<MapperMetaTag>
		<MapperInfo srcSchemaPathIsRelative="yes" srcSchemaInterpretAsXML="no" destSchemaPath="" destSchemaRoot="" destSchemaPathIsRelative="yes" destSchemaInterpretAsXML="no">
			<SourceSchema srcSchemaPath="..\..\IntegrationStudio\TTI\schemas\FinancialInstrumentSecurity\TTI-FinancialInstrumentSecurity.xsd" srcSchemaRoot="FinancialInstrumentSecurity" AssociatedInstance="" loaderFunction="document"
		...
		<MapperBlockPosition>
			...
			<template name="infra:userDefinedField">
				<block path="xsl:if/and[0]" x="200" y="16"/>
				<block path="xsl:if/and[0]/and[0]" x="154" y="10"/>
				<block path="xsl:if/and[0]/and[0]/and[0]" x="108" y="4"/>
				<block path="xsl:if/and[0]/and[0]/and[0]/and[0]" x="62" y="0"/>
				<block path="xsl:if/and[0]/and[0]/and[0]/and[0]/and[0]" x="16" y="0"/>
				<block path="xsl:if/and[0]/and[0]/and[0]/and[0]/and[0]/!=[1]" x="0" y="22"/>
				<block path="xsl:if/and[0]/and[0]/and[0]/and[0]/!=[1]" x="16" y="22"/>
				<block path="xsl:if" x="246" y="18"/>
				<block path="xsl:if/infra:userDefinedField/infra:value/xsl:value-of" x="246" y="54"/>
				<block path="xsl:if/infra:userDefinedField/infra:value/xsl:value-of/substring[0]" x="200" y="48"/>
				<block path="xsl:if[1]/or[0]" x="200" y="88"/>
				<block path="xsl:if[1]/or[0]/=[0]" x="154" y="82"/>
				<block path="xsl:if[1]" x="246" y="90"/>
				<block path="xsl:if[1]/infra:userDefinedField/infra:value/xsl:value-of" x="246" y="126"/>
				<block path="infra:userDefinedField/infra:value/xsl:value-of" x="246" y="198"/>
				<block path="infra:userDefinedField[1]/infra:value/xsl:value-of" x="246" y="270"/>
			</template>
		</MapperBlockPosition>
