...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionSellGuaranteeIssued"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchTransactionSellGuaranteeIssued"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiTransactionSellGuaranteeIssued"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiTransactionSellGuaranteeIssued"
    xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
    xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="TransactionSellGuaranteeIssued-Core.xsl"/>
    <xsl:import href="TransactionSellGuaranteeIssued-Custo.xsl"/>
	<xsl:import href="TransactionSellGuaranteeIssued.xsl"/>
