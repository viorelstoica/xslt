...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/PriceUpdate"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchPriceUpdate"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiPriceUpdate"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiPriceUpdate" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="PriceUpdate-Core.xsl"/>
    <xsl:import href="PriceUpdate-Custo.xsl"/>
	<xsl:import href="PriceUpdate.xsl"/>
