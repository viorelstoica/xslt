...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/CashAccountType"
	...
	<xsl:import href="CashAccountType-Core.xsl"/>
	<xsl:import href="CashAccountType-Custo.xsl"/>
	<xsl:import href="CashAccountType.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="CashAccountType" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\CashAccountType\CashAccountType.xml" htmlbaseurl="" outputurl="..\..\TestFiles\CashAccountType\CashAccountTypeGWP.xml"
