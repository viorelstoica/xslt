...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/CashAccountType"
	...
	<xsl:import href="CashAccountType-Filter-Core.xsl"/>
	<xsl:import href="CashAccountType-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="CashAccountType" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\CashAccountType\CashAccountTypeT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\CashAccountType\CashAccountType.xml"
