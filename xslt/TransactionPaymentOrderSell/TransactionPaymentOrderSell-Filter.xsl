...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/PaymentOrder" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchPaymentOrder"
	...
	<xsl:import href="TransactionPaymentOrderSell-Filter-Core.xsl"/>
	<xsl:import href="TransactionPaymentOrderSell-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionPaymentSell" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionPaymentOrderSell\TransactionPaymentOrderSell.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionPaymentOrderSell\TransactionPaymentOrderSellFilter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
