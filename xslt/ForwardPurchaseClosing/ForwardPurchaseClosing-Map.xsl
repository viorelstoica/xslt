...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/ForwardPurchaseClosing"
	...
	<xsl:import href="ForwardPurchaseClosing-Core.xsl"/>
	<xsl:import href="ForwardPurchaseClosing-Custo.xsl"/>
	<xsl:import href="ForwardPurchaseClosing.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="ForwardPurchaseClosing" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\ForwardPurchaseClosing\ForwardPurchaseClosing.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\ForwardPurchaseClosing\ForwardPurchaseClosingGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
