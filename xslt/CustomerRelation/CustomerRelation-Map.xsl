...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/generic" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/CustomerRelation"
	...
	<xsl:import href="CustomerRelation-Core.xsl"/>
	<xsl:import href="CustomerRelation-Custo.xsl"/>
	<xsl:import href="CustomerRelation.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="CustomerRelation" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\CustomerRelation\CustomerRelation.xml" htmlbaseurl="" outputurl="..\..\TestFiles\CustomerRelation\CustomerRelationGWP.xml"
