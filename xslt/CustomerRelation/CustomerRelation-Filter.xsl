...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/generic" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/CustomerRelation"
	...
	<xsl:import href="CustomerRelation-Filter-Core.xsl"/>
	<xsl:import href="CustomerRelation-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="CustomerRelation" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\CustomerRelation\CustomerRelationT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\CustomerRelation\CustomerRelation.xml"
