...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFinancialInstrumentOptionContractMaster"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiFinancialInstrumentOptionContractMaster"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiFinancialInstrumentOptionContractMaster" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="FinancialInstrumentOptionContractMaster-Core.xsl"/>
    <xsl:import href="FinancialInstrumentOptionContractMaster-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentOptionContractMaster.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FinancialInstrumentOptionContractMaster" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumentOptionContractMaster\FinancialInstrumentOptionContractMaster.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentOptionContractMaster\FinancialInstrumentOptionContractMasterGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
