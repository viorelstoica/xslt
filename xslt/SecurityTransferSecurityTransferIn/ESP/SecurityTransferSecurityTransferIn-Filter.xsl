...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/SecurityTransfer"
	...
	<xsl:import href="../SecurityTransferSecurityTransferIn-Filter-Core.xsl"/>
    <xsl:import href="../SecurityTransferSecurityTransferIn-Filter-Custo.xsl"/>
    <xsl:import href="SecurityTransferSecurityTransferIn-Filter-Core.xsl"/>
    <xsl:import href="SecurityTransferSecurityTransferIn-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SecurityTransferSecurityTransferIn" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SecurityTransferSecurityTransferIn\SecurityTransferSecurityTransferInT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SecurityTransferSecurityTransferIn\SecurityTransferSecurityTransferIn.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
