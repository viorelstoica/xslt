...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch ns0" version="1.0" xmlns="http://www.odcgroup.com/GenericCOA" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionEntitlement"
	...
	<xsl:import href="TransactionRightsExecution-Core.xsl"/>
	<xsl:import href="TransactionRightsExecution-Custo.xsl"/>
	<xsl:import href="TransactionRightsExecution.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionRightsExecution" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionRightsExecution\TransactionEntitlement.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionRightsExecution\TransactionEntitlementGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
