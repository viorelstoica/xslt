...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/ForwardSaleClosing" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchForwardSaleClosing"
	...
	<xsl:import href="ForwardSaleClosing-Core.xsl"/>
	<xsl:import href="ForwardSaleClosing-Custo.xsl"/>
	<xsl:import href="ForwardSaleClosing.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="ForwardSaleClosing" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\ForwardSaleClosing\ForwardSaleClosing.xml" htmlbaseurl="" outputurl="..\..\TestFiles\ForwardSaleClosing\ForwardSaleClosingGWP.xml"
