...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/BasicInterest" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchBasicInterest" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiBasicInterest" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiBasicInterest" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   ...
   <xsl:template match="multibatch:BatchBasicInterest">
   ...
   <xsl:template match="b:BasicInterest">
      <FiPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('FinancialInstrumentRateBasic',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Rate>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('FinancialInstrumentRateBasic.xsl+', name(/*), '+', ../b:eventCommon/ns0:eventId, '+', ../b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FinancialInstrumentRateBasic" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\BasicInterest\BasicInterest.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\BasicInterest\FinancialInstrumentRateBasicGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
