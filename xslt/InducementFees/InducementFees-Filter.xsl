...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/ClientPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/InducementFees"
	...
	<xsl:import href="InducementFees-Filter-Core.xsl"/>
	<xsl:import href="InducementFees-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="no" name="InducementFees" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\InducementFees\InducementFeesT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\InducementFees\InducementFees.xml" processortype="jaxp"
		...
		<scenario default="yes" name="InducementFeesProrata" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\InducementFees\InducementFeesProrataT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\InducementFees\InducementFeesProrata.xml"
		...
		<scenario default="no" name="InducementFeesBackup" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\InducementFees\InducementFeesBackupT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\InducementFees\InducementFeesBackup.xml"
		          processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline=""
		          postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="bSchemaAware" value="false"/>
			<advancedProp name="xsltVersion" value="2.0"/>
