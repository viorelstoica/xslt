...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/ClientPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/InducementFees"
	...
	<xsl:import href="InducementFees-Core.xsl"/>
	<xsl:import href="InducementFees-Custo.xsl"/>
	<xsl:import href="InducementFees.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="no" name="InducementFees" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\InducementFees\InducementFees.xml" htmlbaseurl="" outputurl="..\..\TestFiles\InducementFees\InducementFeesGWP.xml" processortype="jaxp"
		...
		<scenario default="yes" name="InducementFeesProrata" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\InducementFees\InducementFeesProrata.xml" htmlbaseurl="" outputurl="..\..\TestFiles\InducementFees\InducementFeesProrataGWP.xml"
		...
		<scenario default="no" name="InducementFeesBackup" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\InducementFees\InducementFeesBackup.xml" htmlbaseurl="" outputurl="..\..\TestFiles\InducementFees\InducementFeesBackupGWP.xml"
		          processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline=""
		          postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="bSchemaAware" value="false"/>
			<advancedProp name="xsltVersion" value="2.0"/>
