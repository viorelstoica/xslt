...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchIRSNotionalPrinChange"
	...
	<xsl:template name="accountingDate">
		<accountingDate>
			<xsl:call-template name="xsdate">
				<xsl:with-param name="date" select="b:swapbalancesrecord/ns1:SwapBalancesList[ns1:scheduleType = 'PDN']/ns1:processDate"/>
			</xsl:call-template>
		</accountingDate>
	</xsl:template>
	...
	<xsl:template name="principalAmount">
		<principalAmount>
			<xsl:value-of select="b:swapbalancesrecord/ns1:SwapBalancesList[ns1:scheduleType='PDN']/ns1:currencyAmount"/>
		</principalAmount>
	</xsl:template>
	...
	<xsl:template name="transactionCode">
		<transactionCode>
			<xsl:value-of select="concat('IRS_PDN',$COMPANY_POSTFIX_SEPARATOR, b:swapbalancesrecord/ns1:swapId,$COMPANY_POSTFIX_SEPARATOR,b:swapbalancesrecord/ns1:SwapBalancesList[ns1:scheduleType = 'PDN']/ns1:processDate,$COMPANY_POSTFIX_SEPARATOR,b:swapbalancesrecord/ns1:coMnemonic)"/>
		</transactionCode>
	</xsl:template>
