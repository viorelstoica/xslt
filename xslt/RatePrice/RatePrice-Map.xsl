...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/RatePrice"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchRatePrice"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiRatePrice"
    xmlns:infra="http://www.odcgroup.com/InfraPMS"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiRatePrice" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="RatePrice-Core.xsl"/>
    <xsl:import href="RatePrice-Custo.xsl"/>
	<xsl:import href="RatePrice.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="RatePrice" userelativepaths="yes" externalpreview="no" url="..\..\Test\AUTO_TEST\Online\RatePrice\RatePrice_msg-1 - Copy.xml" htmlbaseurl="" outputurl="..\..\Test\AUTO_TEST\Online\RatePrice\RatePrice_msg-1OUT.xml"
