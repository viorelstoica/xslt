   ...
   <xsl:template match="b:FdFiduciary">
      <TransactionPMS mode="INSUPD">
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransactionFiduciaryAcknowledgeEmatReimb',../b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <xsl:for-each select="b:orderNosGroup">
               <DepositLoan>
                  <xsl:attribute name="description">
                     <xsl:value-of select="concat('TransactionFiduciaryAcknowledgeEmatReimb.xsl+', name(/*), '+', ../b:eventCommon/ns0:eventId, '+', ../b:eventCommon/ns0:creationTime)"/>
                  </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionFiduciaryAcknowledgeEmatReimb" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionFiduciaryAcknowledgeEmatReimb1\TransactionFiduciaryAcknowledgeEmatReimb1filter.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionFiduciaryAcknowledgeEmatReimb1\TransactionFiduciaryAcknowledgeEmatReimb1GWP.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml=""
