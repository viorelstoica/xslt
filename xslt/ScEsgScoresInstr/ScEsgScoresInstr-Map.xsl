...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="ScEsgScoresInstr-Core.xsl"/>
    <xsl:import href="ScEsgScoresInstr-Custo.xsl"/>
	<xsl:import href="ScEsgScoresInstr.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\ScEsgScoresSecurity.xml" htmlbaseurl="" outputurl="..\ScEsgScoresSecurityout.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth=""
