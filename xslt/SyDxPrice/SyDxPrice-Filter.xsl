...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/SyDxPrice" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchSyDxPrice"
	...
	<xsl:import href="SyDxPrice-Filter-Core.xsl"/>
    <xsl:import href="SyDxPrice-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="Price" userelativepaths="yes" externalpreview="no" url="..\..\..\SyDxPrice.xml" htmlbaseurl="" outputurl="..\..\..\SyDxPriceFilter.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth=""
