...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0" xmlns="http://www.odcgroup.com/FiPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/SyDxPrice" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchSyDxPrice"
                xmlns:c="http://www.temenos.com/T24/event/TTI/MultiSyDxPrice" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiSyDxPrice" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon">
	<xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
	<xsl:import href="SyDxPrice-Core.xsl"/>
    <xsl:import href="SyDxPrice-Custo.xsl"/>
	<xsl:import href="SyDxPrice.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="Price" userelativepaths="yes" externalpreview="no" url="..\..\..\SyDxPrice.xml" htmlbaseurl="" outputurl="..\..\..\SyDxPriceOut.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth=""
