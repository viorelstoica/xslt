   ...
   <xsl:template match="b:LdLoansAndDeposits">
      <TransactionPMS mode="INSUPD">
         <xsl:attribute name="output">
            <xsl:value-of select="concat('RevTransactionOpenLDDeposits',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('RevTransactionOpenLDDeposits.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\..\testfiles\LdLoansAndDeposits\LdLoansAndDeposits.xml" htmlbaseurl="" outputurl="..\..\..\..\testfiles\LdLoansAndDeposits\LdLoansAndDepositsGWP.xml"
