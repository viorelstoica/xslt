...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/SecurityTransfer" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchSecurityTransfer"
    ...
    <xsl:import href="SecurityTransferBuy-Core.xsl"/>
    <xsl:import href="SecurityTransferBuy-Custo.xsl"/>
	<xsl:import href="SecurityTransferBuy.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="SecurityTransferBuy" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\SecurityTransferBuy\SecurityTransferBuy.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\SecurityTransferBuy\SecurityTransferBuyGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
