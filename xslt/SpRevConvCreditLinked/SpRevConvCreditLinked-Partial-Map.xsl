...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="SpRevConvCreditLinked-Partial-Core.xsl"/>
    <xsl:import href="SpRevConvCreditLinked-Partial-Custo.xsl"/>
    <xsl:import href="SpRevConvCreditLinked-Partial.xsl"/>
