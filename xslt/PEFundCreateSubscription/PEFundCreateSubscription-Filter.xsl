...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/PECustomerTxn" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchPECustomerTxn"
	...
	<xsl:import href="PEFundCreateSubscription-Filter-Core.xsl"/>
	<xsl:import href="PEFundCreateSubscription-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\..\DailyTrack\TTI-2532\PECustomerTXn_prefilter.xml" htmlbaseurl="" outputurl="..\..\..\..\DailyTrack\TTI-2532\PECustomerTXn_postfilter.xml"
