...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="TransactionSecurityBuyReversal" userelativepaths="yes" externalpreview="no" url="..\..\sell reversal.xml" htmlbaseurl="" outputurl="..\..\sell reversalfil12.xml" processortype="jaxp" useresolver="no" profilemode="0"
		          profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no"
		          validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
