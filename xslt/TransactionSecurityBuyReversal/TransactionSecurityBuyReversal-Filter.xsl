...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="TransactionSecurityBuyReversal-Filter-Core.xsl"/>
    <xsl:import href="TransactionSecurityBuyReversal-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="TransactionSecurityBuyReversal" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionSecurityBuyReversal\TransactionSecurityBuyReversal.xml" htmlbaseurl=""
