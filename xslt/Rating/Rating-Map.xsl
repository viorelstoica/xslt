...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchRating"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiRating"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiRating" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="Rating-Core.xsl"/>
    <xsl:import href="Rating-Custo.xsl"/>
	<xsl:import href="Rating.xsl"/>
