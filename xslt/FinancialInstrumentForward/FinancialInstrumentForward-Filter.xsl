...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/FiPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/FinancialInstrumentForex"
	...
	<xsl:import href="FinancialInstrumentForward-Filter-Core.xsl"/>
	<xsl:import href="FinancialInstrumentForward-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FinancialInstrumentForward" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\FinancialInstrumentForward\FinancialInstrumentForexT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentForward\FinancialInstrumentForwardPostFilter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
