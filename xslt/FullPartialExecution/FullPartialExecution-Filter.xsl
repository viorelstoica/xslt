...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/F2B" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/FullPartialExecution"
	...
	<xsl:import href="FullPartialExecution-Filter-Core.xsl"/>
	<xsl:import href="FullPartialExecution-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FullPartialExecution" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\FullPartialExecution\FullPartialExecutionT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FullPartialExecution\FullPartialExecution.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
