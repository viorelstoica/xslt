...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/FundsTransferOperationType" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFundsTransferOperationType" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiFundsTransferOperationType" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiFundsTransferOperationType" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   <xsl:output encoding="UTF-8" indent="yes" method="xml"/>
   <xsl:template match="c:MultiFundsTransferOperationType">
      <xsl:apply-templates select="c:CurrentEvent/b:FundsTransferOperationType"/>
   </xsl:template>
   <xsl:template match="batch:BatchFundsTransferOperationType">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchFundsTransferOperationType" name="BatchFundsTransferOperationType">
         <xsl:apply-templates select="b:FundsTransferOperationType"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiFundsTransferOperationType">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiFundsTransferOperationType" name="BatchMultiFundsTransferOperationType">
         <xsl:apply-templates select="c:MultiFundsTransferOperationType"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:FundsTransferOperationType">
      <InfraPMS>
         <xsl:attribute name="mode">INSUPD</xsl:attribute>
         <xsl:attribute name="output">
            <xsl:value-of select="concat('fundsTransferOperationType',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Type>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('FundsTransferOperationType.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FundsTransferOperationType" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FundsTransferOperationType\FundsTransferOperationType.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FundsTransferOperationType\FundsTransferOperationTypeCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
