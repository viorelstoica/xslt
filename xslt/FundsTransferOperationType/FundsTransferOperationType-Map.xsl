...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/FundsTransferOperationType"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFundsTransferOperationType"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiFundsTransferOperationType"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiFundsTransferOperationType" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="FundsTransferOperationType-Core.xsl"/>
    <xsl:import href="FundsTransferOperationType-Custo.xsl"/>
	<xsl:import href="FundsTransferOperationType.xsl"/>
