...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/LockingTransactionCOA"
	...
	<xsl:import href="LockingTransactionENTITLEMENT-Core.xsl"/>
	<xsl:import href="LockingTransactionENTITLEMENT-Custo.xsl"/>
	<xsl:import href="LockingTransactionENTITLEMENT.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="LockingTransactionENTITLEMENT" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\LockingTransactionENTITLEMENT\LockingTransactionENTITLEMENT.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\LockingTransactionENTITLEMENT\LockingTransactionENTITLEMENTGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
