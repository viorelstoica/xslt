...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/LockingTransaction"
	...
	<xsl:import href="LockingTransaction-Filter-Core.xsl"/>
	<xsl:import href="LockingTransaction-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="LockingTransaction" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\LockingTransaction\LockingTransactionT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\LockingTransaction\LockingTransaction.xml"
