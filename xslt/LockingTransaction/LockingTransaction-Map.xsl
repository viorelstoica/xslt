...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/LockingTransaction"
	...
	<xsl:import href="LockingTransaction-Core.xsl"/>
	<xsl:import href="LockingTransaction-Custo.xsl"/>
	<xsl:import href="LockingTransaction.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="LockingTransaction" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\LockingTransaction\LockingTransaction.xml" htmlbaseurl="" outputurl="..\..\TestFiles\LockingTransaction\LockingTransactionGWP.xml"
