...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/OrderGroupingForSubscriptionRedemption"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchOrderGroupingForSubscriptionRedemption"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiOrderGroupingForSubscriptionRedemption"
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="OrderGroupingForSubscriptionRedemption" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\OrderGroupingForSubscriptionRedemption\FinancialInstruemntMutualFund.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\OrderGroupingForSubscriptionRedemption\FinancialInstruemntMutualFundCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
		          additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
