...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="DXOrderUpdateRejected-Core.xsl"/>
    <xsl:import href="DXOrderUpdateRejected-Custo.xsl"/>
	<xsl:import href="DXOrderUpdateRejected.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DXOrderUpdateRejected" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\DXorderUpdateRejected\20161021_142756_499_47_msgin_MultiDXOrderUpdateRejected.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\DXOrderUpdateRejected\DXOrderUpdateRejectedFiter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
