...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/F2B" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/DXFullPartialExecution" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchDXFullPartialExecution" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiDXFullPartialExecution" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiDXFullPartialExecution" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   <xsl:output encoding="UTF-8" indent="yes" method="xml"/>
   <xsl:template match="c:MultiDXFullPartialExecution">
      <xsl:apply-templates select="c:CurrentEvent/b:DXFullPartialExecution"/>
   </xsl:template>
   <xsl:template match="batch:BatchDXFullPartialExecution">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchDXFullPartialExecution" name="BatchDXFullPartialExecution">
         <xsl:apply-templates select="b:DXFullPartialExecution"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiDXFullPartialExecution">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiDXFullPartialExecution" name="BatchMultiDXFullPartialExecution">
         <xsl:apply-templates select="c:MultiDXFullPartialExecution"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:DXFullPartialExecution">
		<F2B mode="INSUPD">
			<xsl:attribute name="output">
				<xsl:value-of select="concat('DXFullPartialExecution',b:id)"/>
			</xsl:attribute>
			<DataGroup>
				<Security>
					<xsl:attribute name="description">
						<xsl:value-of select="concat('DXFullPartialExecution.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
					</xsl:attribute>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FullPartialExecution" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\DXFullPartialExecution\DXFullPartialExecution.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\DXFullPartialExecution\DXFullPartialExecutionGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
		          additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath="" postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="bSchemaAware" value="false"/>
			<advancedProp name="xsltVersion" value="2.0"/>
