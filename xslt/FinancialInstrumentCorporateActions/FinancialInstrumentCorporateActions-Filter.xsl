...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/CaEvent" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="FinancialInstrumentCorporateActions-Filter-Core.xsl"/>
	<xsl:import href="FinancialInstrumentCorporateActions-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FinancialInstrumentCorporateActions" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\FinancialInstrumentCorporateActions\FinancialInstrumentCorporateActionsT24.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentCorporateActions\FinancialInstrumentCorporateActions.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
