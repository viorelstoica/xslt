	...
	<xsl:template match="b:PaymentOrder">
		<TransactionPMS>
			...
			<xsl:attribute name="output">
				<xsl:value-of select="concat('TransactionPaymentOrderDebitRev',b:id)"/>
			</xsl:attribute>
			<DataGroup>
				<Cash>
					<xsl:attribute name="description">
						<xsl:value-of select="concat('TransactionPaymentOrderDebitRev.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
					</xsl:attribute>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="TransactionPaymentOrderDebitRev" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionPaymentOrderDebitRev\TransactionPaymentOrderDebitCusto.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionPaymentOrderDebitRev\TransactionPaymentOrderDebitGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
