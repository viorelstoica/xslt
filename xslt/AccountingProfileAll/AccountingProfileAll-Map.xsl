...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
	...
	<xsl:import href="AccountingProfileAll-Core.xsl"/>
	<xsl:import href="AccountingProfileAll-Custo.xsl"/>
	<xsl:import href="AccountingProfileAll.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\Defects\TAXAll\20190313_201825_420_325_msgin_MultiCginventoryAll_eca6e962-4826-4872-9584-4a9ade717be7.xml" htmlbaseurl=""
		          outputurl="..\..\..\Defects\TAXAll\accccAll.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none"
