...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="FinancialInstrumentSyMasterAccuDecu-Core.xsl"/>
    <xsl:import href="FinancialInstrumentSyMasterAccuDecu-Custo.xsl"/>
	<xsl:import href="FinancialInstrumentSyMasterAccuDecu.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FinancialInstrumentFuture" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumentSyMasterPartFwd\FinancialInstrumentSyMasterPartFwd.xml" htmlbaseurl="" outputurl="" processortype="jaxp"
		          useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath="" postprocessortype="none" postprocesscommandline="" postprocessadditionalpath=""
		          postprocessgeneratedext="" validateoutput="no" validator="internal" customvalidator="">
			<advancedProp name="sInitialMode" value=""/>
			<advancedProp name="bXsltOneIsOkay" value="true"/>
