...
<xsl:stylesheet exclude-result-prefixes="b" version="1.0"
    ...
    <xsl:import href="F2B_SyPwfdTarko-Core.xsl"/>
    <xsl:import href="F2B_SyPwfdTarko-Custo.xsl"/>
	<xsl:import href="F2B_SyPwfdTarko.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="F2B_SyPwfdTarko" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\F2B_SyPwfdTarko\F2B-FormatFilterOut.xml" htmlbaseurl="" outputurl="..\..\TestFiles\F2B_SyPwfdTarko\F2B-FormatPostMap.xml"
