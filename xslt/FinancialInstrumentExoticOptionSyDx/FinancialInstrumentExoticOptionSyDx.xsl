...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/StructuredProducts" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/FinancialInstrumentExoticOptionSyDx" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFinancialInstrumentExoticOptionSyDx" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiFinancialInstrumentExoticOptionSyDx" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiFinancialInstrumentExoticOptionSyDx" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   <xsl:output encoding="UTF-8" indent="yes" method="xml"/>
   <xsl:template match="c:MultiFinancialInstrumentExoticOptionSyDx">
      <xsl:apply-templates select="c:CurrentEvent/b:FinancialInstrumentExoticOptionSyDx"/>
   </xsl:template>
   <xsl:template match="batch:BatchFinancialInstrumentExoticOptionSyDx">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchFinancialInstrumentExoticOptionSyDx" name="BatchFinancialInstrumentExoticOptionSyDx">
         <xsl:apply-templates select="b:FinancialInstrumentExoticOptionSyDx"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiFinancialInstrumentExoticOptionSyDx">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiFinancialInstrumentExoticOptionSyDx" name="BatchMultiFinancialInstrumentExoticOptionSyDx">
         <xsl:apply-templates select="c:MultiFinancialInstrumentExoticOptionSyDx"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:FinancialInstrumentExoticOptionSyDx">
      <StructuredProducts>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('FinancialInstrumentExoticOptionSyDx',translate(translate(b:id,'/',''),':',''))"/>
         </xsl:attribute>
         <DataGroup>
            <ExoticOption>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('FinancialInstrumentExoticOptionSyDx.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
            ...
            <xsl:if test="b:dxContractMasterJoinUnderlyingGroup/b:dxContractMasterJoinUnderlying!='' or b:dlvCcy!='' or b:tradeCcy!=''">
			<Event>
               <termEvent>
				  ...
				  <xsl:call-template name="barrierTimeZone"/>
				  <xsl:call-template name="eventTimeType"/>
