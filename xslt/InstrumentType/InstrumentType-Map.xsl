...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchInstrumentType"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiInstrumentType"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiInstrumentType" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="InstrumentType-Core.xsl"/>
    <xsl:import href="InstrumentType-Custo.xsl"/>
	<xsl:import href="InstrumentType.xsl"/>
