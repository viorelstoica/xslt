   ...
   <xsl:template match="b:SyFxForwardsCob">
      <TransactionPMS mode="INSUPD">
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransactionSYFXOpenDerivativeSell',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Derivative>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionSYFXOpenDerivativeSell.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
