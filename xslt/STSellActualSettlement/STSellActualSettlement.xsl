...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/STSellActualSettlement" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchSTSellActualSettlement" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiSTSellActualSettlement" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiSTSellActualSettlement" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" exclude-result-prefixes="b c batch multibatch ns0" version="1.0">
   ...
   <xsl:template match="c:MultiSTSellActualSettlement">
      <xsl:apply-templates select="c:CurrentEvent/b:STSellActualSettlement"/>
   </xsl:template>
   <xsl:template match="batch:BatchSTSellActualSettlement">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchSTSellActualSettlement" name="BatchSTSellActualSettlement">
         <xsl:apply-templates select="b:STSellActualSettlement"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="multibatch:BatchMultiSTSellActualSettlement">
      <xsl:element xmlns="http://www.temenos.com/T24/event/TTI/BatchMultiSTSellActualSettlement" name="BatchMultiSTSellActualSettlement">
         <xsl:apply-templates select="c:MultiSTSellActualSettlement"/>
      </xsl:element>
   </xsl:template>
   <xsl:template match="b:STSellActualSettlement">
      <TransactionPMS>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('STSellActualSettlement',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <Security>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('STSellActualSettlement.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\STSellActualSettlement\STSellActualSettlement.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\STSellActualSettlement\STSellActualSettlementCusto.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
