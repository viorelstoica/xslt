...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="ChronoDataFund-Core.xsl"/>
    <xsl:import href="ChronoDataFund-Custo.xsl"/>
	<xsl:import href="ChronoDataFund.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="ChronologicalDataFixedIncome" userelativepaths="yes" externalpreview="no" url="..\msgfil.xml" htmlbaseurl="" outputurl="..\msgout.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth=""
