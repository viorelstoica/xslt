...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/InstrumentSubType"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchInstrumentSubType"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiInstrumentSubType"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiInstrumentSubType" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="InstrumentSubType-Core.xsl"/>
    <xsl:import href="InstrumentSubType-Custo.xsl"/>
	<xsl:import href="InstrumentSubType.xsl"/>
