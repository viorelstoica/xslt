...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/F2B" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/T24StatusChange"
	...
	<xsl:import href="T24StatusChange-Filter-PO-Core.xsl"/>
	<xsl:import href="T24StatusChange-Filter-PO-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="T24StatusChange" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\T24StatusChange\T24StatusChangePOT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\T24StatusChange\T24StatusChange.xml"
