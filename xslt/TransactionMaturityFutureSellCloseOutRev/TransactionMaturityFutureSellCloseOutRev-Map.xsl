...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon"
	...
	<xsl:import href="TransactionMaturityFutureSellCloseOutRev-Core.xsl"/>
	<xsl:import href="TransactionMaturityFutureSellCloseOutRev-Custo.xsl"/>
	<xsl:import href="TransactionMaturityFutureSellCloseOutRev.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="TransactionMaturityFutureSellCloseOutRev" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\TransactionMaturityFutureSellCloseOutRev\TransactionMaturityFutureSellCloseOutRev.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionMaturityFutureSellCloseOutRev\TransactionMaturityFutureSellCloseOutRevGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
