...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="TransactionTraspasoRejected-Core.xsl"/>
    <xsl:import href="TransactionTraspasoRejected-Custo.xsl"/>
	<xsl:import href="TransactionTraspasoRejected.xsl"/>
