...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DXOrderAcknowledgment" userelativepaths="yes" externalpreview="no" url="..\test\rejected.xml" htmlbaseurl="" outputurl="..\test\rejectedfil.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth=""
