...
<xsl:stylesheet exclude-result-prefixes="b" version="1.0"
    ...
    <xsl:import href="TransactionLDInterestPayment-Core.xsl"/>
    <xsl:import href="TransactionLDInterestPayment-Custo.xsl"/>
	<xsl:import href="TransactionLDInterestPayment.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionCashInvestment\TransactionCashInvestment.xml" htmlbaseurl="" outputurl="..\..\TestFiles\TransactionCashInvestment\filter.xml"
