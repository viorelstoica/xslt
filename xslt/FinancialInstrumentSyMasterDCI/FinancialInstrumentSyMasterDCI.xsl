   ...
   <xsl:template match="b:FinancialInstrumentSyContractMaster">
      <StructuredProducts>
         ...
         <xsl:attribute name="output">
            <xsl:value-of select="concat('FinancialInstrumentSyMasterDCI',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DualCurrencyInvestment>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('FinancialInstrumentSyMasterDCI.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="FinancialInstrumentSyMasterDCI" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FinancialInstrumentSyMasterDCI\FinancialInstrumentSyMasterDCI.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\FinancialInstrumentSyMasterDCI\FinancialInstrumentSyMasterDCI_GWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath=""
