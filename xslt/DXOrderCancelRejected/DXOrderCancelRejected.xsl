         ...
         <DataGroup>
            <EventStatus>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('DXOrderCancelRejected.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DXOrderCancelRejected" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\DXOrderCancelRejected\DXOrderCancelRejectedFiter.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\DXOrderCancelRejected\DXOrderCancelRejectedGWP.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
