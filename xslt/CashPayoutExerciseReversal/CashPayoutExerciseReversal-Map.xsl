...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionAssignExpiryOptionBuyCloseOutRev"
	...
	<xsl:import href="CashPayoutExerciseReversal-Core.xsl"/>
	<xsl:import href="CashPayoutExerciseReversal-Custo.xsl"/>
	<xsl:import href="CashPayoutExerciseReversal.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\BuyCloseOutRevFILTER_OUT.xml" htmlbaseurl="" outputurl="..\BuyCloseOutRevMSG_OUT.xml" processortype="saxon8" useresolver="no" profilemode="0"
