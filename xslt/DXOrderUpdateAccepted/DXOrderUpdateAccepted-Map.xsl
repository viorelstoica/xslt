...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiDXOrderReturn" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="DXOrderUpdateAccepted-Core.xsl"/>
    <xsl:import href="DXOrderUpdateAccepted-Custo.xsl"/>
	<xsl:import href="DXOrderUpdateAccepted.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DXOrderUpdateAccepted" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\DXOrderUpdateAccepted\20170302_102032_887_45_msgin_MultiDXT24StatusChange_1149b757-4a3e-4906-8290-0a5611df8b11.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\DXOrderUpdateAccepted\DXOrderUpdateAcceptedOUT.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
