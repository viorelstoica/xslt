...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/FXTransactionType"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchFXTransactionType"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiFXTransactionType"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiFXTransactionType" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="FXTransactionType-Core.xsl"/>
    <xsl:import href="FXTransactionType-Custo.xsl"/>
	<xsl:import href="FXTransactionType.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="FXTransactionType" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\FXTransactionType\FXTransactionType.xml" htmlbaseurl="" outputurl="..\..\TestFiles\FXTransactionType\FXTransactionTypeCusto.xml"
