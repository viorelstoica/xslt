...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/FiPMS" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:a="http://www.temenos.com/T24/AaActivityExtractorService/AaArrInterestRec"
	...
	<xsl:import href="TransactionAARedemptionFeeDeposits-Core.xsl"/>
    <xsl:import href="TransactionAARedemptionFeeDeposits-Custo.xsl"/>
	<xsl:import href="TransactionAARedemptionFeeDeposits.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\TransactionAARedemptionFeeDeposits\TransactionAARedemptionFeeDeposits.xml" htmlbaseurl=""
		          outputurl="..\..\TestFiles\TransactionAARedemptionFeeDeposits\TransactionAARedemptionFeeDepositsFilter.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
