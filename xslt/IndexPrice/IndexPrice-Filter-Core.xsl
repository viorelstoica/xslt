<?xml version="1.0" encoding="UTF-8"?><xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/FiPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/IndexPrice" xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchIndexPrice" xmlns:c="http://www.temenos.com/T24/event/TTI/MultiIndexPrice" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiIndexPrice" exclude-result-prefixes="b c batch multibatch" version="1.0">
	...
	<xsl:template match="b:IndexPrice">
		<xsl:apply-templates select="self::b:IndexPrice[b:rate and b:rate!='']" mode="filter-custo"/>
	</xsl:template>
	<!-- Custo placeholder -->
	<xsl:template match="b:IndexPrice" mode="filter-custo">
		<xsl:apply-templates select="self::b:IndexPrice" mode="filter-final"/>
	</xsl:template>
	<!-- Copy block -->
	<xsl:template match="b:IndexPrice" mode="filter-final">
		<xsl:copy>
			<xsl:apply-templates select="@* | node()"/>
		</xsl:copy>
	</xsl:template>
