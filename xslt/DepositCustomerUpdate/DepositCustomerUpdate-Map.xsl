...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/DepositCustomerUpdate"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchDepositCustomerUpdate"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiDepositCustomerUpdate"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiDepositCustomerUpdate" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="DepositCustomerUpdate-Core.xsl"/>
    <xsl:import href="DepositCustomerUpdate-Custo.xsl"/>
	<xsl:import href="DepositCustomerUpdate.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="Deposit" userelativepaths="yes" externalpreview="no" url="..\..\TestFiles\depositcustomerUpdate\Deposit3.xml" htmlbaseurl="" outputurl="..\..\TestFiles\depositcustomerUpdate\depositcustomerUpdateFilter3.xml"
