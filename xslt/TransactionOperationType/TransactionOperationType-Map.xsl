...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    xmlns:b="http://www.temenos.com/T24/event/TTI/TransactionOperationType"
    xmlns:batch="http://www.temenos.com/T24/event/TTI/BatchTransactionOperationType"
    xmlns:c="http://www.temenos.com/T24/event/TTI/MultiTransactionOperationType"
    xmlns:multibatch="http://www.temenos.com/T24/event/TTI/BatchMultiTransactionOperationType" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Core.xsl"/>
    <xsl:import href="../GlobalTemplate/GlobalTemplate-Custo.xsl"/>
    <xsl:import href="TransactionOperationType-Core.xsl"/>
    <xsl:import href="TransactionOperationType-Custo.xsl"/>
	<xsl:import href="TransactionOperationType.xsl"/>
