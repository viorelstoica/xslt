...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch" version="1.0" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/TTI/PaymentOrderNotification"
	...
	<xsl:import href="CsdTransactionPaymentOrderNotificationDebit-Filter-Core.xsl"/>
	<xsl:import href="CsdTransactionPaymentOrderNotificationDebit-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PaymentOrderNotification" userelativepaths="yes" externalpreview="yes" url="..\..\..\..\..\Users\abiram.anandakumar\Downloads\CsdDebit\PaymentOrderNotificationMsgin.xml" htmlbaseurl=""
		          outputurl="..\..\..\..\..\Users\abiram.anandakumar\Downloads\CsdDebit\PaymentOrderNotificationDebFilter.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline=""
