   ...
   <xsl:template match="b:LdLoansAndDepositsOldNew">
      <TransactionPMS mode="INSUPD">
         <xsl:attribute name="output">
            <xsl:value-of select="concat('TransactionOpenLDDeposits',b:id)"/>
         </xsl:attribute>
         <DataGroup>
            <DepositLoan>
               <xsl:attribute name="description">
                  <xsl:value-of select="concat('TransactionOpenLDDeposits.xsl+', name(/*), '+', b:eventCommon/ns0:eventId, '+', b:eventCommon/ns0:creationTime)"/>
               </xsl:attribute>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="Scenario1" userelativepaths="yes" externalpreview="no" url="..\..\..\..\testfiles\LdLoansAndDepositsOldNew\20170123_105448_158_44_msgin_MultiLdLoansAndDepositsOldNew_63c71a10-e78b-42ef-89a9-a710f127f915.xml"
		          htmlbaseurl="" outputurl="..\..\..\..\LdLoansAndDepositsOldNewGWP.xml" processortype="saxon8" useresolver="no" profilemode="0" profiledepth="" profilelength="" urlprofilexml="" commandline="" additionalpath="" additionalclasspath=""
