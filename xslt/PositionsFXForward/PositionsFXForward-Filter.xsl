...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/PositionPMS" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/PositionsForex"
	...
	<xsl:import href="PositionsFXForward-Filter-Core.xsl"/>
	<xsl:import href="PositionsFXForward-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		<scenario default="yes" name="PositionsFXForward" userelativepaths="yes" externalpreview="yes" url="..\..\TestFiles\PositionsFXForward\PositionsFXForwardT24.xml" htmlbaseurl="" outputurl="..\..\TestFiles\PositionsFXForward\PositionsFXForward.xml"
