...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/TransactionPMS" xmlns:b="http://www.temenos.com/T24/event/AcEntry/AcEntry" xmlns:batch="http://www.temenos.com/T24/event/AcEntry/BatchAcEntry" xmlns:c="http://www.temenos.com/T24/event/AcEntry/MultiAcEntry" xmlns:d="http://www.temenos.com/T24/AccountingEventsService/StatementEntry" xmlns:e="http://www.temenos.com/T24/AccountingEventsService/StatementEntry" xmlns:infra="http://www.odcgroup.com/InfraPMS" xmlns:multibatch="http://www.temenos.com/T24/event/AcEntry/BatchMultiAcEntry" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" exclude-result-prefixes="b ns0" version="1.0">
   ...
   <xsl:template name="d_sourceSystemCode">
      ...
      <sourceSystemCode>
         <xsl:value-of select="b:statemententry[e:transactionCode/@Rank=$MinRank]/e:statementNumber"/>
      </sourceSystemCode>
   </xsl:template>
   ...
   <xsl:template name="d_transactionFeesTaxesCounter">
      ...
      <xsl:call-template name="printLDCommAndChrgFeesAndTaxes">
         <xsl:with-param name="amount">
            <xsl:choose>
               <xsl:when test="(b:statemententry[e:transactionCode[@Rank=$MinRank and (@BalancePosition = 'LD_COMMISSION' or @BalancePosition = 'LD_CHARGE')]]/e:amountFcy = '')or not(b:statemententry[e:transactionCode[@Rank=$MinRank and (@BalancePosition = 'LD_COMMISSION' or @BalancePosition = 'LD_CHARGE')]]/e:amountFcy)">
                  <xsl:value-of select="b:statemententry[e:transactionCode[@Rank=$MinRank and (@BalancePosition = 'LD_COMMISSION' or @BalancePosition = 'LD_CHARGE')]]/e:amountLcy"/>
               </xsl:when>
               <xsl:when test="b:statemententry[e:transactionCode[@Rank=$MinRank and (@BalancePosition = 'LD_COMMISSION' or @BalancePosition = 'LD_CHARGE')]]/e:amountFcy != ''">
                  <xsl:value-of select="b:statemententry[e:transactionCode[@Rank=$MinRank and (@BalancePosition = 'LD_COMMISSION' or @BalancePosition = 'LD_CHARGE')]]/e:amountFcy"/>
               </xsl:when>
            </xsl:choose>
         </xsl:with-param>
         ...
         <xsl:with-param name="currency">
            <xsl:choose>
               <xsl:when test="b:statemententry[e:transactionCode[@Rank=$MinRank and (@BalancePosition = 'LD_COMMISSION' or @BalancePosition = 'LD_CHARGE')]]">
                  <xsl:value-of select="b:statemententry[e:transactionCode[@Rank=$MinRank and (@BalancePosition = 'LD_COMMISSION' or @BalancePosition = 'LD_CHARGE')]]/e:currency"/>
               </xsl:when>
            </xsl:choose>
         </xsl:with-param>
      </xsl:call-template>
   ...
   <xsl:template name="d_renewalTreatment"/><!-- end of COMMCHRGDEPOSIT --><!-- COMMCHRGLOAN -->
   ...
   <xsl:template name="l_renewalTreatment"/><!-- end of COMMCHRGLOAN -->
