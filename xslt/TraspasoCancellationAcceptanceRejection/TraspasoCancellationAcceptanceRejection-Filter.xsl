...
<xsl:stylesheet exclude-result-prefixes="b c batch multibatch"
    ...
    <xsl:import href="TraspasoCancellationAcceptanceRejection-Filter-Core.xsl"/>
    <xsl:import href="TraspasoCancellationAcceptanceRejection-Filter-Custo.xsl"/>
...
<metaInformation>
	<scenarios>
		...
		<scenario default="yes" name="DXOrderAcknowledgment" userelativepaths="yes" externalpreview="no" url="..\test\cancell.xml" htmlbaseurl="" outputurl="..\test\cancell1.xml" processortype="jaxp" useresolver="no" profilemode="0" profiledepth=""
