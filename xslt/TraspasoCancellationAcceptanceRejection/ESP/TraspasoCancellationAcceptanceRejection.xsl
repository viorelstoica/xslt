...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns="http://www.odcgroup.com/Request" xmlns:ns0="http://www.temenos.com/T24/event/Common/EventCommon" xmlns:b="http://www.temenos.com/T24/event/TTI/EsfundTraspasoRequest"
	...
	<!--	<Event>
			...
			<xsl:attribute name="output">
				<xsl:value-of select="concat('TraspasoCancellationAcceptanceRejection',b:id)"/>
			</xsl:attribute>
			<DataGroup>
				<EventStatus>
